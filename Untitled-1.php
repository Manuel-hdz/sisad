...
#form-salida { position:absolute; left:4px; top:190px; width:467px; height:240px; z-index:13; }
#foto-empleado { position:absolute; left:515px; top:196px; width:160px; height:230px; z-index:13; border:solid; }
#material-agregado { position:absolute; left:5px; top:455px; width:990px; height:240px; z-index:11; overflow:auto; }
#boton-terminar { position:absolute; left:173px; top:462px; width:141px; height:37px; z-index:15; }
#form-seguridad { position:absolute; left:680px; top:190px; width:300px; height:82px; z-index:18; }
#res-spider { position:fixed; left:70px; z-index:30; }

/* Modal Excel */
#modal_excel { display:none; position:fixed; top:50%; left:50%; transform:translate(-50%,-50%); background:#fff; border:2px solid #000; z-index:50; padding:20px; width:600px; max-height:400px; overflow:auto; }
#modal_excel table { width:100%; border-collapse:collapse; }
#modal_excel table th, #modal_excel table td { border:1px solid #ccc; padding:5px; text-align:center; }
#modal_excel button { margin-top:10px; margin-right:10px; }
</style>
</head>
...
<thead><tr><th>Clave</th><th>Nombre</th><th>Cantidad</th><th>Id Equipo</th></tr></thead>
<tbody></tbody>
</table>
