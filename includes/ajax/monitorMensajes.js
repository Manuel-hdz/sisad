  ...
  */
	...
	function msjesNuevos(){
		//Crear la URL, la cual será solicitada al Servidor, el directorio inicia desde la ubicacion del archivo donde esta siendo incluido este archivo JavaScript(validarDatoBD.js)
	 	var url = "../../includes/ajax/monitorMensajes.php?";		
		...
		cargaContenidoMsjes(url, "GET", procesarRespuestaMsjes);
	...
	function cargaContenidoMsjes(url, metodo, funcion) {
	...
	function procesarRespuestaMsjes(){		
		//Verificar que la peticion HTTP se haya realizado correctamente
 		if(peticion_http_iva.readyState==READY_STATE_COMPLETE){
			if(peticion_http_iva.status==200){
				...
				if (existe=="true")
					document.getElementById("chat").innerHTML ="<img src=\"../../images/msnNuevo.gif\" width=\"100%\" height=\"100%\" title=\"Hay Mensajes Nuevos\" align=\"absmiddle\" style=\"cursor:pointer;\" onClick=\"abrirVentanaChat();\"/>";
				else
					document.getElementById("chat").innerHTML ="<img src=\"../../images/msn.png\" width=\"100%\" height=\"100%\" title=\"Escribir Mensaje\" align=\"absmiddle\" style=\"cursor:pointer;\" onClick=\"abrirVentanaChat();\"/>";
