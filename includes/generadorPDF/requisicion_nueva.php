...
class PDF extends PDF_MySQL_Table{
	...
	function Header(){
		...
		$this->Image('fondo-requisicion.jpg',-0.9,0,210);
	    //Arial bold 15
	    ...
	    $this->Cell(60);
	    //Title
	    $this->Cell(70,25,utf8_decode('CONFIDENCIAL, PROPIEDAD DE CONCRETO LANZADO DE FRESNILLO, S.A DE C.V. PROHIBIDA SU REPRODUCCIÓN TOTAL O PARCIAL.'),0,0,'C');
	...
	function Footer(){
	    ...
	    //Numero de Pagina
		$this->Cell(-20,15,utf8_decode('Página ').$this->PageNo().' de {nb}',0,0,'C');
		$this->SetY(-17);
