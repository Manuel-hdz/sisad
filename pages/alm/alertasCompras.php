<?php
	...
	function desplegarAlertasCompras(){
		...
		departamento = 'ALMACEN' AND estado='0'";		
	...
	function notificarAlertaCompras($num_alertas){?>
		...
		<script type="text/javascript" language="javascript">
			setTimeout("popup_show('popup_alm0', 'popup_drag_alm0', 'popup_exit_alm0', 'screen-top-left', 75, 400);",1000);			
		</script>
		<!-- ********************************************************* Popup Window **************************************************** -->
		<div class="sample_popup" id="popup_alm0" style="display: none;">
			<div align="center" class="menu_form_header" id="popup_drag_alm0">
				<img class="menu_form_exit" id="popup_exit_alm0" src="includes/aviso-form-exit.png" alt="" title="Posponer" />
				AVISO COMPRAS
			</div>
	...
	function mostrarAlertasCompras($ctrl){		
		...
		WHERE estado = '0' AND departamento = 'ALMACEN'";
		...
		if($datos=mysql_fetch_array($rs)){			
			...
			<script type="text/javascript" language="javascript">			
				setTimeout("popup_show('popup_rh<?php echo $ctrl?>', 'popup_drag_rh<?php echo $ctrl?>', 'popup_exit_rh<?php echo $ctrl?>', 'screen-top-left', 75, 400);",1000);				
			</script>
			<!-- ********************************************************* Popup Window **************************************************** -->
