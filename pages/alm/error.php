...
<body>
	<div id="parrilla-menu1" align="center">
		...
		if(isset($_GET['err'])) { 
			if($err=="AccesoNegado") {
				$usuarios=verificarUsuarioPermisos("Almacen");
				$band=0;
				...
				if($band==1){?>
					<meta http-equiv="refresh" content="4;url=inicio_almacen.php">
					<p>
				...
				else{//Si es cualquier otro usuario cerrar la SESSION
					?><meta http-equiv="refresh" content="0;url=../salir.php"><?php
				}
			} 
			else {?>
				<meta http-equiv="refresh" content="7;url=inicio_almacen.php">
				<p>
