    	...
    	<table width="931" height="92" border="0" cellpadding="5" cellspacing="5" class="tabla_frm">
    		<tr>
				...
				<td width="163">
					...
					readonly="readonly" width="50" onchange="cargarRequisicion(1);"/>
				</td>
            	...
            	<td colspan="3">
					...
					width="50" 	onchange="cargarRequisicion(1);" />
				</td>
			</tr>
        	<tr>
            <td align="right">
            ...
            <td>
				<select name="cmb_buscarPor" id="cmb_buscarPor" class="combo_box" disabled="disabled"  onchange="cargarRequisicion(1);">
            ...
            <td width="239">
				...
				onchange="cargarRequisicion(1);" ></textarea>
			</td>
