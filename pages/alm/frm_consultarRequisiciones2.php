...
<head>
    ...
    <style type="text/css">
		...
		#Msje{position:absolute; left:70px; top:260px; width:900px; height:50px; z-index:18;}
...
/*		echo "<meta http-equiv='refresh' content='10;url=menu_requisiciones.php'>";
		...
		if (isset($_POST["btn_revisar"]) || isset($_POST["btn_guardarC"]) || isset($_POST["origen"])){
			...
			<div id='botones' align="center" style="top:670px">
				...
				&nbsp;&nbsp;&nbsp;&nbsp;
				<input name="btn_guardarC" type="submit" id="btn_guardarC" class="botones" value="Guardar Estado"
