...
<?php
	...
	if(!verificarPermiso($usr_reg,$_SERVER['PHP_SELF'])){
		...
		//Manejo de la funciones para editar los registros del detalle de Entradas, Salidas, Requisiciones y Ordenes de Compra
...
<body>
    ...
    <fieldset class="borde_seccion" id="editar-registro" name="editar-registro">
		...
		if(isset($_GET['origen'])){
			switch($_GET['origen']){
				case "entrada":					
					editarRegistroEntrada($_GET['pos']);
				break;
				case "salida":
					editarRegistroSalida($_GET['pos']);
				break;
				case "requisicion":
					editarRegistroRequisicion($_GET['pos']);
				break;
				case "orden compra":
					editarRegistroOrdenCompra($_GET['pos']);
				break;
			}
		}
