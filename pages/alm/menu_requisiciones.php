...
<?php
	...
	if(!verificarPermiso($usr_reg,$_SERVER['PHP_SELF'])){		
		...
		//Archivo que contiene la funciuon para borrar fotos en caso de haber cancelado el registro
    	...
    	<tr>
      		<td width="188" align="center">
				...
				<form action="frm_generarRequisicion.php">
					<input type="image" src="images/add-requisicion.png"  width="110" height="158" border="0" title="Generar Requisici&oacute;n" onmouseover="window.status='';return true" /><br/>
      		...
      		<td width="190" align="center">
				...
				<form action="frm_consultarRequisiciones.php">
					<input type="image" src="images/sea-requisicion.png" width="110" height="158" border="0" title="Estado Requisiciones" onmouseover="window.status='';return true"/><br/>
