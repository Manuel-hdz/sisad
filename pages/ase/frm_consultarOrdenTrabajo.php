...
<head>
    ...
    <style type="text/css">
		<!--
		#titulo-consultarOrdenTrabajo {position:absolute;left:30px;top:146px;width:619px;height:20px;z-index:11;}
		#tabla-consultarOrdenTrabajo {position:absolute;left:30px;top:190px;width:530px;height:176px;z-index:12;padding:15px;padding-top:0px;}
		#calendarioInicio {position:absolute;left:255px;top:302px;width:30px;height:26px;z-index:13;}
		#calendarioFin {position:absolute;left:495px;top:302px;width:30px;height:26px;z-index:14;}
		#consultar-ordenTrabajo {position:absolute;left:33px;top:187px;width:940px;height:430px;z-index:15;overflow:scroll;}
		#btns-regexp {position:absolute;left:398px;top:666px;width:173px;height:57px;z-index:16;}
		#detalleOT { position:absolute; left:30px; top:190px; width:940px; height:300px; z-index:21; overflow: scroll }
		#btn-detalleOT {position:absolute;left:430px;top:548px;width:173px;height:57px;z-index:6;}
		-->
    </style>
</head>
<body>
	...
	<div class="titulo_barra" id="titulo-consultarOrdenTrabajo">Consulta Mantenimiento - Consultar Orden de Trabajo de Mantenimientos Preventivos</div>
	<?php 	
	...
	if(isset($_POST['sbt_consultar'])){
		...
		if(isset($_POST['verDetalle'])){ 
			...
			<table width="100%" cellpadding="5" cellspacing="5" class="tabla_frm">
				<tr>
					<td width="67"><div align="right">Servicio</div></td>
					<td width="81"><?php
				...
				<tr>
					...
					<td colspan="3"><select name="cmb_familia" id="cmb_familia" >
				...
				<tr>
					...
					onmouseover="window.status='';return true" onclick="location.href='frm_seleccionarConsultaMtto.php'" />
					</td>
				</tr>
			</table>
			</form>
