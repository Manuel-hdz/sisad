...
<body>
	...
	<form onsubmit="return valFormInformacionRequisicion(this);" name="frm_InformacionRequisicion" method="post" action="frm_generarRequisicion.php">
  	<table border="0" width="100%" cellpadding="5" cellspacing="5" class="tabla_frm">
		<tr>
			<td>
    	...
    	<tr>
			<td>
      		...
      		<td>
				<input name="txt_areaSolicitante" type="text" id="txt_areaSolicitante" onkeypress="return permite(event,'num_car');" size="25" maxlength="45" value="ASEGURAMIENTO CALIDAD" required="required"/>
			</td>
			<td>
