...
<?php
	...
	//Comprobar que el usuario registrado tenga acceso a esta seccion del Módulo de Aseguramiento Calidad -Recuros Humanos
...
<title>Sistema de Gesti&oacute;n Empresarial, Producci&oacute;n y Operaci&oacute;n</title>
    ...
    <style type="text/css">
		<!--				
			#titulo-consultar-empleado {position:absolute; left:30px; top:146px; width:359px; height:25px; z-index:11; }
...
<body>
	...
	<div class="titulo_barra" id="titulo-consultar-empleado">Recursos Humanos - Consulta de Ausentismo </div>
		<?php 
	  ...
	  ?> 
			...
			<div align="center">
				<p>
					...
					onMouseOver="window.status='';return true" onclick="location.href='frm_seleccionarConsultaRH.php'" />
				</p>
			</div>
			</form>
			</fieldset>	
