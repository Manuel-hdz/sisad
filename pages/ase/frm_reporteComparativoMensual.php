...
<head>
    ...
    <style type="text/css">
		<!--
		#titulo-reporte {position:absolute;left:30px;top:146px;width:535px;height:20px;z-index:11;}
		#tabla-busqReporte {position:absolute;left:30px;top:190px;width:480px;height:120px;z-index:14;}
		#tabla-comparativo {position:absolute;left:32px;top:186px;width:914px;height:404px;z-index:15; overflow:scroll}
...
<body>
    ...
    <div class="titulo_barra" id="titulo-reporte">Consulta Gerencia T&eacute;cnica - Rendimiento Personal</div>
    <?php
   	...
   	if(!isset($_POST['ckb_idPresupuesto'])){
        ...
        <table width="467" cellpadding="5" cellspacing="5" class="tabla_frm">
            <tr>
