...
<head>
    ...
    <style type="text/css">
		<!--
		#titulo-barra { position:absolute; left:30px; top:146px; width:570px; height:24px; z-index:11; }
...
<body>
	...
	<div class="titulo_barra" id="titulo-barra">Consulta Mantenimiento -Reporte  Mantenimientos Preventivos/Correctivos </div>
    <?php 
	$band = 0;
		...
		<table border="0" align="center" cellpadding="5" cellspacing="5" class="tabla_frm">
			...
			<tr>
				<td colspan="2" align="center">
					...
					&nbsp;&nbsp;&nbsp;
					<input name="btn_cancelar" type="button" value="Regresar" class="botones" title="Regresar a Seleccionar Otra Consulta" 
					onclick="location.href='frm_seleccionarConsultaMtto.php'"/>
				</td>
			</tr>
		</table>
		</form>
