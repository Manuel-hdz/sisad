...
<body>
    ...
    <div class="titulo_barra" id="titulo-registrar">Seleccionar Tipo de Consulta Objetivos de Calidad </div>
    ...
    <legend class="titulo_etiqueta">Seleccionar Consulta Objetivos Calidad</legend>
    <table width="530" height="94"  cellpadding="5" cellspacing="5" class="tabla_frm">
    	<tr>
			...
			<select name="cmb_consulta" id="cmb_consulta" size="1" class="combo_box" onchange="selConsulta();">
				...
				<option value="SISAD">BIT&Aacute;CORA SISAD</option>
