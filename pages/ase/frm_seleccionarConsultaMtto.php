...
<body>
    ...
    <div class="titulo_barra" id="titulo-registrar">Seleccionar Tipo de Consulta Mantenimiento </div>
    ...
    <legend class="titulo_etiqueta">Seleccionar Consulta Mantenimiento </legend>
    <table width="530" height="94"  cellpadding="5" cellspacing="5" class="tabla_frm">
    	<tr>
       	  <td width="142" height="31"><div align="right">*Tipo Consulta </div></td>
         	<td width="351">
			<select name="cmb_consultaMtto" id="cmb_consultaMtto" size="1" class="combo_box" onchange="selConsultaMtto();">
                <option value="">Consultas Mantenimiento</option>
				<option value="PROGRAMADOS">MANTENIMIENTOS PROGRAMADOS</option>
				<option value="BITACORA">MANTENIMIENTOS REALIZADOS - BIT&Aacute;CORA</option>	
				<option value="REALIZADOS">MANTENIMIENTOS REALIZADOS - REPORTE</option>				
             </select>
		  </td>
       	</tr>
		<tr>
