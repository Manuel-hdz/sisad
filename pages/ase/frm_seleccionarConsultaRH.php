...
<?php
	...
	if(!verificarPermiso($usr_reg,$_SERVER['PHP_SELF'])){	
		...
		//Archivo que incluye las funciones
...
<body>
    ...
    <div class="titulo_barra" id="titulo-registrar">Seleccionar Tipo de Consulta Recursos Humanos</div>
    ...
    <legend class="titulo_etiqueta">Seleccionar Consulta Recursos Humanos</legend>
    <table width="530" height="94"  cellpadding="5" cellspacing="5" class="tabla_frm">
    	<tr>
        	<td width="121" height="31"><div align="right">*Tipo Consulta </div></td>
         	<td width="610">
			<select name="cmb_consultaRH" id="cmb_consultaRH" size="1" class="combo_box" onchange="selConsultaRH();">
                <option value="">Consultas RH</option>
