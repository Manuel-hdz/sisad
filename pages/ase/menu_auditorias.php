...
<head>
    ...
    <style type="text/css">
		<!--
		#parrilla-menu1 { position:absolute; left:100px; top:160px; width:556px; height:229px;	z-index:1; }
		-->
    </style>
</head>
<body>
	<div id="parrilla-menu1">
  	<table class="tabla_frm" width="518" border="0" align="center" cellpadding="5" cellspacing="5">
    	<tr>
      		<td width="34%" align="center">
	    		<div align="center">
					<form action="frm_registrarPlanAcciones.php">
						<input type="image" src="images/add-planAcciones.png"  width="110" height="180" border="0" title="Registrar Plan Acciones" 
						onmouseover="window.status='';return true" /><br/>
						<input type="image" src="../../images/btn-reg.png" name="btn1" id="bnt1" width="118" height="46" border="0" title="Registrar Plan Acciones"
      		...
      		<td width="33%" align="center">
	    		<div align="center">
					<form action="frm_modificarPlanAcciones.php">
						<input type="image" src="images/upd-planAcciones.png" width="110" height="180" border="0" title="Modificar Plan Acciones" 
						onmouseover="window.status='';return true"/><br/>
						<input type="image" src="../../images/btn-upd.png" name="btn2" id="bnt2" width="118" height="46" border="0" title="Modificar Plan Acciones" 
