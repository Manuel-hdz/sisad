  	...
  	<table class="tabla_frm" width="388" border="0" align="center" cellpadding="5" cellspacing="5">
    	<tr>
      		<td width="50%" align="center">
	    		<div align="center">
					<form action="frm_registrarListaMaestraDoc.php">
						<input type="image" src="images/add-listaMaestra.png"  width="150" height="190" border="0" 
						title="Registrar Lista Maestra Control Documentos" onmouseover="window.status='';return true" /><br/>
						<input type="image" src="../../images/btn-reg.png" name="btn1" id="bnt1" width="118" height="46" border="0" 
						title="Registrar Lista Maestra Control Documentos"
      		...
      		<td width="50%" align="center">
	    		<div align="center">
					<form action="frm_modificarListaMaestraDoc.php">
						<input type="image" src="images/upd-listaMaestra.png" width="150" height="190" border="0" 
						title="Modificar Lista Maestra Control Documentos" onmouseover="window.status='';return true"/><br/>
						<input type="image" src="../../images/btn-upd.png" name="btn2" id="bnt2" width="118" height="46" border="0" 
						title="Modificar Lista Maestra Control Documentos" 
