...
<?php
	...
	if(!verificarPermiso($usr_reg,$_SERVER['PHP_SELF'])){		
		...
		//Verificamos si existe la lista maestra del registro de documentos
  	...
  	<table class="tabla_frm" width="388" border="0" align="center" cellpadding="5" cellspacing="5">
    	<tr>
      		<td width="50%" align="center">
	    		<div align="center">
					<form action="frm_registrarListaMaestraRegCal.php">
						<input type="image" src="images/add-listaMaestra.png"  width="150" height="190" border="0" title="Registrar Lista Maestra Registros Calidad"
						...
						title="Registrar Lista Maestra Registros Calidad"
      		...
      		<td width="50%" align="center">
	    		<div align="center">
					<form action="frm_modificarListaMaestraRegCal.php">
						<input type="image" src="images/upd-listaMaestra.png" width="150" height="190" border="0" 
						title="Modificar Lista Maestra Registros Calidad" onmouseover="window.status='';return true"/><br/>
						<input type="image" src="../../images/btn-upd.png" name="btn2" id="bnt2" width="118" height="46" border="0" 
						title="Modificar Lista Maestra Registros Calidad" 
