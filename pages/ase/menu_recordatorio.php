  	...
  	<table class="tabla_frm" width="388" border="0" align="center" cellpadding="5" cellspacing="5">
    	<tr>
      		<td width="50%" align="center">
	    		<div align="center">
					<form action="frm_registrarRecordatorio.php">
						<input type="image" src="images/add-recordatorio.png"  width="150" height="190" border="0" title="Registrar Recordatorio"
      		...
      		<td width="50%" align="center">
	    		<div align="center">
					<form action="frm_modificarRecordatorio.php">
						<input type="image" src="images/upd-recordatorio.png" width="150" height="190" border="0" 
						title="Modificar Recordatorio" onmouseover="window.status='';return true"/><br/>
