...
<head>
    ...
    <style type="text/css">
		<!--
		#parrilla-menu1 { position:absolute; left:136px; top:168px; width:287px; height:275px; z-index:1; }
		-->
    </style>
</head>
<body>
	<div id="parrilla-menu1" >
  	<table class="tabla_frm" width="256" border="0" align="center" cellpadding="5" cellspacing="5">
    	<tr>
      		<td width="50%" align="center">
	    		<div align="center">
					<form action="frm_reportePlanAcciones.php">
						<input type="image" onclick="location.href='frm_reportePlanAcciones.php'" src="images/add-rep-plan-acciones.png" width="115" height="160" 
						border="0" title="Reporte de Plan de Acciones" 
						onmouseover="window.status='';return true" /><br/>
						<input type="image" src="../../images/btn-gen.png" name="btn1" id="bnt1" width="118" height="46" border="0" title="Reporte de Plan de Acciones"
						onclick="MM_nbGroup('down','group1','btn1','',1)" 
						onmouseover="MM_nbGroup('over','btn1','../../images/btn-gen-over.png','',1);window.estatus='';return true" 
