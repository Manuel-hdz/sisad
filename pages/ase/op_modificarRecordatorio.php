<?php
	...
	function guardarRegistro(){
		...
		if ($band==1){
			...
			if($dptos!=""){
				...
				registrarOperacion("bd_aseguramiento",$idRecordatorio,"ModRecordatorio",$_SESSION['usr_reg']);
	...
	if(isset($_POST['sbt_eliminar'])){
		//Registrar la Operacion en la Bitácora de Movimientos
		registrarOperacion("bd_aseguramiento",$_POST['rdb_id'],"EliminarRecordatorio",$_SESSION['usr_reg']);
		//Llamar a la funcion de eliminar Registro
		eliminarRegistro();
	}
