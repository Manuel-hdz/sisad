<?php
	...
	function mostrarDepartamentos(){
		...
		$stm_sql ="SELECT DISTINCT depto FROM usuarios ORDER BY depto";
			...
			do{	
				echo "	<tr>
							<td class='nombres_filas' align='center'>
								<input type='checkbox' id='ckb_dpto$cont' name='ckb_dpto$cont' value='$datos[depto]'/>
							</td>				
		...
		if(isset($_SESSION['lista'])&&isset($_POST['sbt_guardar'])){?>
			<script language="javascript" type="text/javascript">
				...
				function enviarMensaje(){
					//Enviamos un mensaje
					alert('Registro de Clasula Guardado Con Éxito. Agregue Más Clausulas o Presione Cancelar para Salir Del Registro');
	...
	function guardarRegistro(){
		...
		if($bandProc==1||$bandForm==1||$bandManu==1||$bandClau==1){
			...
			<script language="javascript" type="text/javascript">
				setTimeout("alert('Registro No Guardado. Verificque Valores o Intente Nuevamente');",500);
			</script><?php 
			...
			registrarOperacion("bd_aseguramiento",$claveManual,"RegListaMaestraDoc",$_SESSION['usr_reg']);			 
