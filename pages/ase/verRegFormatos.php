<?php
	...
	?>
	<p>&nbsp;</p>
	<form onsubmit="return valFormRegForm(this);"method="post"name="frm_agregarRegistro" id="frm_agregarRegistro" action="verRegFormatos.php">
    ...
    <br />
    	<table width="634" height="89"  cellpadding="5" cellspacing="5" class="tabla_frm">
        	<tr>
          		...
          		<td width="96"><input name="txt_cveProc" id="txt_cveProc" type="text" class="caja_de_texto" size="20" onkeypress="return permite(event,'num_car', 1);" value="<?php echo $clave; ?>"/></td>
          		<td><div align="right">*Titulo Procedimiento </div></td>
          		<td width="222"><textarea name="txa_tituloProc" id="txa_tituloProc" maxlength="120" onkeyup="return ismaxlength(this)" class="caja_de_texto" rows="2" cols="30"onkeypress="return permite(event,'num_car', 0);"><?php echo $titulo; ?></textarea></td>
        	</tr>
        	<tr>
          		<td><div align="right">*No de Revisi&oacute;n </div></td>
          		<td><input name="txt_noRevision" id="txt_noRevision" type="text" class="caja_de_texto" size="3" onkeypress="return permite(event,'num', 2);" value="<?php echo $rev; ?>" maxlength="3"/></td>
          		<td width="137"><div align="right">*Fecha</div></td>
          		<td width="222"><input name="txt_fecha" type="text" id="txt_fecha" size="10" maxlength="15" value="<?php echo $fecha;?>" readonly="readonly" style="background-color:#999999; color:#FFFFFF"/></td>
        	</tr>
    	</table>
	</fieldset>
    ...
    <br />
    	<table width="634" height="134"  cellpadding="5" cellspacing="5" class="tabla_frm">
        	<tr>
          		...
          		<td width="100"><input name="txt_noFormatoProc" id="txt_noFormatoProc" type="text" class="caja_de_texto" size="15" onkeypress="return permite(event,'num_car', 1);"/></td>
          		<td width="157"><div align="right">*Nombre de la Forma  </div></td>
          		<td width="198"><textarea name="txt_nombreForma" id="txt_nombreForma" maxlength="120" onkeyup="return ismaxlength(this)" class="caja_de_texto" rows="2" cols="30"onkeypress="return permite(event,'num_car', 0);"></textarea></td>
        	</tr>
        	<tr>
          		<td height="13"><div align="right">*No. Revisi&oacute;n de la Forma</div></td>
         		<td width="100"><input name="txt_noRevisionForma" id="txt_noRevisionForma" type="text" class="caja_de_texto" size="3" onkeypress="return permite(event,'num', 2);" maxlength="3"/></td>
          		<td width="157"><div align="right">*Entrada en Vigor </div></td>
          		<td width="198"><input name="txt_fecha2" type="text" id="txt_fecha2" size="10" maxlength="15" value="<?php echo date("d/m/Y");?>" readonly="readonly" style="background-color:#999999; color:#FFFFFF" /></td>
        	</tr>
        	<tr>
        	...
        	<tr>
				  ...
				  <div align="center">
				  	<?php if(isset($_SESSION['lista_maestra'])){?>
						<input name="btn_finalizar" type="button" class="botones" value="Finalizar" title="Finalizar al Registro" onmouseover="window.status='';return true"  onclick="window.close();" />
						&nbsp;&nbsp;&nbsp;
					<?php }?>
						<input name="sbt_agregar" type="submit" class="botones" id= "sbt_agregar" value="Agregar" title="Guardar Registro De Lista Maestra" onmouseover="window.status='';return true"/>
						&nbsp;&nbsp;&nbsp;
						...
						&nbsp;&nbsp;&nbsp;
						<input name="btn_cancelar" type="button" class="botones" value="Cerrar" title="Regresar al Registro de la Lista Maestra" onmouseover="window.status='';return true"  onclick="window.close();" />
          		</div>
			</td>
        </tr>
    </table>
