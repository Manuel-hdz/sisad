...
<title>Sistema de Gesti&oacute;n Empresarial, Producci&oacute;n y Operaci&oacute;n</title>
    ...
    <style type="text/css">
		<!--	
			...
			#tabla-consultar {position:absolute; left:30px; top:190px; width:600px; height:200px; z-index:14;}
			#calendarioInicio {position:absolute;left:295px;top:230px;width:30px;height:26px;z-index:15;}
			#calendarioFin {position:absolute;left:625px;top:230px;width:30px;height:26px;z-index:15;}
...
<body>
	...
	<div class="titulo_barra" id="titulo-reporte">Reporte de Pedidos</div>
	<?php
		...
		<table width="108%" border="0" cellpadding="5" cellspacing="5" class="tabla_frm">
			...
			<tr>
				...
				<td>
					<?php
					$conn = conecta("bd_recursos");
					$rs = mysql_query("SELECT * FROM cuentas ORDER BY descripcion");
					if($rs){
						$row=mysql_fetch_array($rs)
					?>
			...
			<tr>
				...
				<td>
					<?php
					$conn = conecta("bd_recursos");
					$rs = mysql_query("SELECT * FROM subcuentas ORDER BY descripcion");
					if($rs){
						$row=mysql_fetch_array($rs)
					?>
