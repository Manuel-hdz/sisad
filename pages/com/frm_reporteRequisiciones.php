...
<title>Sistema de Gesti&oacute;n Empresarial, Producci&oacute;n y Operaci&oacute;n</title>
    ...
    <style type="text/css">
		<!--	
			...
			#tabla-consultar {position:absolute; left:30px; top:190px; width:600px; height:150px; z-index:14;}
	...
	if(isset($_POST['verDetalle'])){
		...
		<table width="108%" border="0" cellpadding="5" cellspacing="5" class="tabla_frm">
			<tr>
				...
				<td>
					<input name="txt_fecha_ini" id="txt_fecha_ini" type="text" value=<?php echo date("d/m/Y");?> size="10" maxlength="15"
