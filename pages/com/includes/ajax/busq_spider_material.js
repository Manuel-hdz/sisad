...
function lookup_material(cajaTexto,num) {
	...
	if(inputString.length == 0) {
		...
		$.post("includes/ajax/busq_spider_material.php?nomCajaTexto="+nomCajaTexto+"&num="+num, {queryString: ""+inputString+""}, function(data){
