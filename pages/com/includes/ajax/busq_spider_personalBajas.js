...
function lookupBajasEmp(cajaTexto,num) {
	...
	if(inputString.length == 0) {
		...
		$.post("includes/ajax/busq_spider_personalBajas.php?nomCajaTexto="+nomCajaTexto+"&num="+num, {queryString: ""+inputString+""}, function(data){
