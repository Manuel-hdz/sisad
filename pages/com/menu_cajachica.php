        ...
        <table width="100%" border="0" align="center" cellpadding="5" cellspacing="5">
            <tr>
                <td width="50%" align="center">
                    <form action="frm_cajaChica.php">
                        <input type="image" src="images/add-cajachica.png" width="147" height="179" border="0" title="Registrar Caja Chica" 
                        onmouseover="window.status='';return true"/><br/>
						<input type="image" src="../../images/btn-reg.png" name="btn1" id="bnt1" width="118" height="46" border="0" title="Registrar Caja Chica"
                ...
                <td width="50%" align="center">
                    <form action="frm_consultarCajaChica.php">
						<input type="image" src="images/sea-cajachica.png" width="147" height="179" border="0" title="Consultar Caja Chica" 
                        onmouseover="window.status='';return true"/><br/>
						<input type="image" src="../../images/btn-sea.png" name="btn2" id="bnt2" width="118" height="46" border="0" title="Consultar Caja Chica"
