...
<body>
	<div id="parrilla-menu1" align="center">
		...
		if(isset($_GET['err'])) { 
			if($err=="AccesoNegado") {		
				$usuarios=verificarUsuarioPermisos("comaro");
				$band=0;
				...
				if($band==1){?>
 					<meta http-equiv="refresh" content="2;url=inicio_comaro.php">
					<p>
            	...
            	<meta http-equiv="refresh" content="7;url=inicio_comaro.php">
				<p>
