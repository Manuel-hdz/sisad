...
<?php
	...
	include ("op_agregarplatillo.php"); 
...
<body>
    ...
    <div class="titulo_barra" id="titulo-registrar">Agregar Platillos al Men&uacute;</div>
	...
	<br>
	<form name="frm_aregarPlatillos" method="post" action="frm_aregarPlatillos.php" onsubmit="return valFormAgregarPlatillo(this)">
		<table width="100%" border="0" align="left" cellpadding="5" cellspacing="5" class="tabla_frm">		
		<tr>
			<td><div align="right">*Descripcion</div></td>
			<td><textarea name="txa_descripcion" maxlength="60" cols="30" rows="3" class="caja_de_texto" id="txa_descripcion" style="resize:none;"></textarea></td>
			<td><div align="right">*Costo Venta</div></td>
			<td>
				$ <input type='text' name='txt_costo' id='txt_costo' class='caja_de_num' size='10' value="0.00" maxlength="10"
