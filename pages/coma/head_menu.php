...
<head>
	...
	<style type="text/css">
		...
		.usr-reg {color: #FFFFFF; font-weight: bold; font-family: MicrogrammaDMedExt; font-size: 12px; color:#FFF;}
		...
		#fecha {position:absolute; left:300px; top:59px; width:430px; height:18px;z-index:9;}
		.fecha {font-family: MicrogrammaDMedExt; font-size: 12px;color:#FFFFFF;font-weight:bold;color:#FFF;}		
...
<body onLoad="inicio(); setInterval(muestraReloj, 1000);" onkeypress="parar()" onclick="parar()" onmousemove="parar()">
  	...
  	<table width="50" border="0">    			
		<tr>
      		<td width="50" height="50">						
				<form action="inicio_comaro.php">						
					<input type="image" src="../../images/dock/home-comaro.png" name="icono1" id="icono1" width="50" height="50" border="0" title="Inicio MAINMI"					
					onClick="MM_nbGroup('down','group2','icono1','',1)" 
					onMouseOver="MM_nbGroup('over','icono1','../../images/dock/home-over-comaro.png','',1); window.status='';return true" onMouseOut="MM_nbGroup('out')" />
				</form>
			</td>
    	</tr>
  	</table>
	...
	<div id="menu" style="position:absolute; left:-15px; top:70px; width:1035px; height:85px; z-index:123;"> 
		<ul id="css3menu">
			<!--
			<li class="topfirst"><a href="menu_platillos.php" title="Men&uacute; Comaro" onMouseOver="window.status='';return true"><span>Men&uacute; Comaro</span></a>
				<ul>
					<li class="subfirst"><a href="frm_aregarPlatillos.php" title="Agregar Platillo al Men&uacute;" onMouseOver="window.status='';return true">Agregar Platillo</a></li>
					<!--<li class="subfirst"><a href="" title="Consultar Platillo al Men&uacute;" onMouseOver="window.status='';return true">Consultar Platillo</a></li>-->
			<!--
					<li class="subfirst"><a href="frm_modificarPlatillos.php" title="Modificar Platillo al Men&uacute;" onMouseOver="window.status='';return true">Modificar Platillo</a></li>
					<li class="subfirst"><a href="frm_aregarPlatilloDia.php" title="Agregar Platillo del Dia" onMouseOver="window.status='';return true">Agregar Platillo del Dia</a></li>
				</ul>
			</li>
			<li class="topfirst"><a href="menu_bitacoras.php" title="" onMouseOver="window.status='';return true"><span>Bitacoras</span></a>
				<ul>
					<li class="subfirst"><a href="frm_aregarBitacora.php" title="Agregar Bitacora" onMouseOver="window.status='';return true">Registrar Bitacora</a></li>
					<li class="subfirst"><a href="frm_consultarBitacora.php" title="Consultar Bitacora" onMouseOver="window.status='';return true">Consultar Bitacora</a></li>
					<li class="subfirst"><a href="frm_modificarBitacora.php" title="Modificar Bitacora" onMouseOver="window.status='';return true">Modificar Bitacora</a></li>
				</ul>
			</li>
			-->
			<li class="topfirst"><a href="menu_requisiciones.php" title="Requisiciones de MAINMI" onMouseOver="window.status='';return true">
			<span>Requisici&oacute;n</span></a>
				<ul>
					...
					<li class="subfirst"><a href="frm_consultarRequisicion.php" title="Consultar las Requisiciones de Recursos Humanos" 
	...
	<div id="barra-titulo-mod" style="position:absolute; left:0px; top:51px; width:1035px; height:30px; z-index:6; background-color: #666666; layer-background-color: #666666; border: 1px none #000000; visibility: inherit;">
		<img src="../../images/title-bar-bg-comaro.png" width="1035" height="30" />	
	</div>
	<div id="usuario" style="position:absolute; left:820px; top:54px; width:189px; height:17; z-index:7">  
	...
	<div id="modulo" class="usr-reg">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;M&oacute;dulo MAINMI</div>
