    	...
    	<tr>
			...
			<td width="25%" align="center">
				<form action="frm_generarRequisicion.php">
					...
					<input type="image" src="../../images/btn-add-comaro.png" name="btn5" id="btn5" width="118" height="46" border="0" 
                    title="Generar Requisici&oacute;n" onclick="MM_nbGroup('down','group1','btn5','',1)" 
                    onmouseover="MM_nbGroup('over','btn5','../../images/btn-add-comaro-over.png','',1);window.status='';return true" 
			...
			<td width="25%" align="center">
				<form action="frm_consultarRequisicion.php">
					<input type="image" src="images/sea-requisicion.png" width="130" height="200" border="0" title="Consultar Requisici&oacute;nes" 
                    onmouseover="window.status='';return true" /><br/>
					<input type="image" src="../../images/btn-sea-comaro.png" name="btn6" id="btn6" width="118" height="46" border="0" 
                    title="Registrar Becarios de Empleado" onclick="MM_nbGroup('down','group1','btn6','',1)" 
                    onmouseover="MM_nbGroup('over','btn6','../../images/btn-sea-comaro-over.png','',1);window.status='';return true" onmouseout="MM_nbGroup('out')"/>
				</form>
			</td>
			<td>
			</td>
