<?php
	function mostrarRequisiciones(){
		...
		$conec=conecta("bd_comaro");
		?>
		<table cellpadding='5' cellspacing='5' class='tabla_frm' width='100%'>
			<tr>
				<td colspan='4' align='center' class='titulo_etiqueta'>Requisiciones Publicadas por MAINMI entre el <?php echo modFecha($fechaI,2)." y el ".modFecha($fechaF,2); ?></td>
			</tr>
			<tr>
				<td colspan='4'>&nbsp;</td>
	      	</tr>
			<tr align='center'>
				<td class='nombres_columnas_comaro'>N&Uacute;MERO</td>
	        	<td class='nombres_columnas_comaro'>FECHA DE PUBLICACI&Oacute;N</td>
				<td class='nombres_columnas_comaro'>ESTADO</td>
				<td class='nombres_columnas_comaro'>PRIORIDAD</td>
				<td class='nombres_columnas_comaro'>SELECCIONAR</td>
			</tr>
			<?php
			if($filtro==""){
			...
			if($row = mysql_fetch_array($rs)){
				...
				do{
					...
					?>
					<tr>
						<td class='nombres_filas_comaro' align='center'>
	...
	function dibujarDetalle($clave_req){
		...
		if($datos=mysql_fetch_array($rs)){
			...
			<table cellpadding='5' width='100%'>
				...
				<tr>
					<td class='nombres_columnas_comaro' align='center'>CANTIDAD</td>
        			<td class='nombres_columnas_comaro' align='center'>UNIDAD</td>
			        <td class='nombres_columnas_comaro' align='center'>DESCRIPCI&Oacute;N</td>
        			<td class='nombres_columnas_comaro' align='center'>APLICACI&Oacute;N</td>
				</tr>
				<?php
				$nom_clase = "renglon_gris";
				$cont = 1;
