...
<?php
	...
	if(!verificarPermiso($usr_reg,$_SERVER['PHP_SELF'])){		
		...
		//Archivo con las operaciones de Consulta
...
<body>
    ...
    <div class="titulo_barra" id="titulo-consultar">Almac&eacute;n - Inventario de Materiales</div>
	...
	<div id="botones" align="center">
		<input type="button" name="btn_regresar" title="Regresar al Inicio" onclick="location.href='inicio_desarrollo.php';" value="Regresar" class="botones"
