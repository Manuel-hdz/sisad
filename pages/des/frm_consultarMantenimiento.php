...
<title>Sistema de Gesti&oacute;n Empresarial, Producci&oacute;n y Operaci&oacute;n</title>
    ...
    <style type="text/css">
		<!--	
			...
			#tabla-consultar-disponibilidad2 {position:absolute; left:520px; top:190px; width:315px; height:144px; z-index:14;}
			...
			#calendar-uno {position:absolute; left:720px; top:234px; width:30px; height:26px; z-index:18; }
			#calendar-dos {position:absolute; left:720px; top:270px; width:30px; height:26px; z-index:18; }
		-->
    </style>
...
<body>
	...
	<div class="titulo_barra" id="titulo-consultar-empleado">Mantenimiento - Reporte de Consumo de Aceites</div><?php 
	...
	if(isset($_POST["sbt_consultar"])){?>
		...
		<div align="center" id="botones">
			...
			onMouseOver="window.status='';return true" onclick="borrarHistorial();location.href='frm_consultarMantenimiento.php'" />
		</div>
	 ...
	 if(isset($_POST["sbt_consultar2"])){
		...
		if(isset($_POST["sbt_repDisp2"])){
			...
			<div align="center" id="botones">
				...
				?>
				<form method="post" action="frm_consultarMantenimiento.php">
	 ...
	 if(!isset($_POST["sbt_consultar"]) && !isset($_POST["sbt_consultar2"]) && !isset($_POST["sbt_repDisp2"])) { ?> 
		...
		<br>
		<form method="post" name="frm_reporteFecha" id="frm_reporteFecha" action="frm_consultarMantenimiento.php">
		...
		<br>
		<form method="post" name="frm_reporteDisponibilidad2" id="frm_reporteDisponibilidad2" action="frm_consultarMantenimiento.php">
