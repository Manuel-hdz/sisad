...
<body>
	...
	<form name="registrar_nomina" action="frm_continuarNomina.php" method="post">
    ...
    <?php
		...
		$msje="Registro de N&oacute;mina Desarrollo del <em><u>$_POST[txt_fechaIni_Con]</u></em> al <em><u>$_POST[txt_fechaFin_Con]</u></em>";
			...
			do{	 
				...
				<tr>
					...
					<td class=<?php echo $nom_clase; ?> align="center">
						...
						value="<?php echo $datos["horas_extra"]; ?>"/>
					</td>
					<td class=<?php echo $nom_clase; ?> align="center">
