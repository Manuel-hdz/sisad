...
<body>
    ...
    <div class="titulo_barra" id="titulo-consultar">Registrar Nomina</div>
	...
	<fieldset class="borde_seccion" id="tabla-consultarFechas-Con" name="tabla-consultarFechas-Con" style="top:400px">
		...
		<br>
		<form name="frm_reporteNomina" method="post" action="frm_continuarNomina.php" onsubmit="return valSeleccionarNomina(this);">
			<table width="415"  cellpadding="5" cellspacing="5" class="tabla_frm">
				<tr>
					...
					<td width="276">
						...
						value="<?php echo date("d/m/Y", strtotime("-7 day"));?>" readonly="readonly"
						onchange="cargarCmbNomina('cmb_nomina',this.value,txt_fechaFin_Con.value,'bd_desarrollo','DESARROLLO FRESNILLO','0')"/>
					</td>
					...
					onchange="cargarCmbNomina('cmb_nomina',txt_fechaIni_Con.value,this.value,'bd_desarrollo','DESARROLLO FRESNILLO','0')"/></td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="5">
						<div align="center">
							<input name="sbt_consultar_nom" type="submit" class="botones" id= "sbt_guardar" value="Consultar" title="Consultar N&oacute;mina Desarrollo"
							onMouseOver="window.status='';return true"/>
							&nbsp;&nbsp;
	...
	<script type="text/javascript">
		cargarCmbNomina('cmb_nomina',txt_fechaIni_Con.value,txt_fechaFin_Con.value,'bd_desarrollo','DESARROLLO FRESNILLO','0');
	</script>
