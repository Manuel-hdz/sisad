...
<body>
    ...
    <div class="titulo_barra" id="titulo-consultar">Reporte de Equipo Utilitario</div>
	<?php 
	...
	if (!isset($_POST["sbt_consultar"])){
		...
		<br>
		<form name="frm_consultarReporte" method="post" action="frm_reporteUtilitario.php"  onsubmit="return valFormConsultarReporte(this);">
		...
		<form name="frm_consultarResultados" method="post" action="guardar_reporte.php"><?php 
			...
			if ($res!="false"){
				...
				?>
					...
					<input type="hidden" name="hdn_tipoReporte" id="hdn_tipoReporte" value="reporteUtilitario"/>
				...
				onMouseOver="window.status='';return true" onclick="location.href='frm_reporteUtilitario.php'" />
			</div>
		</form>
	<?php }?>
</body>
