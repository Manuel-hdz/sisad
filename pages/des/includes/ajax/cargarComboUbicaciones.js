/**
  ...
  */
	...
	//1	Concreto-GT
	//2 Produccion
	function cargarUbicaciones(periodo,ubicacion){
		...
		if(periodo!=""){			
			...
			var url = "includes/ajax/cargarComboUbicaciones.php?periodo="+periodo;
			...
			objeto.length++;
			objeto.options[objeto.length-1].text="Clientes";
