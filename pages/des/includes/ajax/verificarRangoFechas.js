/**
  ...
  */
	...
	function verificarRangoValido(fecha1,fecha2,cliente){
		//Verificar al Ubicacion haya sido proporcionada		
		if(cliente!=""){
			//Crear la URL, la cual será solicitada al Servidor, el directorio inicia desde la obra del archivo donde esta siendo 
			//incluido este archivo JavaScript(validarDatoBD.js)
			var url = "includes/ajax/verificarRangoFechas.php?fecha1="+fecha1+"&fecha2="+fecha2+"&cliente="+cliente;
