<?php
	...
	if(isset($_GET["fecha1"])){
		...
		//Esta variable indicara si el rango de fechas seleccionado contiene el rango de fechas registrado en la BD para la ubicacion seleccionada
		//Crear la Sentencia SQL
		$sql_stm = "SELECT id_presupuesto FROM presupuesto WHERE '$fecha1'>=fecha_inicio AND '$fecha1'<=fecha_fin AND catalogo_clientes_id_cliente='$idUbicacion'";
		...
		$sql_stm2 = "SELECT id_presupuesto FROM presupuesto WHERE '$fecha2'>=fecha_inicio AND '$fecha2'<=fecha_fin AND catalogo_clientes_id_cliente='$idUbicacion' ";
		//Ejecutar la Sentencia previamente creada
		...
		if($bandF1==0&&$bandF2==0){
			//Crear la Sentencia SQL
			$sql_stm = "SELECT id_presupuesto FROM presupuesto WHERE fecha_inicio>='$fecha1' AND fecha_fin<='$fecha2' AND catalogo_clientes_id_cliente='$idUbicacion' ";
			//Ejecutar la Sentencia previamente creada
			$rs = mysql_query($sql_stm);
