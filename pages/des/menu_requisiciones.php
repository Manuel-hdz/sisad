  	...
  	<table class="tabla_frm" width="388" border="0" align="center" cellpadding="5" cellspacing="5">
    	<tr>
      		<td width="50%" align="center">
	    		<div align="center">
				<form action="menu_requisiciones2.php">
					<input type="image" src="images/add-requisicion.png"  width="100" height="158" border="0" title="Autorizar Requisici&oacute;n" 
					onmouseover="window.status='';return true" /><br/>
					<input type="image" src="../../images/btn-aut-requisicion.png" name="btn3" id="btn3" width="118" height="46" border="0" 
					title="Autorizar Requisici&oacute;n"	onclick="MM_nbGroup('down','group1','btn3','',1)" 
					onmouseover="MM_nbGroup('over','btn3','../../images/btn-aut-requisicion-over.png','',1);window.status='';return true"
			...
			<td width="50%" align="center">
				...
				<form action="frm_generarRequisicion.php">
					<input type="image" src="images/add-requisicion.png"  width="100" height="158" border="0" title="Generar Requisici&oacute;n" 
					onmouseover="window.status='';return true" /><br/>
					<input type="image" src="../../images/btn-gen-requisicion.png" name="btn1" id="btn1" width="118" height="46" border="0" 
					title="Generar Requisici&oacute;n"	onclick="MM_nbGroup('down','group1','btn1','',1)" 
					onmouseover="MM_nbGroup('over','btn1','../../images/btn-gen-requisicion-over.png','',1);window.status='';return true"
					onmouseout="MM_nbGroup('out')"/>
	    		</form>
    		  </div>
			</td>
      		<td width="50%" align="center">
				...
				<form action="frm_consultarRequisiciones.php">
					<input type="image" src="images/sea-requisicion.png" width="100" height="158" border="0" title="Consultar Estado Requisiciones" 
					onmouseover="window.status='';return true"/><br/>
					<input type="image" src="../../images/btn-est-req.png" name="btn2" id="btn2" width="118" height="46" border="0" 
					title="Consultar Estado Requisiciones" 	onclick="MM_nbGroup('down','group1','btn2','',1)" 
					onmouseover="MM_nbGroup('over','btn2','../../images/btn-est-req-over.png','',1);window.status='';return true"  onmouseout="MM_nbGroup('out')"/>
	    		</form>
	 		  </div>
	  		</td>
    	</tr>
