  	...
  	<table class="tabla_frm" width="388" border="0" align="center" cellpadding="5" cellspacing="5">
    	<tr>
      		<td width="50%" align="center">
	    		<div align="center">
				<form action="frm_registrarServicios.php">
					<input type="image" src="images/add-registroServicio.png"  width="200" height="200" border="0" 
					title="Registrar Servicios Realizados a Minera Fresnillo" onmouseover="window.status='';return true" /><br/>
					<input type="image" src="../../images/btn-add.png" name="btn1" id="bnt1" width="118" height="46" border="0" 
					title="Registrar Servicios Realizados a Minera Fresnillo"
      		...
      		<td width="50%" align="center">
	    		<div align="center">
				<form action="frm_modificarServicios.php">
					<input type="image" src="images/upd-registroServicio.png" width="200" height="200" border="0" 
					title="Modificar Registro de Servicios Realizados a Minera Fresnillo" onmouseover="window.status='';return true"/><br/>
					<input type="image" src="../../images/btn-upd.png" name="btn2" id="bnt2" width="118" height="46" border="0" 
					title="Modificar Registro de Servicios Realizados a Minera Fresnillo" 
