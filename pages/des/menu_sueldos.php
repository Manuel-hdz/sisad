  	...
  	<table class="tabla_frm" width="656" border="0" align="center" cellpadding="5" cellspacing="5">
    	<tr>
      		<!-- <td width="33%" align="center">
	    		<div align="center">
				<form action="frm_catSueldos.php">
					<input type="image" src="images/upd-catalogoSueldos.png"  width="170" height="200" border="0" title="Actualizar Cat&aacute;logo de Sueldos" onmouseover="window.status='';return true" /><br/>
					<input type="image" src="../../images/btn-upd.png" name="btn1" id="bnt1" width="118" height="46" border="0" title="Actualizar Cat&aacute;logo de Sueldos"
					onclick="MM_nbGroup('down','group1','btn1','',1)" onmouseover="MM_nbGroup('over','btn1','../../images/btn-upd-over.png','',1);window.status='';return true" onmouseout="MM_nbGroup('out')"/>
	    		</form>
    		  </div>
			</td>
      		<td width="33%" align="center">
	    		<div align="center">
				<form action="frm_catIncentivos.php">
					<input type="image" src="images/upd-registrarBono.png" width="170" height="200" border="0" title="Actualizar Cat&aacute;logo de Incentivos" onmouseover="window.status='';return true"/><br/>
					<input type="image" src="../../images/btn-upd.png" name="btn2" id="bnt2" width="118" height="46" border="0" title="Actualizar Cat&aacute;logo de Incentivos" 
