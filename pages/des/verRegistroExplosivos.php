...
<head>
	...
	<script type="text/javascript" language="javascript">
		...
		function habilitarBoton(){
			window.opener.document.getElementById("btn_verExplosivo<?php echo $no;?>").disabled=false;
		}
		//-->
	</script>
...
<body onunload="habilitarBoton();">
	...
	$stm_sql="SELECT nombre,SUM(cantidad) AS cant,medida FROM explosivos_empleados JOIN catalogo_explosivos ON id_explosivos=catalogo_explosivos_id_explosivos WHERE bitacora_avance_id_bitacora='$id_bit' GROUP BY nombre";
	$rs=mysql_query($stm_sql);
	if($datos=mysql_fetch_array($rs)){
		echo "				
				<br>
				<table cellpadding='5' width='100%'> 
				<caption class='titulo_etiqueta'>Explosivo Cosumido del Registro Seleccionado</caption>
				<thead>
					<tr>
			...
			do{	
				echo "	<tr>
						...
						<td class='$nom_clase' align='center'>$datos[cant]</td>
			...
			echo "<p class='msje_correcto' align='center'><br><br><br><br><br><br><br><br><br>No hay Registros de Explosivo Cosumido para el Registro Seleccionado</u></em></p>";
		}
		?>
