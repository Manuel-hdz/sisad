...
<head>
	...
	<script type="text/javascript" language="javascript">
		...
		function habilitarBoton(){
			window.opener.document.getElementById("btn_verFallas<?php echo $no;?>").disabled=false;
		}
		//-->
	</script>
...
<body onunload="habilitarBoton();">
	...
	$stm_sql="SELECT equipo,tipo,descripcion,tiempo_gastado FROM bitacora_fallas WHERE tipo_registro='$tipo_reg' AND (bitacora_avance_id_bitacora='$id_bit' OR bitacora_retro_bull_id_bitacora='$id_bit')";
	$rs=mysql_query($stm_sql);
	if($datos=mysql_fetch_array($rs)){
		echo "				
				<br>
				<table cellpadding='5' width='100%'> 
				<caption class='titulo_etiqueta'>Fallas del Registro Seleccionado</caption>
				<thead>
					<tr>
						<th class='nombres_columnas' align='center'>NO.</th>
        				<th class='nombres_columnas' align='center'>EQUIPO</th>
				        <th class='nombres_columnas' align='center'>TIPO FALLA</th>
						<th class='nombres_columnas' align='center'>DESCRIPCI&Oacute;N</th>
						<th class='nombres_columnas' align='center'>TIEMPO GASTADO</th>
      				</tr>
				</thead>";
			...
			do{	
				echo "	<tr>
						...
						<td class='$nom_clase' align='center'>$datos[equipo]</td>
						<td class='$nom_clase' align='center'>$datos[tipo]</td>
						<td class='$nom_clase' align='center'>$datos[descripcion]</td>
						<td class='$nom_clase' align='center'>$datos[tiempo_gastado] HORAS</td>
						</tr>
						";
			...
			echo "<p class='msje_correcto' align='center'><br><br><br><br><br><br><br><br><br>No hay Registros de Fallas para el Registro Seleccionado</u></em></p>";
		}
		?>
