...
<?php
	...
	<style type="text/css">
		...
		#form-selecPeriodo {position:absolute;left:30px;top:190px;width:300px;height:140px;z-index:14;}
...
<body>
	...
	<div class="titulo_barra" id="titulo-barra">Reporte Entradas VS Salidas</div>
	...
	<table border="0" align="center" cellpadding="5" cellspacing="5" class="tabla_frm">
		...
		<tr>
			<td colspan="2" align="center">
				...
				<input name="btn_reporte" type="button" class="botones" value="Ver Reporte" onMouseOver="window.status='';return true" title="Ver Entradas Registradas en el Almac&eacute;n" onclick="mostrarReporteES(3,txt_fechaInicio.value,txt_fechaCierre.value);"/>
				&nbsp;&nbsp;&nbsp;&nbsp;
