...
<?php
	...
	<script type="text/javascript" src="includes/ajax/reportesAlmacen.js"></script>	
...
<body>
	...
	<div class="titulo_barra" id="titulo-barra">Reporte Salidas</div>
	...
	<table border="0" align="center" cellpadding="5" cellspacing="5" class="tabla_frm">
		...
		<tr>
			<td colspan="2" align="center">
				...
				<input name="btn_reporte" type="button" class="botones" value="Ver Reporte" onMouseOver="window.status='';return true" title="Ver Entradas Registradas en el Almac&eacute;n" onclick="mostrarReporteSalidas(2,txt_fechaInicio.value,txt_fechaCierre.value,cmb_orden.value);"/>
				&nbsp;&nbsp;&nbsp;&nbsp;
				<input name="btn_cancelar" type="button" class="botones" value="Regresar" title="Regresar al Men&uacute; de Reportes de Almac&eacute;n" onClick="borrarHistorial();location.href='submenu_almacen.php'" />
			</td>
		</tr>
	</table>    
	</form>    			 	
	...
	<div id="consultarDetalle">
		<img src='images/verDetalle.png' width='100%' height='100%' title='Consultar a Detalle la Consulta' border=0 onclick="mostrarDetalleSalidas('hdn_fechaI','hdn_fechaF','hdn_combo');" style="cursor:pointer"/>
	</div>
