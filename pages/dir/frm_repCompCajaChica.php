...
<?php
	...
	<script type="text/javascript" src="includes/ajax/reportesCom.js"></script>	
	<script type="text/javascript" language="javascript">
		function detalle(fechaI,fechaF,combo){
			fechaI=document.getElementById(fechaI).value;
			fechaF=document.getElementById(fechaF).value;
			combo=document.getElementById(combo).value;
			window.open('verCajaChicaDetalle.php?fechaI='+fechaI+'&fechaF='+fechaF+'&combo='+combo,'_blank','top=100,left=100,width=800,height=600,status=no,menubar=no,resizable=yes,scrollbars=yes,toolbar=no,location=no, directories=no');
		}
	</script>
...
<body>
	...
	<div class="titulo_barra" id="titulo-barra">Reporte Movimientos Caja Chica</div>
	...
	<table border="0" align="center" cellpadding="5" cellspacing="5" class="tabla_frm">
		...
		<tr>
			<td style="color:#FFFFFF"><div align="right">Ordenar Por:</div></td>
			<td>
				<select class="combo_box" name="cmb_orden" id="cmb_orden">
					<option value="fecha" selected="selected">Orden</option>
		...
		<tr>
			<td colspan="2" align="center">
				<input type="hidden" id="hdn_fechaI" value="" name="hdn_fechaI"/>
				<input type="hidden" id="hdn_fechaF" value="" name="hdn_fechaF"/>
				<input type="hidden" id="hdn_combo" value="" name="hdn_combo"/>
				<input name="btn_reporte" type="button" class="botones" value="Ver Reporte" onMouseOver="window.status='';return true" title="Ver Entradas Registradas en el Almac&eacute;n" onclick="mostrarReporteCajaChica(4,txt_fechaInicio.value,txt_fechaCierre.value,cmb_orden.value);"/>
				&nbsp;&nbsp;&nbsp;&nbsp;
				<input name="btn_cancelar" type="button" class="botones" value="Regresar" title="Regresar al Men&uacute; de Reportes de Compras" onClick="borrarHistorial();location.href='submenu_compras.php'" />
			</td>
		</tr>
	</table>    
	</form>    			 	
	...
	<div id="calendario_repInicio">
		<input name="calendario_iniRep" type="image" id="calendario_iniRep" onclick="displayCalendar(document.frm_reporteSalidas.txt_fechaInicio,'dd/mm/yyyy',this)" 
	...
	<div id="calendario_repCierre">
		<input name="calendario_cieRep" type="image" id="calendario_cieRep" onclick="displayCalendar(document.frm_reporteSalidas.txt_fechaCierre,'dd/mm/yyyy',this)" 
		onmouseover="window.status='';return true" src="../../images/calendar.png" align="absbottom" width="25" height="25" border="0" />
	</div>

	<div id="consultarDetalle">
		<img src='images/verDetalle.png' width='100%' height='100%' title='Consultar a Detalle la Consulta' border=0 onclick="detalle('hdn_fechaI','hdn_fechaF','hdn_combo');" style="cursor:pointer"/>
	</div>
