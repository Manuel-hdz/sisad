...
<body>
	...
	<div class="titulo_barra" id="titulo-barra">Reporte Compras </div>
		...
		<tr>
			...
			<td>
				<select class="combo_box" name="cmb_orden" id="cmb_orden">
					...
					<option value="proveedores_rfc">PROVEEDOR</option>
					<option value="depto_solicitor">DEPARTAMENTO</option>
					<option value="via_pedido">VIA PEDIDO</option>
					<option value="solicitor">SOLICITOR</option>
					<option value="tipo_moneda">TIPO MONEDA</option>
				</select>
			</td>
		</tr>
		<tr>
			<td colspan="2" align="center">
				<input name="btn_reporte" type="button" class="botones" value="Ver Reporte" onMouseOver="window.status='';return true" title="Ver Entradas Registradas en el Almac&eacute;n" onclick="mostrarReporteCompras(1,txt_fechaInicio.value,txt_fechaCierre.value,cmb_orden.value);"/>
				&nbsp;&nbsp;&nbsp;&nbsp;
