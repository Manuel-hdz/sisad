	...
	<table border="0" align="center" cellpadding="5" cellspacing="5" class="tabla_frm">
		...
		<tr>
			...
			<td>
				<select class="combo_box" name="cmb_orden" id="cmb_orden">
					...
					<option value="vendio">VENDEDOR</option>
		...
		<tr>
			<td colspan="2" align="center">
				<input name="btn_reporte" type="button" class="botones" value="Ver Reporte" onMouseOver="window.status='';return true" title="Ver Entradas Registradas en el Almac&eacute;n" onclick="mostrarReporteVentas(2,txt_fechaInicio.value,txt_fechaCierre.value,cmb_orden.value);"/>
				&nbsp;&nbsp;&nbsp;&nbsp;
