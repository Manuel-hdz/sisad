...
<head>
	...
	<script type="text/javascript" src="includes/ajax/reportesDesarrollo.js" ></script>
...
<body>
	...
	<table width="100%" cellpadding="5" cellspacing="5" class="tabla_frm">
		<tr>
			...
			<td width="60%"><?php 
					...
					if($datos = mysql_fetch_array($rs)){
						$fecha=date("Y-m-d");
						?>
						<select name="cmb_periodo" id="cmb_periodo" class="combo_box" onchange="cargarUbicaciones(this.value,'cmb_cliente',3)">
						...
						echo "<label class='msje_correcto'> No hay Periodos Registrados</label>
							<input type='hidden' name='cmb_periodo' id='cmb_periodo' value=''/>";
					}
		...
		<tr>
			<td align="right" style="color:#FFFFFF">Clientes</td>
			<td >
			<?php if ($res=="si") {?>
		...
		<tr>
			<td colspan="2" align="center">
				...
				onclick="reporteDesarrollo(1,document.getElementById('cmb_periodo').value,cmb_cliente.value);"/>
				&nbsp;&nbsp;&nbsp;
				<input type="button" name="btn_regresar" value="Regresar" class="botones" onclick="borrarHistorial();location.href='submenu_desarrollo.php'" title="Regresar al Men&uacute; de Reportes de Zarpeo" />
			</td>
		</tr>		
	</table>
</fieldset>
