...
<head>
    ...
    <style type="text/css">
		...
		#resultados{position:absolute;left:360px;top:190px;width:620px; height:475px;;z-index:14;}
		-->
    </style>
</head>
<body>
	...
	<div class="titulo_barra" id="titulo-barra">Reporte Comparativo Mensual </div>
	...
	<table width="100%" cellpadding="5" cellspacing="5" class="tabla_frm">
		...
		<tr>
			<td colspan="2" align="center">
				<input type="button" name="sbt_consultar" value="Consultar" class="botones" onmouseover="window.status='';return true" title="Consultar el Periodo Seleccionado" onclick="mostrarReporteMensual(4,cmb_periodo);"/>
				&nbsp;&nbsp;&nbsp;
	...
	<div id="resultados" class="borde_seccion2" style="visibility:hidden"></div>
</body>
