...
<body>
	...
	<div class="titulo_barra" id="titulo-barra">Reporte Servicios Mantenimiento Preventivo</div>
	...
	<table border="0" align="center" cellpadding="5" cellspacing="5" class="tabla_frm">
		...
		<tr>
			<td colspan="2" align="center">
				...
				<input name="btn_reporte" type="button" class="botones" value="Ver Reporte" onMouseOver="window.status='';return true" title="Ver Mantenimientos Preventivos" onclick="mostrarReportePreventivo(1,txt_fechaInicio.value,txt_fechaCierre.value,cmb_orden.value,'<?php echo substr($tipo,0,1) ?>');"/>
				&nbsp;&nbsp;&nbsp;&nbsp;
