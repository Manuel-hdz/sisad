...
<body>
	...
	<br>	
	<form name="frm_reporteBolsaTrabajo">
	<table border="0" align="center" cellpadding="5" cellspacing="5" class="tabla_frm">
		...
		<tr>
			<td colspan="2" align="center">
				<input name="btn_reporte" type="button" class="botones" value="Ver Reporte" onMouseOver="window.status='';return true" title="Ver Incidencias de Kardex en las Fechas Ingresadas" onclick="mostrarReporteBolsaTrabajo(3,txt_fechaInicio.value,txt_fechaCierre.value,cmb_area.value);"/>
				&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<div id="calendario_repInicio">
		<input name="calendario_iniRep" type="image" id="calendario_iniRep" onclick="displayCalendar(document.frm_reporteBolsaTrabajo.txt_fechaInicio,'dd/mm/yyyy',this)" 
	...
	<div id="calendario_repCierre">
		<input name="calendario_cieRep" type="image" id="calendario_cieRep" onclick="displayCalendar(document.frm_reporteBolsaTrabajo.txt_fechaCierre,'dd/mm/yyyy',this)" 
		onmouseover="window.status='';return true" src="../../images/calendar.png" align="absbottom" width="25" height="25" border="0" />
	</div>
