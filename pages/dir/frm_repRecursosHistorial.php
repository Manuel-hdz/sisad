...
<body>
	...
	<div class="titulo_barra" id="titulo-barra">Reporte Hist&oacute;rico de Trabajadores </div>
	...
	<br>	
	<form name="frm_reporteHistorial">
	<table border="0" align="center" cellpadding="5" cellspacing="5" class="tabla_frm">
		...
		<tr>
			...
			<td>
				...
				$result=mysql_query("SELECT DISTINCT area FROM empleados WHERE area NOT LIKE '%PAILERIA%' ORDER BY area");?>
		...
		<tr>
			<td colspan="2" align="center">
				<input name="btn_reporte" type="button" class="botones" value="Ver Reporte" onMouseOver="window.status='';return true" title="Ver Historial de Altas, Bajas y Modificaciones de Puesto" onclick="mostrarReporteHistorial(2,txt_fechaInicio.value,txt_fechaCierre.value,cmb_area.value);"/>
				&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<input type="hidden" name="hdn_fechaI" id="hdn_fechaI" value=""/>
	<input type="hidden" name="hdn_fechaF" id="hdn_fechaF" value=""/>
	<input type="hidden" name="hdn_combo" id="hdn_combo" value=""/>
	</form>    			 	
	</fieldset>
		
	<div id="calendario_repInicio">
		<input name="calendario_iniRep" type="image" id="calendario_iniRep" onclick="displayCalendar(document.frm_reporteHistorial.txt_fechaInicio,'dd/mm/yyyy',this)" 
	...
	<div id="calendario_repCierre">
		<input name="calendario_cieRep" type="image" id="calendario_cieRep" onclick="displayCalendar(document.frm_reporteHistorial.txt_fechaCierre,'dd/mm/yyyy',this)" 
		onmouseover="window.status='';return true" src="../../images/calendar.png" align="absbottom" width="25" height="25" border="0" />
	</div>

	<div id="consultarDetalle">
		<img src='images/verDetalle.png' width='100%' height='100%' title='Consultar a Detalle la Consulta' border=0 onclick="mostrarDetalleRH('hdn_fechaI','hdn_fechaF','hdn_combo');" style="cursor:pointer"/>
	</div>
