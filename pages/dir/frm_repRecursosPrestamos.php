	...
	<table border="0" align="center" cellpadding="5" cellspacing="5" class="tabla_frm">
		...
		<tr>
			<td colspan="2" align="center">
				<input name="btn_reporte" type="button" class="botones" value="Ver Reporte" onMouseOver="window.status='';return true" title="Ver Reporte de Pr&eacute;stamos" onclick="mostrarReportePrestamos(4,txt_fechaInicio.value,txt_fechaCierre.value,cmb_area.value);"/>
				&nbsp;&nbsp;&nbsp;&nbsp;
