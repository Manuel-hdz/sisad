...
<?php
	...
	<script language="javascript" type="text/javascript">
		setTimeout("cargarComboClaves(2,document.getElementById('txt_fechaInicio').value,document.getElementById('txt_fechaCierre').value,'cmb_actas');",500);
	</script>

<style type="text/css">
		<!--
		#titulo-barra {position:absolute;left:30px;top:146px; width:337px;height:20px;z-index:11;}
		#form-selecPeriodo {position:absolute;left:30px;top:190px;width:300px;height:180px;z-index:12;}
...
<body>
	...
	<div class="titulo_barra" id="titulo-barra">Reporte Actas Comisi&oacute;n Seguridad e Higiene </div>
	...
	<table border="0" align="center" cellpadding="5" cellspacing="5" class="tabla_frm">
		<tr>
			<td width="40%" style="color:#FFFFFF"><div align="right">Fecha de Inicio</div></td>
		  	<td width="60%">
				...
				onchange="cargarComboClaves(2,txt_fechaInicio.value,txt_fechaCierre.value,'cmb_actas');"/>
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td style="color:#FFFFFF"><div align="right">Clave Acta</div></td>
			<td>
				<select class="combo_box" name="cmb_actas" id="cmb_actas">
					<option value="fecha" selected="selected">Clave</option>
				</select>
			</td>
		</tr>
		<tr>
			<td colspan="2" align="center">
				<input name="btn_reporte" type="button" class="botones" value="Ver Reporte" onMouseOver="window.status='';return true" title="Ver Acta de la Comisi&oacute;n de Seguridad e Higiene" onclick="mostrarReporteCSH(cmb_actas.value);"/>
				&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<div id="calendario_repInicio">
		<input name="calendario_iniRep" type="image" id="calendario_iniRep" onclick="displayCalendar(document.frm_reporteCSH.txt_fechaInicio,'dd/mm/yyyy',this)" 
	...
	<div id="calendario_repCierre">
		<input name="calendario_cieRep" type="image" id="calendario_cieRep" onclick="displayCalendar(document.frm_reporteCSH.txt_fechaCierre,'dd/mm/yyyy',this)" 
		onmouseover="window.status='';return true" src="../../images/calendar.png" align="absbottom" width="25" height="25" border="0" />
	</div>
</body>
