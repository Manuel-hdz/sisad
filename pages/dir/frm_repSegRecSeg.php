...
<?php
	...
	<script language="javascript" type="text/javascript">
		setTimeout("cargarComboClaves(1,document.getElementById('txt_fechaInicio').value,document.getElementById('txt_fechaCierre').value,'cmb_recorrido');",500);
	</script>
...
<body>
	...
	<div class="titulo_barra" id="titulo-barra">Reporte Recorridos de Seguridad</div>
	...
	<table border="0" align="center" cellpadding="5" cellspacing="5" class="tabla_frm">
		<tr>
			<td width="40%" style="color:#FFFFFF"><div align="right">Fecha de Inicio</div></td>
		  	<td width="60%">
				...
				onchange="cargarComboClaves(1,txt_fechaInicio.value,txt_fechaCierre.value,'cmb_recorrido');"/>
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td style="color:#FFFFFF"><div align="right">Clave Recorrido</div></td>
			<td>
				<select class="combo_box" name="cmb_recorrido" id="cmb_recorrido">
		...
		<tr>
			<td colspan="2" align="center">
				<input name="btn_reporte" type="button" class="botones" value="Ver Reporte" onMouseOver="window.status='';return true" title="Ver Detalle del Recorrido de Seguridad" onclick="mostrarReporteRecSeg(cmb_recorrido.value);"/>
				&nbsp;&nbsp;&nbsp;&nbsp;
