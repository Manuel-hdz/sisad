...
<head>
    ...
    <style type="text/css">
		...
		#resultados{position:absolute;left:380px;top:191px;width:628px; height:399px;;z-index:14;overflow:hidden;}
...
<body>
	...
	<div class="titulo_barra" id="titulo-barra">Reporte Planos Cargados </div>
	...
	<table border="0" align="center" cellpadding="5" cellspacing="5" class="tabla_frm">
		...
		<tr>
			<td colspan="2" align="center">
				<input name="btn_reporte" type="button" class="botones" value="Consultar" onMouseOver="window.status='';return true" title="Ver Planos Registrados en Topograf&iacute;a" onclick="mostrarReportePlanos(1,txt_fechaInicio.value,txt_fechaCierre.value);"/>
				&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<div id="calendario_repInicio">
		<input name="calendario_iniRep" type="image" id="calendario_iniRep" onclick="displayCalendar(document.frm_reportePlanos.txt_fechaInicio,'dd/mm/yyyy',this)" 
	...
	<div id="calendario_repCierre">
		<input name="calendario_cieRep" type="image" id="calendario_cieRep" onclick="displayCalendar(document.frm_reportePlanos.txt_fechaCierre,'dd/mm/yyyy',this)" 
		onmouseover="window.status='';return true" src="../../images/calendar.png" align="absbottom" width="25" height="25" border="0" />
	</div>
