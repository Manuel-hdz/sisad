...
<body onfocus="borrarHistorial()">
	...
	<table class="tabla_frm" width="100%" border="0" align="center" cellpadding="5" cellspacing="5">
    	<tr>
      		<td width="50%" align="center">
	    		<div align="center">
				<form action="frm_repGerenciaAvancePpto.php">
      		...
      		<td width="50%" align="center">
				...
				<form action="frm_repGerenciaCompMina.php">
					<input type="image" src="images/rep-ger-2.png" name="icon2" id="icon2" width="200" height="200" border="0" title="Reporte Anual de Avance Real por Cliente" 
					onclick="MM_nbGroup('down','group1','icon2','',1)" onmouseover="MM_nbGroup('over','icon2','images/rep-ger-2-over.png','',1);window.status='';return true"  onmouseout="MM_nbGroup('out')"/>
	    		</form>
	 		  </div>
	  		</td>
		</tr>
	...
	<table class="tabla_frm" width="100%" border="0" align="center" cellpadding="5" cellspacing="5">
		<tr>
			<td width="50%" align="center">
	    		<div align="center">
				<form action="frm_repGerenciaAnual.php">
					<input type="image" src="images/rep-ger-3.png" name="icon3" id="icon3" width="200" height="200" border="0" title="Reporte Anual de Obras" 
					onclick="MM_nbGroup('down','group1','icon3','',1)" onmouseover="MM_nbGroup('over','icon3','images/rep-ger-3-over.png','',1);window.status='';return true"  onmouseout="MM_nbGroup('out')"/>
	    		</form>
	 		  </div>
	  		</td>
			...
			<td width="50%" align="center">
	    		<div align="center">
				<form action="frm_repGerenciaMensual.php">
					<input type="image" src="images/rep-ger-4.png" name="icon4" id="icon4" width="200" height="200" border="0" title="Reporte Mensual por Cliente" 
					onclick="MM_nbGroup('down','group1','icon4','',1)" onmouseover="MM_nbGroup('over','icon4','images/rep-ger-4-over.png','',1);window.status='';return true"  onmouseout="MM_nbGroup('out')"/>
	    		</form>
	 		  </div>
	  		</td>
    	</tr>
