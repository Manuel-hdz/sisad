	...
	<br /><br /><br /><br /><br />
    	<tr>
      		<td width="33%" align="center">
	    		<div align="center">
				<form action="frm_repTopografiaConc.php">
					<input type="image" src="images/rep-top-1.png" name="icon1" id="icon1" width="200" height="200" border="0" title="Reporte de Conciliaci&oacute;n"
					onclick="MM_nbGroup('down','group1','icon1','',1)" onmouseover="MM_nbGroup('over','icon1','images/rep-top-1-over.png','',1);window.status='';return true"  onmouseout="MM_nbGroup('out')"/>
	    		</form>
    		  </div>
			</td>
      		<td width="33%" align="center">
	    		<div align="center">
				<form action="frm_repTopografiaPlanos.php">
					<input type="image" src="images/rep-top-2.png" name="icon2" id="icon2" width="200" height="200" border="0" title="Planos Topogr&aacute;ficos" 
					onclick="MM_nbGroup('down','group1','icon2','',1)" onmouseover="MM_nbGroup('over','icon2','images/rep-top-2-over.png','',1);window.status='';return true"  onmouseout="MM_nbGroup('out')"/>
	    		</form>
	 		  </div>
	  		</td>
    	</tr>
