...
<?php
	...
	/**
	  ...
	  * Fecha: 05/Abril/2011
	  * Descripción: Este archivo contiene funciones para Ver las Capacitaciones de los Empleados
	  **/ 
...
function mostrarCapacitaciones(){	
	...
	if($datos = mysql_fetch_array($rs)){
		...
		<caption class='titulo_etiqueta' style='color:#FFF'>Capacitaciones Recibidas por $nombre</caption></br>";
		echo "
		<tr>
