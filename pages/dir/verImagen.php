<?php
	...
	/**
	  ...
	  * Fecha: 01/Abril/2011
	  * Descripción: Este archivo contiene funciones para Ver la Imágen relacionada con el personal de Recursos Humanos
	  **/ 
...
function mostrarImagen(){	
	...
	$sql = "SELECT fotografia, mime FROM empleados WHERE rfc_empleado = '$id_empleado'";
