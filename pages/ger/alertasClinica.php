<?php
	...
	function desplegarAlertasHC(){
		...
		FROM alerta_examen WHERE catalogo_departamentos_id_departamento = '2' AND estado = '1' ";		
	...
	function mostrarAlertasClinica($idNumEmpleado, $ctrl){		
		...
		$stm_sql = "SELECT catalogo_departamentos_id_departamento, area, puesto_realizar, fecha_programada, alerta_examen.nom_empleado, alerta_examen.id_empleados_empresa 
