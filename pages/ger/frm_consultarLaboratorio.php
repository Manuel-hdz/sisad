...
html xmlns="http://www.w3.org/1999/xhtml"><?php
	...
	//Comprobar que el usuario registrado tenga acceso a esta seccion de Gerencia Tecnica
            ...
            <tr>
                <td colspan="2" align="center">
                  <input name="sbt_continuar" id="sbt_continuar" type="submit" class="botones" value="Continuar" onmouseover="window.status='';return true" 
                    ...
                    &nbsp;&nbsp;&nbsp;
                    <input name="btn_regresar" type="button" class="botones" value="Regresar" onclick="location.href='frm_selTipoConsultaLaboratorio.php';"
                    title="Regresar a Seleccionar Otro Tipo de Reporte"/> 
                </td>
            </tr>
        </table>
        </form>
