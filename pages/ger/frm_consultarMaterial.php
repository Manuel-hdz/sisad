...
<?php
	...
	//Comprobar que el usuario registrado tenga acceso a esta seccion del Módulo Gerencia Técnica
...
<head>
    ...
    <style type="text/css">
		...
		#resultado-consulta { position:absolute; left:30px; top:190px; width:950px; height:420px; z-index:12; overflow:scroll; }
		...
		#btns-regpdf { position: absolute; left:30px; top:630px; width:900px; height:40px; z-index:23; }
		-->
    </style>
</head>
<body>
...
<?php //Si las variables $cmb_material, $cmb_lineaArticulo, $cmb_param2 y $hdn_verTodo no estan definidas mostrar los formularios 
	...
	<br>
	<table width="100%" border="0" align="left" class="tabla_frm" cellpadding="5">
	...
	<form onSubmit="return valFormConsultarCategoria(this);" name="frm_consultarCategoria" method="post" action="frm_consultarMaterial.php">
		<tr>
			<td><div align="right">Categor&iacute;a</div></td>
			<td><?php $lnArt= cargarCombo("cmb_lineaArticulo","linea_articulo","materiales","bd_almacen","Categor&iacute;a","");?></td>
		</tr>
		<tr>
		...
		<tr>
	  		<td colspan="2"><div align="center"><input name="btn_consultar" type="submit" class="botones" value="Consultar" onmouseover="window.status='';return true" 
	...
	<form onSubmit="return valFormConsultarClave(this);" name="frm_consultarClave" method="post" action="frm_consultarMaterial.php">
		<tr>
			...
			<td><input type="text" name="txt_clave" id="txt_clave" size="10" maxlength="10" onkeypress="return permite(event,'num_car');" /></td>
		</tr>
		<tr>
	  		<td colspan="2">
			<div align="center"><input name="btn_consultar" type="submit" class="botones" value="Consultar" onmouseover="window.status='';return true" title="Consultar Material por Clave"/></div>			</td>
		</tr>
	</form>
	</table>	  			
</fieldset>	
	...
	<br>
	<table width="100%" border="0" class="tabla_frm" cellpadding="5">
	...
	<form onSubmit="return valFormConsultarMixta(this);" name="frm_consultarMixta" method="post" action="frm_consultarMaterial.php">
		...
		<tr>
		  ...
		  <div align="center"><input name="btn_consultar2" type="submit" class="botones" value="Consultar" 
                        onMouseOver="window.status='';return true" title="Consultar Material por Opci&oacute;n M&uacute;ltiple" />
		    <?php
                 	} 
					else{
	...
	<legend class="titulo_etiqueta">Ver Cat&aacute;logo</legend>
	<br>
	...
	<div id="boton-cancelar">
        <form action="menu_material.php" method="post">
			...
			<input name="btn_cancelar" type="button" class="botones" value="Cancelar" title="Regresar al Men&uacute; de Materiales" 
				onClick="location.href='menu_materiales.php'" />        
		  </div>
        </form>
</div><?php
