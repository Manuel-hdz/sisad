...
<?php
	...
	if(!verificarPermiso($usr_reg,$_SERVER['PHP_SELF'])){		
		...
		include ("op_consultarProduccion.php");?>
...
<head>
    ...
    <style type="text/css">
		...
		#tabla-generarReporteMes {position:absolute;left:30px;top:190px;width:290px;height:170px;z-index:14;}
		#tabla-generarReporteFecha {position:absolute;left:420px;top:190px;width:283px;height:170px;z-index:14;}
		#calendario {position:absolute;left:675px;top:235px;width:30px;height:26px;z-index:13;}		
		#mostrarRepoFecha {position:absolute;left:33px;top:190px;width:900px;height:431px;z-index:14; overflow:scroll}
...
<body>
	...
	if(isset($_POST['sbt_continuarFecha'])){?>
		<form name="frm_mostrarRepoFecha" method="post" action="../pro/guardar_reporte.php">
            ...
            <div id='btnRegExpRepoFecha' align="center"><?php
                ...
                onMouseOver="window.status='';return true" onclick="location.href='frm_consultarProduccion.php';" />
            </div>
		</form><?php
	}
		...
		<form name="frm_mostrarRepoFecha" method="post" action="../pro/guardar_reporte.php">
            ...
            <div id="btnRegExpRepoFecha" align="center"><?php
            	...
            	if($periodo!=""){?>					
					...
					<input name="hdn_numEmpleados" type="hidden" value="<?php echo $_POST['txt_numEmpleados']; ?>"/>
                    <input name="sbt_exportar" id="sbt_exportar" type="submit" class="botones" value="Exportar Datos" title="Exportar Datos de las Consultas"
                    onmouseover="window.estatus='';return true"/>
					&nbsp;&nbsp;&nbsp;<?php
				}?>
        ...
        <br>
        <form onSubmit="return valFormGenerarRepoMes(this);" name="frm_generarReporteMes" method="post" action="frm_consultarProduccion.php">
        <table cellpadding="5" cellspacing="5" class="tabla_frm">
			<tr>
              	<td><div align="right">Periodo</div></td>
                <td><?php 
                    $res=cargarComboOrdenado('cmb_periodo','periodo','presupuesto','bd_produccion','Seleccionar','','fecha_inicio');
                    if($res==0){?>
			...
			<tr>
				<td align="right">No. Empleados</td>
				<td><?php //Obtener la cantidad de empleados de CONCRETO
					$conn = conecta("bd_recursos");
					$empleados = mysql_query("SELECT COUNT(rfc_empleado) AS cantEmpleados FROM empleados WHERE area = 'CONCRETO'");
					$cantEmpleados = "";
					if($datos=mysql_fetch_array($empleados))
						$cantEmpleados = $datos['cantEmpleados'];?>
					<input type="text" name="txt_numEmpleados" id="txt_numEmpleados" class="caja_de_texto" value="<?php echo $cantEmpleados;?>" 
					ondblclick="this.value=''" size="5" maxlength="10" onkeypress="return permite(event,'num',2);"/> 
				</td>
			</tr>
            <tr>
              	<td colspan="2">
        ...
        <br>
        <form onSubmit="return valFormGenerarRepoFecha(this);" name="frm_generarReporteFecha" method="post" action="frm_consultarProduccion.php">
        <table  cellpadding="5" cellspacing="5" class="tabla_frm">
			<tr>
