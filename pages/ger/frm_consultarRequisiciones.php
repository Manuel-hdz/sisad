...
<title>Sistema de Gesti&oacute;n Empresarial, Producci&oacute;n y Operaci&oacute;n</title>
	...
	<?php if(!isset($_GET['idReq'])){?>
		<script type="text/javascript" language="javascript">
			setTimeout("cargarRequisicion(9);",500);
		</script>
	<?php }
	else{?>
		<script language="javascript" type="text/javascript" language="javascript">
			setTimeout("cargarTablaRequisicion('<?php echo $_GET['idReq'];?>',9)",500);	
		</script>
	<?php }?>
...
<body>
	...
	<fieldset class="borde_seccion" id="consulta-requisicion" name="consulta-consultar">
    	...
    	<table width="931" height="92" border="0" cellpadding="5" cellspacing="5" class="tabla_frm">
    		<tr>
				...
				<td width="163">
					...
					readonly="readonly" width="50" onchange="cargarRequisicion(9);"/>
				</td>
            	...
            	<td colspan="3">
					...
					width="50" 	onchange="cargarRequisicion(9);" />
				</td>
			</tr>
        	<tr>
            <td align="right">
            ...
            <td>
				<select name="cmb_buscarPor" id="cmb_buscarPor" class="combo_box" disabled="disabled"  onchange="cargarRequisicion(9);">
            ...
            <td width="239">
				...
				onchange="cargarRequisicion(9);" ></textarea>
			</td>
            <td width="67">Requisici&oacute;n</td>
            <td width="152">
				<select name="cmb_estadoRequisicion" id="cmb_estadoRequisicion" class="combo_box" onchange="cargarTablaRequisicion(this.value,9);">
              		<option value="">Requisici&oacute;n</option>
					<?php if(isset($_GET['idReq'])){?>
						<option <?php echo "selected='selected'";?> value="<?php echo $_GET['idReq'];?>"><?php echo $_GET['idReq'];?></option>
					<?php }?>
            	</select>
			</td>	
	  </table>			
