...
<head>
    ...
    <style type="text/css">
		...
		#btn-regresardetalle {position:absolute;left:230px;top:603px;width:431px;height:40px;z-index:9;}
...
<body>
	...
	if(!isset($_POST['ckb_idRegRend'])){?>
		...
		<br>
		<form  onsubmit="return valFormRepRendimientoFecha(this);" name="frm_reporteFecha" id="frm_reporteFecha"  method="post" action="frm_reporteRendimiento.php">
		<table cellpadding="5" cellspacing="5" class="tabla_frm">
			<tr>
