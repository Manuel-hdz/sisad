...
<?php
	...
	if(!verificarPermiso($usr_reg,$_SERVER['PHP_SELF'])){
		...
		//Liberar el arreglo de session utilizado durante el registro de la bitacora
		if(isset($_SESSION['infoBitacora']))
			unset($_SESSION['infoBitacora']);
		if(isset($_SESSION['bitZarpeo']))
...
<head>
    ...
    <style type="text/css">
		<!--
		#titulo-seleccionar {position:absolute;left:30px;top:146px;	width:210px;height:20px;z-index:11;}
...
<body>
    ...
    <div class="titulo_barra" id="titulo-seleccionar">Agregar Registro a la Bit&aacute;cora</div>
	<fieldset class="borde_seccion" id="tabla-seleccionarBit" name="tabla-seleccionarBit">
	<legend class="titulo_etiqueta">Seleccionar el Tipo de Registro</legend>	
	<br>
	<form onSubmit="return valFormSeleccionarBit(this);" name="frm_selRegistroBitacora" method="post" action="">
