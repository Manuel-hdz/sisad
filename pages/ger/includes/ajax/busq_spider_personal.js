...
function lookup(cajaTexto,nomTabla,num,area) {
	...
	if(inputString.length == 0) {
		...
		$.post("includes/ajax/busq_spider_personal.php?nomCajaTexto="+nomCajaTexto+"&nomTabla="+nomTabla+"&num="+num+"&area="+area, {queryString: ""+inputString+""}, function(data){
