/**
  ...
  */
	...
	function verificarRangoValido(fecha1,fecha2,clave,ubicacion){
		...
		if(ubicacion!=""){
			...
			var url = "includes/ajax/verificarRangoFechas.php?fecha1="+fecha1+"&fecha2="+fecha2+"&clave="+clave+"&ubicacion="+ubicacion;
