	...
	<div id="parrilla-menu1">
  	<table class="tabla_frm" width="500" border="0" align="center" cellpadding="5" cellspacing="5">
    	<tr>
			...
			<td width="33%" align="center">
	    		<div align="center">
				<form action="frm_consultarPedido.php">
					<input type="image" src="images/sea-pedido.png" width="140" height="158" border="0" title="Consultar Pedidos" onmouseover="window.status='';return true"/><br/>
					<input type="image" src="../../images/btn-sea.png" name="btn3" id="bnt3" width="118" height="46" border="0" title="Consultar Pedidos" 
