	...
	/**
	 ...
	 function dibujarDetalle($campo,$valBuscar){
		...
		switch($campo){
			...
			break;
			case "unidad_medida":			
				$stm_sql = "SELECT * FROM materiales JOIN unidad_medida ON id_material=materiales_id_material WHERE unidad_medida='$valBuscar' ORDER BY linea_articulo";
				$msg="Material existente en Almac&eacute;n acorde a la Unidad de Medida: <u>".$valBuscar."</u>";
			break;
			case "clave":			
				$stm_sql = "SELECT * FROM materiales JOIN unidad_medida ON id_material=materiales_id_material WHERE id_material='$valBuscar' ORDER BY id_material";
			...
			default:
				...
				$stm_sql = "SELECT * FROM materiales JOIN unidad_medida ON id_material=materiales_id_material WHERE $campo='$valBuscar' ORDER BY linea_articulo";
			break;
		}
			...
			echo "				
				...
				<tr>
					...
					<tr>
        				...
        				<td class='nombres_columnas' align='center'>LINEA DEL ARTICULO (CATEGORIA)</td>
						<td class='nombres_columnas' align='center'>GRUPO</td>
        				<td class='nombres_columnas' align='center'>COSTO UNITARIO</td>
						<td class='nombres_columnas' align='center'>EXISTENCIA</td>
        				<td class='nombres_columnas' align='center'>NIVEL MINIMO </td>
						<td class='nombres_columnas' align='center'>NIVEL M&Aacute;XIMO </td>
						<td class='nombres_columnas' align='center'>PUNTO REORDEN </td>
						...
						<td class='nombres_columnas' align='center'>FACTOR DE CONVERSIÓN</td>
						<td class='nombres_columnas' align='center'>UNIDAD DE DESPACHO</td>
