<?php
	/**
	  ...
	  * Descripción: Este archivo contiene funciones para generar los 2 tipos de reportes de producción, que son consultados por Gerencia Tecnica
	**/
	...
	function mostrarRepoMensual(){
		...
		//Revisar si viene el Numero de Empleados de Concreto en el POST para Colocar la Tabla de Analisis de Productividad		
		$noEmpleados = $_POST['txt_numEmpleados'];			
			...
			<tr>
				...
				foreach($sumPorDia as $ind => $totalDia){
					...
					if($totalDia!=0){
						...
						<td class="<?php echo $nom_clase; ?>"><?php echo number_format($productividad,2,".","."); ?></td><?php						
						//Obtener la suma total de la ubicacion que esta siendo impresa
