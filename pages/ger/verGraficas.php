...
<script type="text/javascript" language="javascript">
	...
	/**
	  ...
	  * Fecha: 20/Julio/2011                                      			
	  * Descripción: Este archivo contiene funciones para Ver las Graficas de loa Reportes del correspondiente Módulo
	  **/	
	...
	function generarGraficaAsistencias(){
		...
		<body>
			...
			<script type="text/javascript">				
				...
				so.addVariable("x_legend","Áreas,14,#000");
				...
				so.addVariable("bar_3d","75,#1031A3,<?php echo $totalAsistencia;?>Días Representa el 100 %25 de Asistencia,10");			
	...
	function generarGraficaAsistenciasFechas(){
		...
		//Guardamos los datos que vienen en la sessión
		//Guardamos el mensaje que sera mostrado en la gráfica
		$msg = $_SESSION['datosGrapAsistencias']['hdn_msg'];
		//Variable que guarda el total de asistencia que se debio cumplor por area
		$totalAsistencia = $_SESSION['datosGrapAsistencias']['diferencia'];
		
		//Calcular el Porcentaje de asistencia por cada Area; tenemos que reccorrer el arreglo que viene en la sesión y que tiene las asistencias
		...
		<body>
			...
			<script type="text/javascript">				
				...
				so.addVariable("x_grid_colour","#ADB5C7");
				so.addVariable("y_axis_colour","#909090");
				so.addVariable("bar_3d","75,#1031A3,<?php echo $totalAsistencia;?> Días Representan el 100%25 de Asistencia,10");			
	...
	function generarGraficaIncapacidades(){
		...
		<body>
			...
			<script type="text/javascript">				
				...
				so.addVariable("y_axis_colour","#909090");
				so.addVariable("y_grid_colour","#ADB5C7");
				so.addVariable("bar_3d","75,#C93438,Porcentaje Incapacidades en un periodo de <?php echo $totalIncapacidades; ?> Días,10");			
	...
	function generarGraficaIncapacidadesFechas(){
		...
		//Calcular el Porcentaje de incapacidades por cada Area; tenemos que reccorrer el arreglo que viene en la sesión y que tiene las incapacidades
		...
		<body>
			...
			<script type="text/javascript">				
				...
				so.addVariable("y_axis_colour","#909090");
				so.addVariable("y_grid_colour","#ADB5C7");
				so.addVariable("bar_3d","75,#C93438,Porcentaje de Incapacidades en un periodo de <?php echo $totalIncapacidades; ?> Días,10");			
				so.addVariable("values","<?php 					
					//Variable para controlar el fin del IF en el foreach
					$cont = 1;
					//Recorremos el arreglo para asignar el valor real de las asistencias
	...
	function generarGraficaAusentismo(){
		...
		<body>
			...
			<script type="text/javascript">				
				...
				so.addVariable("y_axis_colour","#909090");
				so.addVariable("y_grid_colour","#ADB5C7");
				so.addVariable("bar_3d","75,#C93438,Porcentaje de Ausentismo en un periodo de <?php echo $totalAusentismo;?> Días,10");			
	...
	function generarGraficaAusentismoFechas(){
		...
		//Calcular el Porcentaje de ausentismo por cada Area; tenemos que reccorrer el arreglo que viene en la sesión y que tiene las ausentismo
		...
		<body>
			...
			<script type="text/javascript">				
				...
				so.addVariable("variables","true");
				so.addVariable("bg_colour","0xA5D8B6");						
				so.addVariable("title","Gráfica de Ausentismo,{font-size:16px; color:#000; margin:5px; padding:5px; padding-left: 20px; padding-right: 20px;}");
				so.addVariable("x_axis_steps","1");
				so.addVariable("x_axis_3d","12");
				so.addVariable("y_legend","Porcentaje de Ausentismo %25,14,#000");
				so.addVariable("x_legend","Áreas,14,#000");
	...
	function generarGraficaAltasBajasFechas(){
		...
		//Obtener los datos que vienen en la sessión
		...
		<body>
			...
			<script type="text/javascript">				
				...
				so.addVariable("x_axis_steps","1");
				so.addVariable("x_axis_3d","12");
				so.addVariable("y_legend","Altas/Bajas por Área,14,#000");
				so.addVariable("x_legend","Áreas,14,#000");
				so.addVariable("y_ticks","5,18,5");
				so.addVariable("x_labels","<?php 
