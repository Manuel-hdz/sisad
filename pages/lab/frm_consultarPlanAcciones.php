...
<?php
	...
	//Comprobar que el usuario registrado tenga acceso a esta seccion del Módulo de Almacen
...
<body>
    ...
    <div class="titulo_barra" id="titulo-consultar">Plan de Acci&oacute;n Registrado</div>
	<form onsubmit="return valFormPlanAlertas(this);" name="frm_verRec" id="frm_verRec" method="post" action="frm_complementarPlanAcciones.php?band=1"><?php 
		...
		<div id="btns-regpdf" align="center">
			...
			onMouseOver="window.status='';return true" onclick="location.href='inicio_laboratorio.php'" />
	  </div>
	</form>
</body>
