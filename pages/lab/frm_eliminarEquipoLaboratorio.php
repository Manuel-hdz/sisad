...
<?php
	...
	if(!verificarPermiso($usr_reg,$_SERVER['PHP_SELF'])){	
		...
		include ("op_eliminarEquipoLaboratorio.php");?>
...
<head>
    ...
    <style type="text/css">
		<!--
			...
			#tabla-eliminarEquipoMarca {position:absolute;left:30px;top:190px;width:425px;height:133px;z-index:12;}
			#tabla-eliminarEquipoNumero{position:absolute;left:507px;top:190px;width:425px;height:133px;z-index:12;}
...
<body>
    ...
    <div class="titulo_barra" id="titulo-eliminar">Eliminar  Equipo </div>
	<fieldset class="borde_seccion" id="tabla-eliminarEquipoMarca" name="tabla-eliminarEquipoMarca">
	<legend class="titulo_etiqueta">Selecciona Marca del Equipo </legend>	
	<br>
	<form name="frm_eliminarEquipoMarca" method="post" action="frm_eliminarEquipoLaboratorio.php" onsubmit="return valFormeliminarMarca(this);">
...
<fieldset class="borde_seccion" id="tabla-eliminarEquipoNumero" name="tabla-eliminarEquipoNumero">
	<legend class="titulo_etiqueta">Introducir Clave del Equipo </legend>	
	<br>
	<form  name="frm_eliminarEquipoClave" method="post" action="frm_eliminarEquipoLaboratorio.php" onsubmit="return valFormeliminarClave(this);" >
		<table width="415"  cellpadding="5" cellspacing="5" class="tabla_frm">
      		<tr>
...
//Verificamos que el boton consultar sea presionado; si es asi mostrar los Empleados
	if(isset($_POST["sbt_consultar"])){?>
		<form name="frm_eliminarEquipo"  onsubmit="return valFormEliminar(this);"method="post" ><?php 
			echo"<div id='tabla-Equipo' class='borde_seccion2' align='center'>";
				...
				<?php if($band!=0){?>
						<input type="submit" name="sbt_eliminar" value="Eliminar" class="botones" title="Eliminar Equipo" 
