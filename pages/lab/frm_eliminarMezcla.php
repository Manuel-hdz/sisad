...
<head>
    ...
    <style type="text/css">
		...
		#tabla-eliminarMezclaFecha {position:absolute;left:40px;top:190px;width:360px;height:151px;z-index:12;}
		#tabla-eliminarMezclaClave {position:absolute;left:478px;top:190px;width:369px;height:151px;z-index:12;}
		...
		#btn-eliminar {position:absolute;left:47px;top:600px;width:946px;height:40px;z-index:9;}
		-->
    </style>
</head>
<body><?php
	...
	<div class="titulo_barra" id="titulo-eliminar">Eliminar Mezclas</div>
    
	<?php // fieldset para manipulacion de mezclas buscadas por su clave?>	
    <fieldset class="borde_seccion" id="tabla-eliminarMezclaClave" name="tabla-eliminarMezclaClave">
	<legend class="titulo_etiqueta">Eliminar  por Clave </legend>	
	<br>
	<form onSubmit="return valFormEliminarMezclaClave(this);" name="frm_eliminarMezcla" method="post" action="frm_eliminarMezcla.php">
	...
	<?php // fieldset para manipulacion de mezclas buscadas por fecha?>	
   	<fieldset class="borde_seccion" id="tabla-eliminarMezclaFecha">
	<legend class="titulo_etiqueta">Eliminar por Fecha de Registro</legend>	
	<br>
	<form onSubmit="return valFormEliminarMezclaFecha(this);" name="frm_eliminarMezcla2" method="post" action="frm_eliminarMezcla.php">
    ...
    <div id="calendario-Ini">
      <input type="image" name="txt_fechaIni" id="txt_fechaIni" src="../../images/calendar.png"
        onclick="displayCalendar(document.frm_eliminarMezcla2.txt_fechaIni,'dd/mm/yyyy',this)" 
    ...
    <div id="calendario-Fin">
      <input type="image" name="txt_fechaFin" id="txt_fechaFin" src="../../images/calendar.png"
        onclick="displayCalendar(document.frm_eliminarMezcla2.txt_fechaFin,'dd/mm/yyyy',this)" 
        onmouseover="window.status='';return true"width="25" height="25" border="0" align="absbottom" 
	...
	if(isset($_POST["sbt_consultar2"]) || isset($_POST['sbt_consultar']) || isset ($_POST['sbt_eliminar'])){?>
        <form onSubmit="return valFormEliminarMezcla(this);" name="frm_eliminarMezcla" method="post" action="frm_eliminarMezcla.php"><?php
			...
			if ($control==1){?>
                <div id='btn-eliminar' align="center">
                    ...
                    onmouseover="window.status='';return true" title="Eliminar Mezcla Seleccionada" />
                </div><?php
			 }?>
        </form><?php
	}?>
