...
<?php
	...
	//Comprobar que el usuario registrado tenga acceso a esta seccion del M�dulo de Laboratorio
...
<body>
	...
	<table border="0" cellpadding="5" cellspacing="5" class="tabla_frm">
		<tr>
			...
			<td>
				<input name="txt_elaboradorReq" type="text" id="txt_elaboradorReq" onkeypress="return permite(event,'num_car');" size="40" readonly="readonly" maxlength="60" value="<?php echo $elaborador;?>"/>
		...
		<tr>
			...
			<td>
				<input name="txt_areaSolicitante" type="text" id="txt_areaSolicitante" onkeypress="return permite(event,'num_car');" size="25" maxlength="45" value="LABORATORIO" required="required"/>
			</td>
			<td>
