...
<head>
    ...
    <style type="text/css">
		...
		#btn-continuar {position:absolute;left:32px;top:665px;width:987px;height:40px;z-index:9;}
		#detalle-equipo {position:absolute;left:37px;top:435px;width:938px;height:171px;z-index:17;overflow:scroll;}
		#tabla-mostrarEquipoLabClave {position:absolute;left:536px;top:209px;width:446px;height:183px;z-index:12;}
		#tabla-mostrarEquipoLabMarca { position:absolute; left:36px; top:210px; width:448px; height:181px; z-index:13; }
		-->
    </style>
</head>
<body>
	...
	<div class="titulo_barra" id="titulo-mostrarEquipoLabNombre">Registrar Mantenimiento a los Equipos de Laboratorio</div><?php	
	...
	if (!isset($_POST['rdb_noEquipo']) ){?>
		...
		<br>			
		<form onSubmit="return valFormSeleccionarNombreEquipo(this);" name="frm_seleccionarNombreEquipo" method="post" action="frm_registrarMttoEquipo.php">
		...
		<legend class="titulo_etiqueta">Registrar Equipos de Laboratorio por Clave</legend>	
		<br>			
		<form onSubmit="return valFormSeleccionarClaveEquipo(this);" name="frm_seleccionarClaveEquipo" method="post" action="frm_registrarMttoEquipo.php">
		<table width="100%" border="0" align="center" cellpadding="5" cellspacing="5" class="tabla_frm">		
			<tr>
		...
		if(isset($_POST['sbt_consultarMarcaEquipo']) || isset ($_POST['sbt_consultarClaveEquipo'])){?>
			<form onSubmit="return valFormRegistrarEquipoLab(this);" name="frm_registrarEquipo" method="post" action="frm_registrarMttoEquipo2.php">
				<input type="hidden" name="sbt_consultarMarcaEquipo" value="Consultar" />
				...
				if ($control==1){?>
					...
					onmouseover="window.status='';return true" title="Continuar Registrando el Mantenimiento para los Equipo"  />
	  		  </div><?php 
				}?>
			</form><?php 
		}
