...
<body onLoad="inicio(); setInterval(muestraReloj, 1000);" onkeypress="parar()" onclick="parar()" onmousemove="parar()">
  	...
  	<table width="50" border="0">    			
		<tr>
      		<td width="50" height="50">						
				<form action="inicio_llantas.php">						
					<input type="image" src="../../images/dock/home.png" name="icono1" id="icono1" width="50" height="50" border="0" title="Inicio M&oacute;dulo Gesti&oacute;n Llantas"					
	...
	<div id="menu" style="position:absolute; left:-15px; top:70px; width:1035px; height:85px; z-index:123;"> 
		<ul id="css3menu">
			...
			<li class="topfirst"><a href="menu_requisiciones.php" title="Requisiciones de Llantas" onMouseOver="window.status='';return true"><span>Requisici&oacute;n</span></a>
				<ul>
					<li class="subfirst"><a href="frm_generarRequisicion.php" title="Generar una Requisici&oacute;n de Llantas" onMouseOver="window.status='';return true">Generar Requisici&oacute;n</a></li>
					<li class="subfirst"><a href="frm_consultarRequisiciones.php" title="Consultar las Requisiciones de Llantas" onMouseOver="window.status='';return true">Consultar Requisiciones</a></li>
				</ul>
			</li>
		</ul>
	</div>	
	...
	<div id="modulo" class="usr-reg">M&oacute;dulo de Gesti&oacute;n Llantas</div>
