...
<head>
	...
	<style type="text/css">
		...
		.mensajes {font-family: Arial, Helvetica, sans-serif; color: FFF; font-size: 12px; font-weight: bold; }
...
<body onload="document.getElementById('txt_usuario').focus();">
	...
	<div id="fondo-login" style="position:absolute; left:290px; top:225px; width:378px; height:225px; z-index:3"><img src="dir/images/login.png" width="451" height="211" /></div>
	...
	<div id="form-datos" style="position:absolute; left:345px; top:353px; width:287px; height:86px; z-index:5">  
		<form action="autentificar.php?dg=y" method="post" name="frm_login">
			<table width="287" border="0" align="center">
				<tr>
      			...
      			<tr>
        			...
        			<td><input type="password" name="txt_clave" size="20" maxlength="20"/></td>
      			</tr>
    		</table>
	...
	<div id="mensajes" style="position:absolute; left:440px; top:402px; width:246px; height:32px; font-family:Arial, Helvetica, sans-serif; font-size:13px; color:#FFFFFF; font-weight:bold z-index:7;">
	<?php
		if ($_GET["usr_sts"]=="err"){
			...
			if (isset($_SESSION["intento"])&&$_SESSION["intento"]>3)
				echo "<p align='center'><div align='left' class='mensajes'>* Queda un intento más</div></p>";
		}
