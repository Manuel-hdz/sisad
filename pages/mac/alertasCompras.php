<?php
	...
	function desplegarAlertasCompras(){
		...
		departamento = 'MTTO CONCRETO' AND estado='0'";		
	...
	function notificarAlertaCompras($num_alertas){?>
		...
		<script type="text/javascript" language="javascript">
			setTimeout("popup_show('popup_rh0', 'popup_drag_rh0', 'popup_exit_rh0', 'screen-top-left', 75, 200);",1000);			
		</script>
		<!-- ********************************************************* Popup Window **************************************************** -->
	...
	function mostrarAlertasCompras($ctrl){		
		...
		WHERE estado = '0' AND departamento = 'MTTO CONCRETO'";
		...
		if($datos=mysql_fetch_array($rs)){			
			...
			<script type="text/javascript" language="javascript">			
				setTimeout("popup_show('popup_rh<?php echo $ctrl?>', 'popup_drag_rh<?php echo $ctrl?>', 'popup_exit_rh<?php echo $ctrl?>', 'screen-top-left', 75, 200);",1000);				
			</script>
			<!-- ********************************************************* Popup Window **************************************************** -->
