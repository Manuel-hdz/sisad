...
<body>
	<div id="parrilla-menu1" align="center">
		...
		if(isset($_GET['err'])) { 
			if($err=="AccesoNegado") {		
				$usuarios=verificarUsuarioPermisos("MttoMina");
				$band=0;
				...
				//si el usuario no es de MttoMina, buscarlo en MttoConcreto
				if($band==0){
					$usuarios=verificarUsuarioPermisos("MttoConcreto");
					$band2=0;
					foreach($usuarios as $ind=> $valor){
						if($usr_reg==$valor){
							$band2=1;
            	...
            	<meta http-equiv="refresh" content="7;url=inicio_mantenimiento.php">
				<p>
