...
<head>
    ...
    <style type="text/css">
		...
		#form-agregarGama { position:absolute; left:30px; top:190px; width:813px; height:260px; z-index:12; }		
		-->
    </style>
</head>
<body>
			...
			<tr>
			  <td width="17%"><div align="right">*Clave de la Gama </div></td>
				<td width="33%">
					...
					onblur="return verificarDatoBD(this,'bd_mantenimiento','gama','id_gama','nom_gama');" />
