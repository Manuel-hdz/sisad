...
<?php
	...
	if(!verificarPermiso($usr_reg,$_SERVER['PHP_SELF'])){
		...
		include ("op_autorizarRequisicion.php");
		?>
			...
			if(isset($_POST["sbt_consultarReq"])){
				...
				<form name="frm_consultarRequisiciones" method="post" action="">
					...
					<div align="center" id="botones-resultados">
						...
						onclick="location.href='frm_autorizarRequisicion.php'"/>
					</div>
				</form>
				<?php
				...
				<form method='post' name='frm_detallesRequisicion' id='frm_detallesRequisicion'>
					...
					<div id='botones' align="center">
						<input type="submit" class="botones" name="sbt_autorizarReq" value="Autorizar" title="Autorizar Requisicion" onmouseover="window.status='';return true;"/>
						&nbsp;&nbsp;&nbsp;&nbsp;
				...
				if(isset($_POST["sbt_autorizarReq"])){
					autorizarRequisicion($_POST["id_req"]);
				}
			?>
				<fieldset id="tabla-fechas" class="borde_seccion">
					<legend class="titulo_etiqueta">Seleccionar Fechas</legend>
					<form name="frm_buscarRequisiciones" action="frm_autorizarRequisicion.php" method="post" onsubmit="return valFormReqFecha(this);">
