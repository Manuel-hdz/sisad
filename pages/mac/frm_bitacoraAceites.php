...
<body>
	...
	<legend class="titulo_etiqueta">Registrar seleccionando Fecha y Familia</legend>
	<br />
	<form name="frm_bitacoraAceites" action="frm_bitacoraAceites.php" method="post" onsubmit="return valFormSelEquipoAceite(this);">
		<table width="100%" border="0" align="center"  cellpadding="5" cellspacing="5" class="tabla_frm">		
			...
			<tr>
				...
				<td colspan="3">
					<?php 
						...
						$stm_sql = "SELECT CONCAT(nombre,' ',ape_pat,' ',ape_mat) AS nombreEmpleado,puesto FROM empleados WHERE id_cuentas='CUEN002' ORDER BY nombreEmpleado";
						...
						mysql_close($conn);	*/
					?>
					<input name="cmb_supervisor" type="text" class="caja_de_texto"  size="55" id="cmb_supervisor"
			...
			<tr>
		    <td width="95"><div align="right">Familia </div></td>
				<td valign="top" colspan="3">
					<?php 
						$area="";
						//Obtener los Sistemas Registrados en la BD
						$conn = conecta("bd_mantenimiento");
						$rs_familia = mysql_query("SELECT DISTINCT familia FROM equipos WHERE area!='$area' AND estado='ACTIVO' ORDER BY familia");
