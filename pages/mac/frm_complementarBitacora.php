...
<body><?php
	...
	<table width="100%" cellpadding="5" cellspacing="5" class="tabla_frm">
		<tr>
			...
			<td width="10" valign="top">
      	    ...
      	    <td width="53" valign="top">*Sistema</td>
				...
				while($file=readdir($h)){
					...
					if ($file=='listaSistemas.txt'){
						...
						if (!is_resource($fp))
							...
							<select class="combo_box" name="txt_sistema" id="txt_sistema" onchange="agregarSistema(this);"><?php
	...
	<div id="btns-regpdf">
		<table width="100%" align="center" cellpadding="5" cellspacing="5" class="tabla_frm">
			<tr>
   				<td align="center">
