...
<head>
    ...
    <style type="text/css">
		...
		#tabla-consultarOrdenTrabajo {position:absolute;left:30px;top:190px;width:660px;height:176px;z-index:12;padding:15px;padding-top:0px;}
		#calendarioInicio {position:absolute;left:302px;top:286px;width:30px;height:26px;z-index:13;}
		#calendarioFin {position:absolute;left:508px;top:287px;width:30px;height:26px;z-index:14;}
