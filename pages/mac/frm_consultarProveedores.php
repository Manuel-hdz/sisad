...
<head>
	...
	$(document).ready(function(){
			$("#tabla-resultadosProveedores").dataTable({
    ...
    <style type="text/css">
		...
		#tabla-consultarProveedores{position:absolute; left:30px; top:190px; width:950px; height:420px; z-index:12; padding:15px; padding-top:0px; overflow:scroll;}
		-->
    </style>
...
<body>
	...
	<div class="borde_seccion2" id="tabla-consultarProveedores" >
	<p class="titulo_etiqueta" align="left">Lista de Proveedores</p>	
		<?php 
			//Mostrar la lista de todos los Proveedores
			mostrarProveedores();
		 ?>
	</div>
