...
<body>
	...
	<form name="registrar_nomina" action="frm_continuarNominaMac.php" method="post">
    ...
    <?php
		...
		$msje="Registro de N&oacute;mina Mantenimiento Superficie del <em><u>$_POST[txt_fechaIni_Con]</u></em> al <em><u>$_POST[txt_fechaFin_Con]</u></em>";
