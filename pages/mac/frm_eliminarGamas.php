	...
	<script type="text/javascript" language="javascript" >
		window.onload = function(){<?php 
			if($area!=""){//Cargar el Combo de familias segun el area seleccionada ?>
				cargarCombo("<?php echo $area; ?>","bd_mantenimiento","gama","familia_aplicacion","area_aplicacion","cmb_familiaGama","Familia","<?php echo $familia; ?>");<?php 
			}
			if($familia!=""){//Cargar el combo de Claves de las Gamas segun la Familia y Area seleccionadas ?>
				setTimeout("cargarComboEspecifico('<?php echo $familia; ?>','bd_mantenimiento','gama','id_gama','familia_aplicacion','area_aplicacion','<?php echo $area; ?>','cmb_claveGama','Clave','<?php echo $claveGama; ?>');",500);<?php 
			}?>
		}
	</script>
