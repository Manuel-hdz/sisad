  	...
  	<table border="0" cellpadding="5" cellspacing="5" class="tabla_frm">
    	...
    	<tr>
			<td>
      		...
      		<td>
				<input name="txt_areaSolicitante" type="text" id="txt_areaSolicitante" onkeypress="return permite(event,'num_car');" size="25" maxlength="45" value="MANTENIMIENTO CONCRETO" required="required"/>
			</td>
			<td>
				<div align="right">Solicit&oacute;</div>
			</td>
		    <td>
				<input name="txt_solicitanteReq" type="text" id="txt_solicitanteReq" onkeypress="return permite(event,'num_car');" size="40" maxlength="60" value="<?php echo $usuario;?>" required="required"/>
			</td>
		</tr>
		<tr>
			<td>
