...
<body>
	...
	<div class="titulo_barra" id="titulo-reporte">Reporte de Consumo de Aceite</div>
	<?php 
	...
	if(isset($_POST['verDetalle'])){
		...
		<div id="calendarioInicio">
			...
			onclick="displayCalendar(document.frm_reporteAceites.txt_fecha_ini,'dd/mm/yyyy',this)" 
		...
		<div id="calendarioFin">
			...
			onclick="displayCalendar(document.frm_reporteAceites.txt_fecha_fin,'dd/mm/yyyy',this)" 
			onmouseover="window.status='';return true"width="25" height="25" border="0" align="absbottom" 
