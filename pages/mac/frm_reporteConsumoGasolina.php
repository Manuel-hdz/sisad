...
<title>Sistema de Gesti&oacute;n Empresarial, Producci&oacute;n y Operaci&oacute;n</title>
    ...
    <style type="text/css">
		<!--	
			...
			#tabla-consultar {position:absolute; left:30px; top:190px; width:500px; height:200px; z-index:14;}
			#calendarioInicio {position:absolute;left:255px;top:230px;width:30px;height:26px;z-index:15;}
			#calendarioFin {position:absolute;left:500px;top:230px;width:30px;height:26px;z-index:15;}
	...
	<script type="text/javascript" language="javascript">
		function reiniciarEquipo(){
			...
			objeto = document.getElementById("cmb_equipo");
...
<body>
	...
	<div class="titulo_barra" id="titulo-reporte">Reporte de Consumo de Gasolina</div>
	<?php 
	...
	if(isset($_POST['verDetalle'])){
		...
		mostrarDetalleGasolinaRE($clave);
	}
		...
		<script type="text/javascript" language="javascript">
			cargarFamiliaEquipos('TODO','cmb_familia','Familia','Familia');
		</script>
		
		<fieldset class="borde_seccion" id="tabla-consultar">
		<legend class="titulo_etiqueta">Seleccionar filtros del reporte</legend>	
		<br>
		<form method="post" name="frm_reporteGasolina" id="frm_reporteGasolina" onsubmit="return valFormRepAceites(this);">
		<table width="108%" border="0" cellpadding="5" cellspacing="5" class="tabla_frm">
			<tr>
				...
				<td>
					<input name="txt_fecha_ini" id="txt_fecha_ini" type="text" value=<?php echo date("d/m/Y", strtotime("-30 day"));?> size="10" maxlength="15"
			...
			<tr>
				...
				<td>
					...
					onchange="cargarFamiliaEquipos(this.value,'cmb_familia','Familia','Familia'); reiniciarEquipo();" >
						<option value="TODO">&Aacute;rea</option>
				...
				<td>
					<select name="cmb_familia" class="combo_box" id="cmb_familia"
					onchange="cargarEquiposFamilia(this.value,cmb_area.value,'cmb_equipo','Equipo','Equipo');">
			...
			<tr>
				<td colspan="4" align="center">
					...
					onmouseover="window.status='';return true;" title="Generar Reporte de Consumo de Gasolina" tabindex="4"/>
					&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<div id="calendarioInicio">
			...
			onclick="displayCalendar(document.frm_reporteGasolina.txt_fecha_ini,'dd/mm/yyyy',this)" 
		...
		<div id="calendarioFin">
			...
			onclick="displayCalendar(document.frm_reporteGasolina.txt_fecha_fin,'dd/mm/yyyy',this)" 
			onmouseover="window.status='';return true"width="25" height="25" border="0" align="absbottom" 
