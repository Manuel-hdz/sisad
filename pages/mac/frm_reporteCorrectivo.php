...
<?php
	...
	if(!verificarPermiso($usr_reg,$_SERVER['PHP_SELF'])){	
		...
		include ("op_reporteCorrectivo.php");
		?>
...
<body>
	...
	<div class="titulo_barra" id="titulo-barra">Reporte Mantenimientos Correctivos </div>
	...
	if(isset($_POST['hdn_tipoRpt'])){
		switch($_POST['hdn_tipoRpt']){
			case 1:
				$_POST['cmb_area'] = $_SESSION['datosRptCorrectivos']['cmb_area'];
				$_POST['txt_fechaIni'] = $_SESSION['datosRptCorrectivos']['txt_fechaIni'];
				$_POST['txt_fechaFin'] = $_SESSION['datosRptCorrectivos']['txt_fechaFin'];
				unset($_SESSION['datosRptCorrectivos']);//Quitar los datos de la SESSION
			break;
			case 2:
				$_POST['cmb_familia'] = $_SESSION['datosRptCorrectivos']['cmb_familia'];
				$_POST['hdn_area'] = $_SESSION['datosRptCorrectivos']['hdn_area'];
				$_POST['txt_fechaIni'] = $_SESSION['datosRptCorrectivos']['txt_fechaIni'];
				$_POST['txt_fechaFin'] = $_SESSION['datosRptCorrectivos']['txt_fechaFin'];
				unset($_SESSION['datosRptCorrectivos']);//Quitar los datos de la SESSION
			break;
			case 3:
				$_POST['cmb_familia'] = $_SESSION['datosRptCorrectivos']['cmb_familia'];
				$_POST['cmb_equipo'] = $_SESSION['datosRptCorrectivos']['cmb_equipo'];				
				unset($_SESSION['datosRptCorrectivos']);//Quitar los datos de la SESSION
			break;
			case 4:
				$_POST['txt_nivelSup'] = $_SESSION['datosRptCorrectivos']['txt_nivelSup'];
				$_POST['txt_nivelInf'] = $_SESSION['datosRptCorrectivos']['txt_nivelInf'];
				unset($_SESSION['datosRptCorrectivos']);//Quitar los datos de la SESSION
			break;
		}
	}
	...
	unset($_SESSION['datosGrapCorrectivos']);
	...
	if($band==0){ 
		...
		<br />
		<form onsubmit="return verFormReportesPreventivos(this,1);" name="frm_rptArea" action="frm_reporteCorrectivo.php" method="post" >
		...
		<br />
		<form onsubmit="return verFormReportesPreventivos(this,2);" name="frm_rptFamilia" action="frm_reporteCorrectivo.php" method="post" >
		...
		<form onsubmit="return verFormReportesPreventivos(this,3);" name="frm_rptEquipo" action="frm_reporteCorrectivo.php" method="post" >
		...
		<br />
		<form onsubmit="return verFormReportesPreventivos(this,4);" name="frm_rptCosto" action="frm_reporteCorrectivo.php" method="post" >
				...
				<td width="160">$<?php 
					if($estado==1){//El estado 1 indica que el departamento registrados en la SESSION tiene acceso a la información de MINA y CONCRETO
						...
						$rs_costos = mysql_query("SELECT DISTINCT costo_mtto FROM bitacora_mtto JOIN equipos ON equipos_id_equipo=id_equipo 
													WHERE area = '$area' AND tipo_mtto = 'CORRECTIVO' AND fecha_mtto!='0000-00-00' ORDER BY costo_mtto");
