...
<title>Sistema de Gesti&oacute;n Empresarial, Producci&oacute;n y Operaci&oacute;n</title>
	...
	<script type="text/javascript" src="includes/ajax/cargarComboBitLlantas.js"></script>
...
<body>
	...
	<div class="titulo_barra" id="titulo-reporte">Reporte de Bit&aacute;cora de Llantas </div>
	<?php 
	//Verificamos si viene definido en el post el boton consultar
	if(!isset($_POST["sbt_consultarGasto"])){
		...
		<legend class="titulo_etiqueta">Reporte Mensual de Llantas </legend>	
		<br>
		<form method="post" name="frm_reporteLlantas" id="frm_reporteLlantas" onsubmit="return valFormRptLlantas(this);">
		<table width="108%" border="0" cellpadding="5" cellspacing="5" class="tabla_frm">
			<tr>
			  <td><div align="right">A&ntilde;o</div></td>
				<td width="94">
					<select name="cmb_anios" id="cmb_anios" class="combo_box" onchange="cargarComboMesesBitLlantas(this.value,'cmb_meses');" tabindex="1">
						<option value="">A&ntilde;o</option>
						<?php
						//conectar a gerencia
						$conn = conecta('bd_mantenimiento');
						$rs = mysql_query("SELECT DISTINCT(SUBSTRING(fecha,1,4)) AS anio FROM bitacora_llantas ORDER BY anio");
		      ...
		      <td width="237"><select name="cmb_meses" id="cmb_meses" class="combo_box" tabindex="2" onchange="cargarComboEquiposBitLlantas(cmb_anios.value,this.value,'cmb_equipo')">
                <option value="">Mes</option>
              </select></td>
			</tr>
			<tr>
			  <td width="44"><div align="right">Equipo</div></td>
				<td width="94"><select name="cmb_equipo" id="cmb_equipo" class="combo_box" tabindex="3" title="Seleccionar un Equipo para Filtrar la Informaci&oacute;n">
			...
			<tr>
				<td colspan="4" align="center">
					<input name="sbt_consultarGasto" type="submit"  class="botones" id="sbt_consultarGasto" value="Generar Reporte"
					...
					onMouseOver="window.status='';return true" onclick="location.href='menu_reportes.php'" tabindex="5"/>				</td>
			</tr>
		</table>
		</form>
</fieldset>
	<?php 
		...
		<div align="center" id="botones">
			...
			onMouseOver="window.status='';return true" onclick="borrarHistorial();location.href='frm_reporteLlantas.php'"/>
		</div>
		<?php 
	}?>
