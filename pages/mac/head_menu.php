...
<body onLoad="inicio(); setInterval(muestraReloj, 1000);" onkeypress="parar()" onclick="parar()" onmousemove="parar()">
  	...
  	<table width="50" border="0">    			
		<tr>
      		<td width="50" height="50">						
				<form action="inicio_mantenimiento.php">						
					<input type="image" src="../../images/dock/home.png" name="icono1" id="icono1" width="50" height="50" border="0" title="Inicio Mantenimiento"					
			...
			<td width="50" height="50">
				<form action="frm_consultarProveedores.php">
					<input type="image" src="../../images/dock/proveedores.png" name="icono3" id="icono3" width="50" height="50" border="0" title="Consultar Proveedores de Compras" 
					onClick="MM_nbGroup('down','group2','icono3','',1)"
					onMouseOver="MM_nbGroup('over','icono3','../../images/dock/proveedores-over.png','',1); window.status='';return true" onMouseOut="MM_nbGroup('out')"/>						
				</form>		    	
			</td>
			<td width="50" height="50">
				<form action="frm_consultarRH.php">
					<input type="image" src="../../images/dock/rh.png" name="icono4" id="icono4" width="50" height="50" border="0" title="Consultar Recursos Humanos" 
					onClick="MM_nbGroup('down','group2','icono4','',1)"
					onMouseOver="MM_nbGroup('over','icono4','../../images/dock/rh-over.png','',1); window.status='';return true" onMouseOut="MM_nbGroup('out')"/>						
				</form>		    	
			</td>							     
    	</tr>
  	</table>
	...
	<div id="menu" style="position:absolute; left:-15px; top:70px; width:1035px; height:85px; z-index:123;"> 
		<ul id="css3menu"> 
			<li class="topfirst"><a href="menu_equipos.php" onMouseOver="window.status='';return true"  title="Equipos"><span>Equipos</span></a>
				<ul>
					<li class="subfirst"><a href="frm_agregarEquipo.php" onMouseOver="window.status='';return true" title="Agregar Equipo">Agregar Equipo</a></li>
					<li class="subfirst"><a href="frm_eliminarEquipo.php" onMouseOver="window.status='';return true"  title="Eliminar Equipo">Eliminar Equipo</a></li>
					<li class="subfirst"><a href="frm_consultarEquipo.php" onMouseOver="window.status='';return true"  title="Consultar Equipo">Consultar Equipo</a></li>
					<li class="subfirst"><a href="frm_modificarEquipo.php" onMouseOver="window.status='';return true"  title="Modificar Equipo">Modificar Equipo</a></li>
					<li class="subfirst"><a href="menu_metricas.php" onMouseOver="window.status='';return true"  title="Registrar Hor&oacute;metro/Od&oacute;metro de Equipos">
					<span>Hor&oacute;metro/Od&oacute;metro</span></a>
						<ul>
							<li class="subfirst"><a href="frm_registrarHorometro.php" onMouseOver="window.status='';return true"  title="Registrar Hor&oacute;metro">
							Hor&oacute;metro</a></li>
							<li class="subfirst"><a href="frm_registrarOdometro.php" onMouseOver="window.status='';return true"  title="Registrar Od&oacute;metro">
							Od&oacute;metro</a></li>
                        	<li class="subfirst"><a href="frm_consultarHoroOdometro.php" onMouseOver="window.status='';return true"  
                        	title="Consultar Hor&oacute;metro/Od&oacute;metro">Consultar Hor&oacute;metro/Od&oacute;metro</a></li>
						</ul>
					</li>
				</ul>
			</li>
			<li class="topfirst"><a href="menu_ordenTrabajo.php" title="Orden de Trabajo" onMouseOver="window.status='';return true"><span>Orden de Trabajo</span></a>
				<ul>
			...
			<li class="topfirst"><a href="menu_gamas.php" title="Gamas de Mantenimiento" onMouseOver="window.status='';return true"><span>Gamas</span></a>
				<ul>
			...
			<li class="topfirst"><a href="menu_llantas.php" title="Administraci&oacute;n de Llantas y Registros en Bit&aacute;cora" onMouseOver="window.status='';return true">
			<span>Llantas</span></a>
				<ul>
					<li class="subfirst"><a href="frm_gestionLlantas.php" title="Administraci&oacute;n de Llantas" onMouseOver="window.status='';return true">Gestionar Llantas</a></li>
					<li class="subfirst"><a href="frm_bitacoraLlantas.php" title="Registrar Uso en Bit&aacute;cora de Llantas" onMouseOver="window.status='';return true">Bit&aacute;cora de Llantas</a></li>
				</ul>
			</li>
			<li class="topfirst"><a href="menu_bitacora.php" title="Bit&aacute;cora de Mantenimiento" onMouseOver="window.status='';return true"><span>Bit&aacute;cora</span></a>
				<ul>
					<li class="subfirst"><a href="frm_registrarBitacora.php" title="Registrar Mantenimiento en la Bit&aacute;cora" onMouseOver="window.status='';return true">
					Registrar Mantenimiento</a></li>
					<li class="subfirst"><a href="frm_consultarBitacora.php" title="Consultar la Bit&aacute;cora" onMouseOver="window.status='';return true">
					Consultar la Bit&aacute;cora</a></li>
				</ul>
			</li>
			<li class="topfirst"><a href="menu_aceites.php" title="Administraci&oacute;n de Aceites y Registros en Bit&aacute;cora" onMouseOver="window.status='';return true">
			<span>Aceites y Gasolina</span></a>
				<ul>
					<li class="subfirst"><a href="frm_gestionAceites.php" title="Administraci&oacute;n de Aceites" onMouseOver="window.status='';return true">Gestionar Aceites</a></li>
					<li class="subfirst"><a href="frm_bitacoraAceites.php" title="Registrar Consumo en Bit&aacute;cora de Aceites" onMouseOver="window.status='';return true">Bit&aacute;cora de Aceites</a></li>
					<li class="subfirst"><a href="frm_bitacoraGasolina.php" title="Registrar Consumo en Bit&aacute;cora de Gasolina" onMouseOver="window.status='';return true">Bit&aacute;cora de Gasolina</a></li>
				</ul>
			</li>
			<li class="topfirst"><a href="menu_requisiciones.php" title="Requisiciones de Mantenimiento" onMouseOver="window.status='';return true">
			<span>Requisici&oacute;n</span></a>
				<ul>
					...
					<li class="subfirst"><a href="frm_generarRequisicion.php" title="Generar una Requisici&oacute;n de Mantenimiento" 
					onMouseOver="window.status='';return true">Generar Requisici&oacute;n</a></li>
					<li class="subfirst"><a href="frm_consultarRequisiciones.php" title="Consultar las Requisiciones de Mantenimiento" 
			...
			<li class="topfirst"><a href="menu_reportes.php" title="Reportes" onMouseOver="window.status='';return true"><span>Reportes</span></a>
				<ul>
					<li class="subfirst"><a href="frm_reportePreventivo.php" title="Reporte Mantenimientos Preventivos" onMouseOver="window.status='';return true">
					Mantenimientos Preventivos</a></li>
					<li class="subfirst"><a href="frm_reporteCorrectivo.php" title="Reporte Mantenimientos Correctivos" onMouseOver="window.status='';return true">
					Mantenimientos Correctivos</a></li>
					<li class="subfirst"><a href="frm_reportePreventivoCorrectivo.php" title="Reporte de Mantenimientos Preventivos Contra Mantenimientos Correctivos" 
					onMouseOver="window.status='';return true">Mantenimientos Preventivos/Correctivos</a></li>
					<li class="subfirst"><a href="frm_reporteOrdenTrabajo.php" title="Reporte de &Oacute;rdenes de Trabajo" onMouseOver="window.status='';return true">
					&Oacute;rdenes de Trabajo</a></li>
					<li class="subfirst"><a href="frm_reporteEstadistico.php" title="Reporte Estad&Iacute;stico de Fallas" onMouseOver="window.status='';return true">
					Estad&Iacute;stica de Fallas</a></li>
					<li class="subfirst"><a href="frm_reporteDisponibilidad.php" title="Reporte Disponibilidad de Equipos" onMouseOver="window.status='';return true">
					Disponibilidad de Equipos</a></li>
					<li class="subfirst"><a href="frm_reporteCostos.php" title="Reporte Costos de Mantenimiento" onMouseOver="window.status='';return true">
					Costos de Mantenimiento</a></li>
					<li class="subfirst"><a href="frm_reporteAceites.php" title="Reporte de Bit&aacute;cora de Aceites" onMouseOver="window.status='';return true">
					Bit&aacute;cora de Aceites</a></li>
					<li class="subfirst"><a href="frm_reporteConsumoAceite.php" title="Reporte Consumo de Aceite" onMouseOver="window.status='';return true">
					Reporte Consumo de Aceite</a></li>
					<li class="subfirst"><a href="frm_reporteConsumoGasolina.php" title="Reporte Consumo de Gasolina" onMouseOver="window.status='';return true">
					Reporte Consumo de Gasolina</a></li>
	...
	<div id="modulo" class="usr-reg">M&oacute;dulo de Mantenimiento</div>
