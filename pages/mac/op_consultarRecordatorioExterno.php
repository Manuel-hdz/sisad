			...
			do{
				...
				<?php if($noReg!=0){
						if($noReg==1){?>
							...
							onClick="javascript:window.open('marco_descarga2.php?id_documento=<?php echo $arrArch['id_documento'];?>&nomArchivo=<?php echo $arrArch['nom_archivo'];?>&ruta=<?php echo $arrArch['ruta'];?>&nombre=<?php echo $arrArch['nombre'];?>&tipo=<?php echo $arrArch['tipo_archivo'];?>&depto=<?php echo $depto;?>',
			...
			do{			
				...
				<tr>
					...
					<td class="<?php echo $nom_clase; ?>" align="center">
						...
						onClick="javascript:window.open('marco_descarga2.php?id_documento=<?php echo $datos['id_documento'];?>&nomArchivo=<?php echo $datos['nom_archivo'];?>&ruta=<?php echo $datos['ruta'];?>&nombre=<?php echo $datos['nombre'];?>&tipo=<?php echo $datos['tipo_archivo'];?>&depto=<?php echo $depto;?>',
						'_blank','top=300, left=450, width=1, height=1, status=no, menubar=no, resizable=no, scrollbars=yes, toolbar=no, location=no, directories=no');"/>		
				</td><?php 
			echo "</tr>";
				//Determinar el color del siguiente renglon a dibujar
