  	...
  	<table border="0" cellpadding="5" cellspacing="5" class="tabla_frm">
    	...
    	<tr>			
			<td><div align="right">&Aacute;rea Solicitante</div></td>
      		<td>
				<input name="txt_areaSolicitante" type="text" id="txt_areaSolicitante" onkeypress="return permite(event,'car',2);" size="25" maxlength="45" 
				value="MANTENIMIENTO EL&Eacute;CTRICO"/>
			</td>
			<td><div align="right">Solicit&oacute;</div></td>
		    <td colspan="2"><input name="txt_solicitanteReq" type="text" id="txt_solicitanteReq" onkeypress="return permite(event,'car',2);" size="42" 
                maxlength="60" value="<?php echo $solicitante?>"/>
            </td>
            <td><?php
