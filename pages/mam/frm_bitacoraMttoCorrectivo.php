...
<body><?php
	...
	//Asignamos a las variables lo que viene en la sesion, para recuperar los datos
	...
	<table width="795" height="363" cellpadding="5" cellspacing="5" class="tabla_frm">
        ...
        <tr>
			...
			<td><input name="txt_fechaMant" type="text" id="txt_fechaMant" size="10" maxlength="15" value="<?php echo date("d/m/Y"); ?>" readonly="readonly" /></td>
