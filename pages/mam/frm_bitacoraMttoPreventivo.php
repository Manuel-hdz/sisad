...
<body>
	...
	<form onSubmit="return valFormRegistrar(this);" name="frm_registrarBitacora" method="post" action="op_registrarBitacora.php">
	<table width="100%" cellpadding="5" cellspacing="5" class="tabla_frm">
		...
		<tr>
			...
			<td>$<?php //Comprobamos que venga definido en la session txt_costoMant y que se haya entrado a registrar material
				$importe = 0.00;
	 	...
	 	<tr>
			...
			<td valign="middle">
				<?php
					...
					$result=mysql_query("SELECT id_orden FROM orden_servicios_externos WHERE depto='MttoMina'");?>
