...
<body>
	...
	<?php
		...
		$stm_sql = "SELECT DISTINCT id_alerta_exa, puesto_realizar, fecha_exp, fecha_programada,alerta_examen.nom_empleado,
		 ...
		 JOIN alerta_examen ON id_historial = historial_clinico_id_historial WHERE catalogo_departamentos_id_departamento = '5' AND estado = '1'";
				...
				<td colspan="7" align="center">
					<input name="btn_regresar" id="btn_regresar" type="button" class="botones" value="Regresar" 
						onMouseOver="window.status='';return true" onclick="location.href='inicio_mantenimiento.php'"
						 title="Regresar al Inicio de Mantenimiento Mina"/>
				</td>
			</tr>
		</table>
		</div>
