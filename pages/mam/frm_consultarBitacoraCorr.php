...
<head>
    ...
    <style type="text/css">
		...
		#consultar {	position:absolute;	left:30px;	top:190px;	width:430px;height:166px;	z-index:15;}
		#reporte { position:absolute; left:30px; top:190px; width:921px; height:350px; z-index:21; overflow:scroll; }
		...
		#calendar-uno {position:absolute; left:345px; top:233px; width:30px; height:26px; z-index:18; }
		#calendar-dos {position:absolute; left:345px; top:267px; width:30px; height:26px; z-index:19; }
		-->
    </style>
</head>
<body>
	...
	if($band==0){
		...
		<table width="321" height="89" border="0" align="center"  cellpadding="5" cellspacing="5" class="tabla_frm">
			<tr>
