...
<body>
	...
	<form name="registrar_nomina" action="frm_continuarNominaMam.php" method="post">
    ...
    <?php
		...
		$msje="Registro de N&oacute;mina Mantenimiento Mina del <em><u>$_POST[txt_fechaIni_Con]</u></em> al <em><u>$_POST[txt_fechaFin_Con]</u></em>";
...
<?php 
		...
		modificarNomina($_POST["hdn_idnomina"]);
	}
