...
<head>
    ...
    <style type="text/css">
		...
		#calendario {position:absolute;left:558px;top:326px;width:30px;height:26px;z-index:13;}
...
<body><?php 
	...
	if(!isset($_POST['sbt_generarOrdenTrabajo'])){
		...
		$revisor="LEONARDO TORRES JIMENO";
		...
		if(!isset($_POST['sbt_continuar'])){ ?>		 
			...
			<table width="923" height="359" cellpadding="5" cellspacing="5" class="tabla_frm">
				...
				<tr>
					...
					<td><input type="text" name="txt_fechaProgramada" id="txt_fechaProgramada" size="10" maxlength="10" class="caja_de_texto" readonly="readonly" 
