...
<?php
	...
	if(!verificarPermiso($usr_reg,$_SERVER['PHP_SELF'])){	
		...
		//Archivo con las operaciones de registros de metricas
...
<head>
    ...
    <style type="text/css">
		...
		#titulo-tabla {	position:absolute; left:-10px; top:205px; width:960px; height:36px; z-index:8;}
    ...
    <table width="828"  cellpadding="5" cellspacing="5" class="tabla_frm">
        <tr>
            ...
            <td width="445">
				...
				$val = cargarComboBicondicional("cmb_familia","familia","equipos","bd_mantenimiento",$area,"area","ACTIVO","estado","Familia",$familia,"javascript:document.frm_registrarHorometro.submit()");
				if($val==0){?>
