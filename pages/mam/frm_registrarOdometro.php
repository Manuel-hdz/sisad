...
<body>
	...
	<script type="text/javascript" language="javascript" >
		window.onload = function(){ 
			...
			setTimeout("cargarCombo('<?php echo $cmb_area; ?>','bd_mantenimiento','equipos','familia','area','cmb_familia','Familia','<?php echo $cmb_familia; ?>');",500);
			<?php }?>
		}
    </script>	
		...
		<tr>
			...
			<td width="513">
            	<select name="cmb_familia" id="cmb_familia" 
                    onchange= "javasript:document.frm_registrarOdometro.submit(); ">
