...
<body>
	...
	<div class="titulo_barra" id="titulo-barra">Reporte de Disponibilidad F&iacute;sica, Mec&aacute;nica y Utilizaci&oacute;n de Equipos</div>
   ...
   if(!isset($_POST["sbt_generar"])){?>
	<fieldset class="borde_seccion" id="rpt-FMU" name="rpt-FMU">	
		...
		<form onsubmit="return verFormReportePreventivoCorrectivo(this);" name="frm_rptFecha" action="frm_reporteTiempos.php" method="post" >
	...
	?>
		...
		<div id="btns-rpt" align="center">
			...
			onclick="location.href='guardar_reporte.php?tipoRep=RepTiempos&fechaI=<?php echo $_POST["txt_fechaIni"];?>&fechaF=<?php echo $_POST["txt_fechaFin"];?>&turno=<?php echo $turno?>&equipo=<?php echo $equipo?>'"/>
			&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="button" name="btn_regresar" id="btn_regresar" value="Regresar" class="botones" title="Regresar a Seleccionar otros Criterios" onclick="location.href='frm_reporteTiempos.php'" />
		</div> 
	<?php }?>
</body>
