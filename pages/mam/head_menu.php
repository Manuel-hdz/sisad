...
<body onLoad="inicio(); setInterval(muestraReloj, 1000);" onkeypress="parar()" onclick="parar()" onmousemove="parar()">
	...
	<div id="logo" style="position:absolute; left:831px; top:-1px; width:154px; height:54px; z-index:4">
		<a href="javascript:void(0)" title="Ir a la Página Web de Concreto Lanzado de Fresnillo S.A. de C.V." onClick="window.open('http://www.concretolanzadodefresnillo.com','clf','');">
		...
		<ul id="css3menu"> 
			<li class="topfirst"><a href="menu_equipos.php" onMouseOver="window.status='';return true"  title="Equipos"><span>Equipos</span></a>
				<ul>
					...
					<li class="subfirst"><a href="frm_registrarEstatus.php" onMouseOver="window.status='';return true"  title="Registrar Status Equipos">Registrar Status</a></li>
			...
			<li class="topfirst"><a href="menu_reportes.php" title="Reportes" onMouseOver="window.status='';return true"><span>Reportes</span></a>
				<ul>
					...
					<li class="subfirst"><a href="frm_reporteStatus.php" title="Reporte de Estatus de los Equipos" onMouseOver="window.status='';return true">
					Status de Equipos</a></li>
					...
					<li class="subfirst"><a href="frm_reporteTiempos.php" title="Reporte de Disponibilidad Mec&aacute;nica, F&iacute;sica y Utilizaci&oacute;n Efectiva"
					onMouseOver="window.status='';return true">Disponibilidad, Usabilidad y Utilizaci&oacute;n</a>
					</li>
					<li class="subfirst"><a href="frm_reporteAceites.php" title="Reporte de Consumo de Aceites"
					onMouseOver="window.status='';return true">Consumo aceites</a>
