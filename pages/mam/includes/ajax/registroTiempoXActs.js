/**
  ...
  */
	...
	/**/
	function guardarTiempoXActividad(cajaTiempo,actividad){
		...
		if(cajaTiempo.readOnly){
			...
			var url = "includes/ajax/registroTiempoXActs.php?tiempo="+tiempo+"&ind="+actividad;
			...
			cargaTiempoGama(url, "GET", procesarRespuestaTiempoGama);
	...
	function cargaTiempoGama(url, metodo, funcion) {
	...
	function procesarRespuestaTiempoGama(){				
