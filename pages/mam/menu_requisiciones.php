    	...
    	<tr>
      		<td width="50%" align="center">
				...
				<form action="frm_generarRequisicion.php">
					<input type="image" src="images/add-requisicion.png"  width="115" height="190" border="0" title="Generar Requisici&oacute;n" onmouseover="window.status='';return true" /><br/>
      		...
      		<td width="50%" align="center">
				...
				<form action="frm_consultarRequisiciones.php">
					<input type="image" src="images/sea-requisicion.png" width="115" height="190" border="0" title="Estado Requisiciones" onmouseover="window.status='';return true"/><br/>
