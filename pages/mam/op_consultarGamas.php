	...
	function mostrarGamaSeleccionada(){
		...
		if($datos_gama=mysql_fetch_array($rs_gama)){
			...
			<table cellpadding='5' width='100%'>				
				...
				<tr>
					<td class='nombres_columnas' width='10%'>ID</td>
					<td class='nombres_columnas' width='20%'>NOMBRE GAMA</td>
					<td class='nombres_columnas' width='40%'>DESCRIPCION</td>
					<td class='nombres_columnas' width='10%'>AREA</td>
					<td class='nombres_columnas' width='10%'>FAMILIA</td>
					<td class='nombres_columnas' width='10%'>CICLO SERVICIO</td>
				</tr>			
				<tr>
					<td class='nombres_filas'>$datos_gama[id_gama]</td>
			...
			<table cellpadding='5' width='100%'>				
				...
				<tr>
					<td class='nombres_columnas' width='10%'>NO</td>
					<td class='nombres_columnas' width='90%'>SISTEMAS, APLICACIONES Y ACTIVIDADES</td>
				<tr>";
			...
			if($datos=mysql_fetch_array($rs)){
				...
				do{
					...
					if($band==1){
						...
						echo "
						<tr>					
							<td class='nombres_filas'>SISTEMA</td>
						...
						echo "
						<tr>					
							<td class='nombres_filas'>APLICACION</td>
					...
					echo "
					<tr>					
						<td class='nombres_filas'>$datos[id_actividad]</td>
		...
		if($datos_gama=mysql_fetch_array($rs)){
			echo "
				<table cellpadding='5' width='100%'>				
					<caption class='titulo_etiqueta'>Datos de la Gama Seleccionada</caption>
					<tr>						
						<td class='nombres_columnas' width='10%'>VER DETALLE</td>
						<td class='nombres_columnas' width='10%'>ID</td>
						<td class='nombres_columnas' width='20%'>NOMBRE GAMA</td>
						<td class='nombres_columnas' width='40%'>DESCRIPCION</td>
						<td class='nombres_columnas' width='10%'>AREA</td>
			...
			do{			
				echo"
					<tr>
						<td class='nombres_filas'><input type='checkbox' name='cmb_claveGama' value='$datos_gama[id_gama]' onclick='document.frm_gamasRelacionadas.submit();' /></td>						
