<?php
	...
	function generarOrdenTrabajo(){
		...
		if($rs){
			...
			registrarOperacion("bd_mantenimiento",$_SESSION['datosOT']['orden_trabajo'],"GenerarOT",$_SESSION['usr_reg']);
			//Si se agrega corectamente generar el pdf de la orden de trabajo?>
			<script type='text/javascript' language='javascript'>
				var codigoPopUp = "window.open('../../includes/generadorPDF/ordenTrabajoMttoMina.php? id=<?php echo $_SESSION['datosOT']['orden_trabajo'];  ?>', ";
