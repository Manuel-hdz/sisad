<?php
	...
	**/
	...
	function registrarBitacora(){
		...
		if($_POST["cmb_ordenExterna"]!="")
			$ordenExterna = $_POST["cmb_ordenExterna"];
		else
			$ordenExterna = "N/A";
		...
		$stm_sql = "UPDATE bitacora_mtto SET fecha_mtto='$fecha_mtto', horometro=$horometro, odometro=$odometro, tiempo_total='$tiempoTotal', costo_mtto=$costoTotal,
					num_factura='$num_factura', comentarios='$comentarios', prox_mtto='$prox_mtto', orden_servicios_externos_id_orden='$ordenExterna' WHERE id_bitacora='$id_bitacora'";
