...
<body>
	...
	<div id="barra"><img src="../../images/title-bar-bg.gif" width="999" height="30" /></div>
     <div class="titulo_barra" id="titulo-modificar">Complementar Plan de Acciones</div>
	<form onsubmit="return valFormReferenciasDepto(this);"name="frm_complementarPAE" id="frm_complementarPAE" method="post" action="op_complementarPlanAcciones.php"><?php 
		...
		<?php if($band!=0){?>
			...
			&nbsp;&nbsp;&nbsp;&nbsp;
			<input name="btn_cancelar" type="button" class="botones" value="Regresar" title="Regresar a Seleccionar Otro Departamento" 
