...
<title>Sistema de Gesti&oacute;n Empresarial, Producci&oacute;n y Operaci&oacute;n</title>
    ...
    <style type="text/css">
		<!--				
			...
			#tabla-empleados { position:absolute; left:30px; top:190px; width:945px; height:420px; z-index:21; overflow:scroll; }
...
<body>
	...
	<div class="titulo_barra" id="titulo-consultar-empleado">Reporte de Kardex Checador</div>
		...
		if(isset($_POST["sbt_consultar"])){
			...
			<div id="botones" align="center">
				...
				onclick="window.open('../../includes/generadorPDF/kardexChecador.php?fechaI=<?php echo $_POST["txt_fechaIni"]?>&fechaF=<?php echo $_POST["txt_fechaFin"]?>&tipo=<?php echo $tipo?>&criterio=<?php echo $criterio?>','_blank',
 ...
 <?php }
			...
			<br>		
			<form name="frm_consultarKardex1" method="post" action="frm_consultarKardexChecador.php" onsubmit="return valFormSeleccionarKardex1(this);">
				<table width="100%" border="0" cellpadding="5" cellspacing="5" class="tabla_frm">
					<tr>
					  <td width="70" ><div align="right">&Aacute;rea</div></td>
						<td width="130"><?php
								...
								$sql = "SELECT * FROM Dept WHERE DeptName LIKE 'gomar' ORDER BY DeptName";
								$rs_access = odbc_exec ($conn_access,$sql);
								//Confirmar que la consulta fue exitosa y guardar los datos en el ComboBox		
								if($datos = odbc_fetch_array($rs_access)){?>			
									<input type="text" name="cmb_areaName" id="cmb_areaName" readonly="readonly" 
									value="<?php echo $datos['DeptName']; ?>"/>
									<input type="hidden" name="cmb_area" id="cmb_area" 
									value="<?php echo $datos['Deptid']; ?>"/><?php
								}
					...
					<tr>
						<td align="center" colspan="4">
							...
							&nbsp;&nbsp;&nbsp;
							<input name="btn_cancelar" type="button" value="Regresar" class="botones" title="Regresar al Men&uacute; de Kardex"
