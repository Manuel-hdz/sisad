			...
			<table align="center">
				<tr>
					...
					<td><?php
						...
						$codigoPopUp = "window.open('../../includes/generadorPDF/ordenServicioExternoGomar.php?";
			...
			<tr>
				...
				<td width="15%">
					<?php	
							...
							$sql_stm = "SELECT DISTINCT familia FROM actividades_realizadas ORDER BY familia";
