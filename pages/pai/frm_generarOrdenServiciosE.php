...
<head>
    ...
    <style type="text/css">
		...
		#calendario-fechaSolicitud {position:absolute; left:280px; top:320px; width:30px; height:26px; z-index:13;}
		#calendario-fechaRecepcion {position:absolute; left:815px; top:320px; width:30px; height:26px; z-index:14;}
		-->
    </style>
</head>
<body>
	...
	if(isset($_POST['sbt_generarOrden'])){
		...
		if(isset($_SESSION['ordenServicioExterno'])){
			...
			$rs_datosEncargados = mysql_query("SELECT CONCAT(nombre,' ',ape_pat,' ',ape_mat) AS nombre, departamento 
												...
												WHERE departamento='DESARROLLO FRESNILLO' OR departamento='ASEGURAMIENTO DE CALIDAD' OR departamento='$deptoActual'");
			while($datosEncargados=mysql_fetch_array($rs_datosEncargados)){
				if($datosEncargados['departamento']=="DESARROLLO FRESNILLO")
		...
		<table width="100%" cellpadding="5" cellspacing="5" class="tabla_frm">
			...
			<tr>
				...
				<td><input type="text" name="txt_area" id="txt_area" class="caja_de_texto" readonly="readonly" size="10" value="<?php echo $area; ?>" /></td>            
