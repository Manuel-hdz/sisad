	...
	<table border="0" cellpadding="5" cellspacing="5" class="tabla_frm" >		
		<tr>
			...
			<td>
				...
				<div id="res-spider">
					<div align="left" class="suggestionsBox_gomar" id="suggestions1" style="display: none; width:380px;">
  	...
  	<table border="0" cellpadding="5" cellspacing="5" class="tabla_frm">
    	...
    	<tr>
			<td>
      		...
      		<td>
				<input name="txt_areaSolicitante" type="text" id="txt_areaSolicitante" onkeypress="return permite(event,'num_car');" size="25" maxlength="45" value="PAILERIA" required="required"/>
			</td>
			<td>
