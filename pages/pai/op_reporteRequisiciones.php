		...
		if($datos = mysql_fetch_array($rs)){
			...
			echo "								
				<table cellpadding='5'>
					<caption class='titulo_etiqueta'>$msg_titulo</caption>
					<tr>
						<td class='nombres_columnas_gomar'>VER DETALLE</td>
						<td class='nombres_columnas_gomar'>ID REQUISICI&Oacute;N</td>
						<td class='nombres_columnas_gomar'>DEPARTAMENTO</td>
						<td class='nombres_columnas_gomar'>FECHA</td>
						<td class='nombres_columnas_gomar'>SOLICIT&Oacute;</td>
						<td class='nombres_columnas_gomar'>REALIZ&Oacute;</td>
						<td class='nombres_columnas_gomar'>ESTADO</td>
						<td class='nombres_columnas_gomar'>PRIORIDAD</td>
						<td class='nombres_columnas_gomar'>TIEMPO DE ENTREGA</td>
					</tr>";
					echo "<form name='frm_mostrarDetalleRE' method='post' action='frm_reporteRequisiciones.php'>
					<tr>
						<td class='nombres_filas_gomar'><input type='checkbox' name='RE' value='todos' 	
						onClick='javascript:document.frm_mostrarDetalleRE.submit();' title='Ver El Detalle de Todas las Requisiciones'/></td>
						<td class='nombres_filas_gomar' colspan='8' align='left'><img src='../../images/arrow.png' height='20' width='30'> Ver Detalle de Todo</td>	
			...
			do{
				...
				echo "	
					<tr>	
						<td class='nombres_filas_gomar'><input type='checkbox' name='RE' value='$datos[id_requisicion]'
