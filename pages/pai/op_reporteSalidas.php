<?php
	...
	function mostrarSalidas($txt_fechaInicio,$txt_fechaCierre,$orden){
		...
		if($row = mysql_fetch_array($rs)){			
			...
			<tr>
				<th class='nombres_columnas_gomar'>Ver Detalle</th>
				<th class='nombres_columnas_gomar'>Clave</th>
				<th class='nombres_columnas_gomar'>Departamento Solicitante</th>
				<th class='nombres_columnas_gomar'>Solicit&oacute;</th>
				<th class='nombres_columnas_gomar'>Turno</th>
				<th class='nombres_columnas_gomar'>Destino</th>
				<th class='nombres_columnas_gomar'>Fecha</th>
			...
			echo "
				<tr>
					...
					<td class='nombres_columnas_gomar'>TOTAL</td>
		...
		if($datos=mysql_fetch_array($rs)){
			...
			echo "				
				<table cellpadding='5' width='100%'>
					...
					<tr>					
						<td class='nombres_columnas_gomar'>CLAVE</td>
        				<td class='nombres_columnas_gomar'>MATERIAL</td>
						<td class='nombres_columnas_gomar'>UNIDAD DE MEDIDA</td>
				        <td class='nombres_columnas_gomar'>CANTIDAD SALIDA</td>						
        				<td class='nombres_columnas_gomar'>COSTO UNITARIO</td>
						<th class='nombres_columnas_gomar'>SUBTOTAL</th>
						<th class='nombres_columnas_gomar'>ID EQUIPO</th>
      				</tr>";
			$nom_clase = "renglon_gris";
			$cont = 1;	
