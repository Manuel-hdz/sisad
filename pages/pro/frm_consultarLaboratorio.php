...
<?php
	...
	//Comprobar que el usuario registrado tenga acceso a esta seccion de Producción
	if(!verificarPermiso($usr_reg,$_SERVER['PHP_SELF'])){		
		...
		include ("op_consultarLaboratorio.php");?>
...
<body>
    ...
    <div class="titulo_barra" id="titulo-generar">Generar Reporte Pruebas de Mezclas</div><?php 
	if(!isset($_POST['ckb_idMuestra'])){?>
        ...
        <br>
        <form onSubmit="return valFormGenRepPba(this);" name="frm_reporteResistencias" method="post" action="frm_consultarLaboratorio.php">
            ...
            <tr>
                <td colspan="2" align="center">
                  <input name="sbt_continuar" id="sbt_continuar" type="submit" class="botones" value="Continuar" onmouseover="window.status='';return true" 
                    ...
                    &nbsp;&nbsp;&nbsp;
                    <input name="btn_regresar" type="button" class="botones" value="Regresar" onclick="location.href='inicio_produccion.php';"
                    title="Regresar Menú Inicio"/>
                </td>
            </tr>
        </table>
        </form>
		...
		if(isset($_POST['sbt_continuar'])){?>
            <form name="frm_detalleMuestra" method="post" action="frm_consultarLaboratorio.php">
		...
		<div id="btn-regresardetalle" align="center">
            <form name="" action="frm_consultarLaboratorio.php" method="post"><?php
