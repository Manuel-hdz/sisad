...
<title>Sistema de Gesti&oacute;n Empresarial, Producci&oacute;n y Operaci&oacute;n</title>
	...
	<script type="text/javascript" language="javascript">
		setTimeout("cargarRequisicion(8);",500);
	</script>
    	...
    	<table width="931" height="92" border="0" cellpadding="5" cellspacing="5" class="tabla_frm">
    		<tr>
				...
				<td width="163">
					...
					readonly="readonly" width="50" onchange="cargarRequisicion(8);"/>
				</td>
            	...
            	<td colspan="3">
					...
					width="50" 	onchange="cargarRequisicion(8);" />
				</td>
			</tr>
        	<tr>
            <td align="right">
            ...
            <td>
				<select name="cmb_buscarPor" id="cmb_buscarPor" class="combo_box" disabled="disabled"  onchange="cargarRequisicion(8);">
            ...
            <td width="239">
				...
				onchange="cargarRequisicion(8);" ></textarea>
			</td>
            <td width="67">Requisici&oacute;n</td>
            <td width="152">
				<select name="cmb_estadoRequisicion" id="cmb_estadoRequisicion" class="combo_box" onchange="cargarTablaRequisicion(this.value,8);">
