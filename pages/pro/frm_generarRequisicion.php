			...
			<form onsubmit="return valFormInformacionRequisicion(this);" name="frm_InformacionRequisicion" method="post"
				...
				<table width="100%" border="0" cellpadding="5" class="tabla_frm">
					<tr>
						...
						<td>
							<textarea name="txa_justificacionReq" maxlength="120" onkeyup="return ismaxlength(this)" cols="30"
					...
					<tr>
                        ...
                        <td>
                            <input name="txt_areaSolicitante" type="text" id="txt_areaSolicitante" onkeypress="return permite(event,'num_car');" size="25" maxlength="45" value="PRODUCCI&Oacute;N" required="required"/>
                        </td>
                        <td>
                            <div align="right">Solicit&oacute;</div>
                        </td>
                        <td>
                            <input name="txt_solicitanteReq" type="text" id="txt_solicitanteReq" onkeypress="return permite(event,'num_car');" size="40" maxlength="60" value="<?php echo $solicitante;?>" required="required"/>
                        </td>
                    </tr>
					<tr>
						<td>
