<?php
	...
	if($clave==""){	
		...
		$sql_stm = "SELECT id_presupuesto FROM presupuesto JOIN catalogo_destino ON catalogo_destino_id_destino=id_destino
					WHERE '$fecha1'>=fecha_inicio AND '$fecha1'<=fecha_fin AND id_destino=$idDestino";
		...
		$sql_stm2 = "SELECT id_presupuesto FROM presupuesto JOIN catalogo_destino ON catalogo_destino_id_destino=id_destino
					WHERE '$fecha2'>=fecha_inicio AND '$fecha2'<=fecha_fin AND id_destino=$idDestino";
		//Ejecutar la Sentencia previamente creada
		...
		if($bandF1==0&&$bandF2==0){
			//Crear la Sentencia SQL
			$sql_stm = "SELECT id_presupuesto FROM presupuesto JOIN catalogo_destino ON catalogo_destino_id_destino=id_destino
						WHERE fecha_inicio>='$fecha1' AND fecha_fin<='$fecha2' AND id_destino=$idDestino";
			//Ejecutar la Sentencia previamente creada
			$rs = mysql_query($sql_stm);
		...
		//Crear la Sentencia SQL
		$sql_stm = "SELECT id_presupuesto FROM presupuesto JOIN catalogo_destino ON catalogo_destino_id_destino=id_destino
					WHERE '$fecha1'>=fecha_inicio AND '$fecha1'<=fecha_fin AND id_destino=$idDestino AND id_presupuesto!='$clave'";
		//Ejecutar la Sentencia previamente creada
		$rs = mysql_query($sql_stm);
		...
		$sql_stm2 = "SELECT id_presupuesto FROM presupuesto JOIN catalogo_destino ON catalogo_destino_id_destino=id_destino
					WHERE '$fecha2'>=fecha_inicio AND '$fecha2'<=fecha_fin AND id_destino=$idDestino AND id_presupuesto!='$clave'";
		//Ejecutar la Sentencia previamente creada
		$rs2 = mysql_query($sql_stm2);
		...
		if($bandF1==0&&$bandF2==0){
			//Crear la Sentencia SQL
			$sql_stm = "SELECT id_presupuesto FROM presupuesto JOIN catalogo_destino ON catalogo_destino_id_destino=id_destino
						WHERE fecha_inicio>='$fecha1' AND fecha_fin<='$fecha2' AND id_destino=$idDestino AND id_presupuesto!='$clave'";
			//Ejecutar la Sentencia previamente creada
			$rs = mysql_query($sql_stm);
