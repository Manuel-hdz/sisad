...
<?php
	...
	if(isset($_SESSION['datosConsultaOTSE']))
    	...
    	<tr>
      		<td width="50%" align="center">
				...
				<form action="frm_gestionarServiciosExternos.php">
					<input type="image" src="images/ges-serv-planta.png"  width="120" height="230" border="0" title="Gestionar &Oacute;rdenes de Servicio Externas para Planta" 
					onmouseover="window.status='';return true" /><br/>
					<input type="image" src="../../images/btn-gestionar.png" name="btn1" id="bnt1" width="118" height="46" border="0" title="Gestionar &Oacute;rdenes de Servicio Externas para Planta"
