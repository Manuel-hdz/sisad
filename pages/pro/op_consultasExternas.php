<?php
	/**
	  ...
	  * Nombre Programador: (adecuado por:) Maurilio Hernández Correa
	  * Fecha: 11/Julio/2011
	...
	**/
	...
	function mostrarMateriales(){
		...
		$stm_sql = "SELECT * FROM materiales JOIN unidad_medida ON id_material=materiales_id_material WHERE grupo='PLANTA' ORDER BY linea_articulo";
