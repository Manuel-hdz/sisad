<?php
	...
	function desplegarAlertasCompras(){
		...
		departamento = 'RECURSOS HUMANOS' AND estado='0'";		
	...
	function notificarAlertaCompras($num_alertas){?>
		...
		<script type="text/javascript" language="javascript">
			setTimeout("popup_show('popup_rh0', 'popup_drag_rh0', 'popup_exit_rh0', 'screen-top-left', 75, 400);",1000);			
		</script>
		<!-- ********************************************************* Popup Window **************************************************** -->
	...
	function mostrarAlertasCompras($ctrl){		
		...
		WHERE estado = '0' AND departamento = 'RECURSOS HUMANOS'";
