	...
	<div id="parrilla-menu1" align="center">
		...
		if(isset($_GET['err'])) { 
			if($err=="AccesoNegado") {		
            	...
            	<meta http-equiv="refresh" content="7;url=inicio_recursos.php">
				<p>
