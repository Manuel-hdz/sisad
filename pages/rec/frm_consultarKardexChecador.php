	...
	<body>
		...
		<div id="botones" align="center">
			...
			<input name="sbt_verPDF" type="button" value="Ver PDF" class="botones"
				onclick="window.open('../../includes/generadorPDF/Checador_Detalle.php?fechaI=<?php echo $_POST["txt_fechaIni"]?>&fechaF=<?php echo $_POST["txt_fechaFin"]?>&tipo=<?php echo $tipo?>&criterio=<?php echo $criterio?>','_blank',
		...
		<fieldset class="borde_seccion" id="consultar-kardex">
			...
			<form name="frm_consultarKardex1" method="post" action="frm_consultarKardexChecador.php"
				...
				<table width="100%" border="0" cellpadding="5" cellspacing="5" class="tabla_frm">
					...
					<tr>
						<td colspan="2">
							<div align="right">Filtrar por Trabajador <input type="checkbox" name="ckb_filtroTrab"
									id="ckb_filtroTrab" onclick="verificarFiltroEmpleado(this,txt_nombreK,cmb_area);" />
							</div>
						</td>
						<td colspan="2">
							<input type="text" name="txt_nombreK" id="txt_nombreK" class="caja_de_texto"
								onkeyup="lookup(this,'empleados','','2');" value="" size="60" maxlength="80"
								onkeypress="return permite(event,'car',0);" readonly="readonly" autocomplete="off" />
							<div id="res-spiderK">
					...
					<tr>
						<td align="center" colspan="4">
							...
							<input name="btn_cancelar" type="button" value="Regresar" class="botones"
								title="Regresar al Men&uacute; de Kardex" onclick="location.href='menu_kardex.php'" />
						</td>
					</tr>
				</table>
			</form>
