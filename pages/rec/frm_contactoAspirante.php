...
<head>
    ...
    <style type="text/css">
		<!--
		#titulo-agregar {position:absolute; left:30px; top:146px; width:231px; height:20px; z-index:11; }
		#tabla-contactoAspirantes { position:absolute; left:20px; top:190px; width:954px; height:308px; z-index:12; padding:15px; padding-top:0px;}
		#resultados-ContactoAspirante { position:absolute; left:110px; top:544px; width:769px; height:130px; z-index:22; overflow:scroll; }		
		-->
    </style>
</head>
<body><?php 	
	...
	if(isset($_SESSION['datosContactoAspirante'])){?>
		<div id="resultados-ContactoAspirante" class='borde_seccion2' align="center"><?php
			mostrarContactosAspirante();?>
		</div><?php 
	}?>
	<div id="barra"><img src="../../images/title-bar-bg.gif" width="999" height="30" /></div>
    <div class="titulo_barra" id="titulo-agregar">Registrar Contacto del Aspirante</div>
	
	<fieldset class="borde_seccion" id="tabla-contactoAspirantes">
	<legend class="titulo_etiqueta">Contacto del Aspirante</legend>	
	<br>
	<form onSubmit="return valFormContactoAspirantes(this);" name="frm_contactoAspirante" method="post" action="frm_contactoAspirante.php" > 
	<table width="100%" cellpadding="5" cellspacing="5" class="tabla_frm">
		<tr>
			...
			<td width="28%">
				...
				onkeypress="return permite(event,'num_car', 3);" value="<?php echo obtenerFolioAspirante(); ?>" readonly="readonly" />		  </td>
		...
		<tr>
			...
			<td align="left">	
				<input name="txt_numExt" type="text" class="caja_de_texto" size="5" maxlength="10" />
				&nbsp;&nbsp;</td>
			...
			<td colspan="4">
				<div align="center">
					...
					<?php if(isset($_SESSION['datosContactoAspirante'])){//Si al menos un puesto ha sido agregado, mostrar el boton de Ginalizar ?>
						<input name="sbt_finalizarRegistroContacto" type="submit" class="botones"  value="Finalizar" title="Finalizar el Registro de los Contactos del Aspirante" 
						onmouseover="window.status='';return true" onclick="hdn_botonSeleccionado.value='finalizarRegistro';" />
					<?php } ?>
					&nbsp;&nbsp;&nbsp;
					<input name="sbt_registrarContacto" type="submit" class="botones_largos" id="sbt_contacto" title="Agregar los Contactos del Aspirante Registrado" 
					onMouseOver="window.status='';return true"  value="Agregar Contacto" onclick="hdn_botonSeleccionado.value='registrarContacto';" />				
					&nbsp;&nbsp;&nbsp;
