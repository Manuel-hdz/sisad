...
<Sistema de Gestion Empresarial, Produccion y Operacion html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<script type="text/javascript" src="../../includes/ajax/busq_spider_material_req_recursos.js"></script>
	...
	?>
		...
		<fieldset id="tabla-material" class="borde_seccion">
			...
			<br>
			<form onsubmit="return valFormGenerarRequisicion(this);" name="frm_generarRequisicion" method="post"
					...
					<tr>
						...
						<td>
							<input type="text" name="cmb_material" id="cmb_material" class="caja_de_texto" size="30"
								...
								onchange="validarMaterialRequi(txt_clave.value, cmb_material, cmb_material.value);" />
							<div id="res-spider">
					...
					<tr>
						...
						<td>
							<input name="txt_elaboradorReq" type="text" id="txt_elaboradorReq"
								onkeypress="return permite(event,'num_car');" size="40" maxlength="60" value="<?php echo $elaborador;?>"
								readonly="readonly" />
					...
					<tr>
						...
						<td>
							<input name="txt_areaSolicitante" type="text" id="txt_areaSolicitante"
								onkeypress="return permite(event,'num_car');" size="25" maxlength="45" value="RECURSOS HUMANOS"
								required="required" />
						</td>
						<td>
						...
						<td>
							<input name="txt_solicitanteReq" type="text" id="txt_solicitanteReq"
								onkeypress="return permite(event,'num_car');" size="40" maxlength="60" required="required" />
						</td>
					</tr>
					<tr>
						<td>
