...
<?php
	...
	if(!verificarPermiso($usr_reg,$_SERVER['PHP_SELF'])){	
		...
		include ("op_modificarBonoProd.php");
		?>
...
<body>
    ...
    <div class="titulo_barra" id="titulo-consultar">Modificar Bono de Productividad</div>

	<?php
	if (!isset($_POST["sbt_consultar"]) && !isset($_POST["sbt_guardar"])){
	?>
		...
		<br>
		<form name="frm_consultarBono" method="post" action="frm_modificarBonoProd.php" onsubmit="">
			<table width="415"  cellpadding="5" cellspacing="5" class="tabla_frm">
				...
				<tr>
					<td colspan="5">
						<div align="center">
							<input name="sbt_consultar" type="submit" class="botones" id= "sbt_guardar" value="Consultar" title="Modificar Bono de Productividad"
	...
	?>
		<form name="frm_consultarResultados" action="" method="post">
			...
			<div id="botones" align="center">
				<input name="sbt_guardar" type="submit" class="botones_largos" id="sbt_guardar" value="Modificar Bonos"
				onmouseover="window.status='';return true;" title="Modificar Bonos de Productividad"/>
				&nbsp;&nbsp;
				<input name="btn_regresar" type="button" class="botones" value="Regresar" title="Regresar a Seleccionar Otros Datos para Reporte" 
				onmouseover="window.status='';return true" onclick="location.href='frm_modificarBonoProd.php'" />
			</div>
		</form>
	<?php
	}
	else if(isset($_POST["sbt_guardar"])){
		modificarDetalleBono();
	?>
