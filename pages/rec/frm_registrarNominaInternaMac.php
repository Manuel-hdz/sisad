...
<body>
	...
	<form name="registrar_nomina" action="frm_registrarNominaInternaMac.php" method="post">
	...
	<div id='botones' align='center'>
		...
		<input name="btn_cancelar" type="button" class="botones" value="Cancelar" title="Cancelar Registro de Nomina" onclick="location.href='frm_registrarNominaMac.php'"/>
	</div>
	</form>
</body>
<?php 
