...
<body>
	...
	<div class="titulo_barra" id="titulo-detalle" style="width:300px;">N&oacute;mina de Mantenimiento Mina</div>
	<?php if(!isset($_POST['btn_continuar'])){ ?>
	<form name="registrar_nomina" action="frm_registrarNominaInternaMam.php" method="post">
    ...
    <?php
		...
		$msje="Registro de N&oacute;mina Mantenimiento Mina del <em><u>$_POST[txt_fechaIni]</u></em> al <em><u>$_POST[txt_fechaFin]</u></em>";
	...
	<div id='botones' align='center'>
		...
		<input name="btn_cancelar" type="button" class="botones" value="Cancelar" title="Cancelar Registro de Nomina" onclick="location.href='frm_registrarNominaMam.php'"/>
	</div>
	</form>
</body>
<?php 
