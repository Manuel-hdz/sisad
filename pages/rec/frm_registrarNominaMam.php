...
<body>
	...
	<br>
	<form name="frm_registrarNomina" method="post" action="frm_registrarNominaInternaMam.php" onsubmit="return valSeleccionarNomina(this);">
		<table width="415"  cellpadding="5" cellspacing="5" class="tabla_frm">
			<tr>
				...
				<td colspan="4"><?php
					...
					$result=mysql_query("SELECT DISTINCT id_nomina FROM nominas WHERE area = 'MANTENIMIENTO MINA' AND finalizada = '1' ORDER BY id_nomina");
