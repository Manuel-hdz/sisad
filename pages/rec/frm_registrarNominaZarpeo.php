...
<body>
	...
	<br>
	<form name="frm_registrarNomina" method="post" action="frm_registrarNominaInternaZarpeo.php" onsubmit="return valSeleccionarNomina(this);">
			...
			<tr>
				...
				<td colspan="4"><?php
					...
					if($nominas=mysql_fetch_array($result)){ ?>
						<select name="cmb_nomina" id="cmb_nomina" size="1" class="combo_box" onchange="cargarTxtFechas(this.value,'txt_fechaIni','txt_fechaFin','bd_gerencia')">
