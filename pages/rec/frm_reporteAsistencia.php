...
<?php
	...
	//Enviar a la pagina de acceso negado
		...
		include ("op_reporteAsistencia.php");?>
<head>
...
<body>
	...
	<div class="titulo_barra" id="titulo-consultar-empleado">Reporte de Asistencias </div>
		<?php 
...
<?php }
			...
			<legend class="titulo_etiqueta">Reporte de Asistencias por &Aacute;rea</legend>	
			<br>
			<form  method="post" name="frm_reporteFechaArea" id="frm_reporteFechaArea" onsubmit="return valFormRptAsistencia(this);" >
			<table width="444" border="0" cellpadding="5" cellspacing="5" class="tabla_frm">
				<tr>
					<td colspan="2"><div align="right">Fecha Inicio</div></td>
				  	<td width="95">
						...
						value="<?php echo date("d/m/Y", strtotime("-6 day")); ?>" size="10"  width="90" onchange="calcularDomingos();" />
					</td>
				...
				<tr>
					...
					<td colspan="4"><?php
						if(isset($_SESSION["datosGrapAsistencias"])){
							unset($_SESSION["datosGrapAsistencias"]);
						} 
						$cmb_area="";
