...
<?php
	...
	//Enviar a la pagina de acceso negado
		...
		//Archivo que incluye las operaciones para realizar el reporte de Incapacidades
		include ("op_reporteIncapacidades.php");?>
<head>
...
<title>Sistema de Gesti&oacute;n Empresarial, Producci&oacute;n y Operaci&oacute;n</title>
    ...
    <style type="text/css">
		<!--				
			...
			#calendar-cuatro {position:absolute; left:943px; top:239px; width:30px; height:26px; z-index:18; }
		-->
    </style>
</head>
<body>
	<div id="barra"> <img src="../../images/title-bar-bg.gif" width="999" height="30" /></div>
	<div class="titulo_barra" id="titulo-consultar-empleado">Reporte de Incapacidades </div><?php 
		...
		if(isset($_POST["sbt_consultar"])){
			echo"<div align='center' id='tabla-empleados' class='borde_seccion2' width='100%' >";
				//Si viene definido el boton; mostrar el reporte de Incapacidades
 ...
 <?php }
			...
			<legend class="titulo_etiqueta">Reporte de Incapacidades por &Aacute;rea</legend>	
			<br>
			<form  method="post" name="frm_reporteFechaArea" id="frm_reporteFechaArea" onsubmit="return valFormRptIncapacidades(this);">
			<table width="444" border="0" cellpadding="5" cellspacing="5" class="tabla_frm">
				...
				<tr>
					...
					<td colspan="4"><?php 
						if(isset($_SESSION["datosGrapIncapacidades"])){
							unset($_SESSION["datosGrapIncapacidades"]);
						}
						$cmb_area="";
			...
			<div align="center">
				<p>
					...
					onmouseover="window.status='';return true;" title="Generar Reporte Incapacidades"/>
					&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<legend class="titulo_etiqueta">Reporte de Incapacidades por Fecha </legend>	
			<br>
			<form  method="post" name="frm_reporteFecha" id="frm_reporteFecha"  onsubmit=" return valFormRptIncapacidadFecha(this);" >
			<table width="444" border="0" cellpadding="5" cellspacing="5" class="tabla_frm">
				<tr>
