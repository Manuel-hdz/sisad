...
<body>
	...
	<div class="titulo_barra" id="titulo-consultar-empleado">Reporte de Kardex </div>
		<?php 
		...
		if(isset($_POST["sbt_consultar"])){
			...
			<div id="botones" align="center">
				...
				onclick="location.href='guardar_reporte.php?kardeDetalle=1&fechaI=<?php echo $_POST["txt_fechaIni"]?>&fechaF=<?php echo $_POST["txt_fechaFin"]?>&tipo=<?php echo $tipo?>&criterio=<?php echo $criterio?>&dias=<?php echo $dias?>'"/>
				&nbsp;&nbsp;&nbsp;&nbsp;
				<input name="btn_regresar" type="button" value="Regresar" class="botones" title="Regresar a Consultar con Otros Datos"
				onclick="location.href='frm_reporteKardex.php'" />
			</div>
 <?php }
	  else{ ?> 
			...
			<br>		
			<form name="frm_consultarKardex1" method="post" action="frm_reporteKardex.php" onsubmit="return valFormSeleccionarKardex1(this);">
