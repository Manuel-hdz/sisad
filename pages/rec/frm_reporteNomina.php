...
<?php
	...
	//Comprobar que el usuario registrado tenga acceso a esta seccion del Módulo de Reursos Humanos
	...
	//Enviar a la pagina de acceso negado
		...
		//Archivo que incluye las operaciones para realizar el reporte de Nómina
...
<title>Sistema de Gesti&oacute;n Empresarial, Producci&oacute;n y Operaci&oacute;n</title>
    ...
    <style type="text/css">
		<!--				
			...
			#calendar-tres {position:absolute; left:731px; top:240px; width:30px; height:26px; z-index:18; }
			#calendar-cuatro {position:absolute; left:942px; top:241px; width:30px; height:26px; z-index:18; }
		-->
    </style>
</head>
<body>
	<div id="barra"> <img src="../../images/title-bar-bg.gif" width="999" height="30" /></div>
	<div class="titulo_barra" id="titulo-consultar-empleado">Reporte de N&oacute;mina </div><?php 
		//Verificamos si viene definido en el post el boton consultar
		if(isset($_POST["sbt_consultarQUITARESTO"])){
			echo"<div align='center' id='tabla-empleados' class='borde_seccion2' width='100%' >";
				//Si viene definido el boton; mostrar el reporte de Nomina
				reporteNomina();					
			echo "</div>";?>	
 <?php }
	  else{ 
	  	if(isset($_POST["sbt_consultar"])){
			...
			<script type="text/javascript" language="javascript">
				setTimeout("alert('Reporte en Construcción')",500);
			</script>
			<?php
		}
	  ?> 
			...
			<legend class="titulo_etiqueta">Reporte de N&oacute;mina por &Aacute;rea</legend>	
			<br>
			<form  method="post" name="frm_reporteFechaArea" id="frm_reporteFechaArea" onsubmit="return valFormRptNomina(this);"  >
			...
			<div align="center">
				<p>
					...
					onmouseover="window.status='';return true;" title="Generar Reporte N&oacute;mina"/>
					&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<legend class="titulo_etiqueta">Reporte de N&oacute;mina por Fecha </legend>	
			<br>
			<form  method="post" name="frm_reporteFecha" id="frm_reporteFecha"  onsubmit=" return valFormRptNominaFecha(this);" >
			<table width="444" border="0" cellpadding="5" cellspacing="5" class="tabla_frm">
				<tr>
			...
			<div id="calendar-dos">
				<input name="fechaFin" id="fechaFin" type="image" src="../../images/calendar.png" onclick="displayCalendar(document.frm_reporteFechaArea.txt_fechaFin,'dd/mm/yyyy',this)" 
