...
<body>
    ...
    <div class="titulo_barra" id="titulo-consultar" style="width:300px">Reporte N&oacute;mina Mantenimiento Superficie</div>
	...
	?>
		...
		<br>
		<form name="frm_reporteNomina" method="post" action="frm_reporteNominaMac.php" onsubmit="return valSeleccionarNomina(this);">
			<table width="415"  cellpadding="5" cellspacing="5" class="tabla_frm">
				<tr>
					...
					<td width="276">
						...
						onchange="cargarCmbNomina('cmb_nomina',this.value,txt_fechaFin.value,'bd_mantenimiento','MANTENIMIENTO SUPERFICIE','1')"/>
					</td>
					...
					onchange="cargarCmbNomina('cmb_nomina',txt_fechaIni.value,this.value,'bd_mantenimiento','MANTENIMIENTO SUPERFICIE','1')"/></td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="5">
						<div align="center">
							<input name="sbt_consultar" type="submit" class="botones" id= "sbt_guardar" value="Consultar" title="Consultar N&oacute;mina Mantenimiento Superficie"
				...
				<input type="hidden" name="hdn_area" id="hdn_area" value="MANTENIMIENTO SUPERFICIE"/>
		  </table>
		</form>
		</fieldset>
		...
		<div id="botones" align="center">
			<form name="frm_consultarResultados" action="guardar_reporte2.php" method="post">
				...
				?>
					...
					<input type="hidden" name="hdn_bd" id="hdn_bd" value="bd_mantenimiento"/>
					<input type="hidden" name="hdn_tipoReporte" id="hdn_tipoReporte" value="exportarNominaMac"/>
			...
			onmouseover="window.status='';return true" onclick="location.href='frm_reporteNominaMac.php'" />
			</form>
		</div>
	<?php
	}
	...
	<script type="text/javascript">
		cargarCmbNomina('cmb_nomina',txt_fechaIni.value,txt_fechaFin.value,'bd_mantenimiento','MANTENIMIENTO SUPERFICIE','1');
	</script>
</body>
