...
<body>
	...
	?>
		...
		<br>
		<form name="frm_reporteNomina" method="post" action="frm_reporteNominaMam.php" onsubmit="return valSeleccionarNomina(this);">
			<table width="415"  cellpadding="5" cellspacing="5" class="tabla_frm">
				<tr>
					...
					<td width="276">
						...
						onchange="cargarCmbNomina('cmb_nomina',this.value,txt_fechaFin.value,'bd_mantenimiento','MANTENIMIENTO MINA','1')"/>
					</td>
					...
					onchange="cargarCmbNomina('cmb_nomina',txt_fechaIni.value,this.value,'bd_mantenimiento','MANTENIMIENTO MINA','1')"/></td>
				</tr>
				<tr>
	...
	?>
		...
		<div id="botones" align="center">
			...
			onmouseover="window.status='';return true" onclick="location.href='frm_reporteNominaMam.php'" />
			</form>
		</div>
	<?php
	}
	...
	<script type="text/javascript">
		cargarCmbNomina('cmb_nomina',txt_fechaIni.value,txt_fechaFin.value,'bd_mantenimiento','MANTENIMIENTO MINA','1');
	</script>
</body>
