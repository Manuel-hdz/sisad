...
<?php
	...
	//Enviar a la pagina de acceso negado
		...
		//Archivo que incluye las operaciones para realizar el reporte de Reclutamiento
		include ("op_reporteReclutamiento.php");?>
<head>
...
<title>Sistema de Gesti&oacute;n Empresarial, Producci&oacute;n y Operaci&oacute;n</title>
    ...
    <style type="text/css">
		<!--				
			...
			#calendar-dos {position:absolute; left:446px; top:240px; width:30px; height:26px; z-index:19; }
			#calendar-tres {position:absolute; left:732px; top:241px; width:30px; height:26px; z-index:18; }
			#calendar-cuatro {position:absolute; left:942px; top:242px; width:30px; height:26px; z-index:18; }
		-->
    </style>
</head>
<body>
	<div id="barra"> <img src="../../images/title-bar-bg.gif" width="999" height="30" /></div>
	<div class="titulo_barra" id="titulo-consultar-empleado">Reporte de Reclutamiento </div>
		<?php 
		...
		if(isset($_POST["sbt_consultar"])){
			echo"<div align='center' id='tabla-empleados' class='borde_seccion2' width='100%' >";
				//Si viene definido el boton; mostrar el reporte de Reclutamiento
				reporteReclutamiento();					
			echo "</div>";?>	
 <?php }
	  else{ ?> 
			</form> 
			<fieldset class="borde_seccion" id="tabla-consultar-empleados">
			<legend class="titulo_etiqueta">Reporte de Reclutamiento por &Aacute;rea</legend>	
			<br>
			<form  method="post" name="frm_reporteFechaArea" id="frm_reporteFechaArea" onsubmit="return valFormRptReclutamiento(this);"  >
				...
				<tr>
					<td colspan="2"><div align="right">Fecha Inicio</div></td>
				  	<td width="95">
						...
						value="<?php echo date("d/m/Y", strtotime("-15 day")); ?>" 	size="10" maxlength="15" width="90" />
					</td>
					<td width="85"><div align="right">Fecha Fin </div></td>
					<td width="122">
						<input name="txt_fechaFin" id="txt_fechaFin2" type="text"  readonly="readonly" 
						value="<?php echo date("d/m/Y"); ?>" size="10" maxlength="15" width="90" />
					</td>
				</tr>
				<tr>
			...
			<div align="center">
				<p>
					...
					onmouseover="window.status='';return true;" title="Generar Reporte Reclutamiento"/>
					&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<legend class="titulo_etiqueta">Reporte de Reclutamiento por Fecha </legend>	
			<br>
			<form  method="post" name="frm_reporteFecha" id="frm_reporteFecha"  onsubmit=" return valFormRptReclutamientoFecha(this);" >
			<table width="444" border="0" cellpadding="5" cellspacing="5" class="tabla_frm">
				<tr>
