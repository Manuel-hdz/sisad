<?php 
	...
	if(isset($_POST['sbt_excel'])){
		if(isset($_POST['hdn_consulta'])){
			...
			switch($hdn_tipoReporte){
				case "exportarNominaDesarrollo":
					guardarRepNominaDesarrollo($hdn_consulta,$hdn_msje,$fecha_ini, $fecha_fin);
				break;
				case "exportarNominaZarpeo":
					guardarRepNominaZarpeo($hdn_consulta,$hdn_msje,$fecha_ini, $fecha_fin);
				break;
				case "exportarNominaMam":
					guardarRepNominaMam($hdn_consulta,$hdn_msje,$fecha_ini, $fecha_fin);
				break;
				case "exportarNominaMac":
					guardarRepNominaMac($hdn_consulta,$hdn_msje,$fecha_ini, $fecha_fin);
				break;
				case "exportarNominaAdministracion":
					guardarRepNominaAdministracion($hdn_consulta,$hdn_msje,$fecha_ini, $fecha_fin);
				break;
			}				
		}
	}
	...
	function guardarRepNominaDesarrollo($hdn_consulta,$hdn_msje,$fecha_ini,$fecha_fin){
		//Manejo de fechas
		include_once("../../includes/func_fechas.php");
		//Esribir datos de la pagina en excel
		header("Content-type: application/vnd.ms-excel");
		header("Content-Disposition: attachment; filename=Nomina_Desarrollo.xls");		
					...
					<?php //do{
						//if($cadena != $datos["nombre"]){?>
							...
							<tr>
								...
								<td width="50"></td><td width="50"></td><td width="50"></td><td width="150"></td><td width="200"></td>
							</tr>
							<tr></tr>
							<tr>
								<td></td>
								...
								<?php if($_POST["hdn_bd"] == "bd_recursos"){ ?>
									<td class="cantidad_topes_total">BONO</td>
								<?php } ?>
					...
					<?php //} 
						...
						do{
							...
							<tr>
								...
								<td class="cantidad_total" style="<?php echo colorCelda($datos["jueves"]); ?>"><?php if($datos["jueves"]=="B") echo "<font style='color:white;'>AL</font>"; else echo $datos["jueves"];?></td>
								<td class="cantidad_total" style="<?php echo colorCelda($datos["viernes"]); ?>"><?php if($datos["viernes"]=="B") echo "<font style='color:white;'>AL</font>"; else echo $datos["viernes"]; ?></td>
								<td class="cantidad_total" style="<?php echo colorCelda($datos["sabado"]); ?>"><?php if($datos["sabado"]=="B") echo "<font style='color:white;'>AL</font>"; else echo $datos["sabado"]; ?></td>
								<td class="cantidad_total" style="<?php echo colorCelda($datos["domingo"]); ?>"><?php if($datos["domingo"]=="B") echo "<font style='color:white;'>AL</font>"; else echo $datos["domingo"]; ?></td>
								<td class="cantidad_total" style="<?php echo colorCelda($datos["lunes"]); ?>"><?php if($datos["lunes"]=="B") echo "<font style='color:white;'>AL</font>"; else echo $datos["lunes"]; ?></td>
								<td class="cantidad_total" style="<?php echo colorCelda($datos["martes"]); ?>"><?php if($datos["martes"]=="B") echo "<font style='color:white;'>AL</font>"; else echo $datos["martes"]; ?></td>
								<td class="cantidad_total" style="<?php echo colorCelda($datos["miercoles"]); ?>"><?php if($datos["miercoles"]=="B") echo "<font style='color:white;'>AL</font>"; else echo $datos["miercoles"]; ?></td>
								...
								<td class="cantidad_total" style="mso-number-format:'Currency';"><?php echo $datos["destajo"];; ?></td>
								...
								<?php if($_POST["hdn_bd"] == "bd_recursos"){ ?>
									<td class="cantidad_total" style="mso-number-format:'Currency'; background-color:yellow;"><?php echo $datos["bono"]; ?></td>
								<?php } ?>
...
<?php	}
	...
	//Esta funcion exporta la Nómina a un archivo de excel
	function guardarRepNominaZarpeo($hdn_consulta,$hdn_msje,$fecha_ini,$fecha_fin){
		//Manejo de fechas
		include_once("../../includes/func_fechas.php");
		//Esribir datos de la pagina en excel
		header("Content-type: application/vnd.ms-excel");
			...
			<div id="tabla">				
				<table width="1100">
							...
							<tr>
								<td></td><td></td><td></td>
								<td colspan="13" rowspan="2" class="cantidad_total" style="font-size: 25px; border-style: none; font-weight: bold;">
									NOMINA DE ZARPEO UNIDAD FRESNILLO
								</td>
								<td></td>
								<td class="cantidad_total" style="border-style: none; font-weight: bold;">Semana:</td>
								<td style="border-bottom-style: solid; border-bottom-width: 1px;" colspan="3"><?php echo $fecha_ini." al ".$fecha_fin ?></td>
							</tr>
							<tr></tr>
							<tr>
								<td width="10"></td><td width="60"></td>
								...
								<td width="30"></td><td width="30"></td><td width="30"></td><td width="30"></td>
								<td width="30"></td><td width="30"></td><td width="30"></td><td width="30"></td>
								<td width="120"></td><td width="100"></td><td width="120"></td><td width="100"></td><td width="110">
								</td><td width="150"></td><td width="50"></td><td width="50"></td>
								<td width="50"></td><td width="150"></td><td width="200"></td>
							</tr>
							<tr></tr>
							<tr>
								<td></td>
								...
								<td class="cantidad_topes_total">SUELDO B.</td>
								<td class="cantidad_topes_total">SUELDO DIARIO</td>
								<td class="cantidad_topes_total">CUMPLIMIENTO</td>
								<td class="cantidad_topes_total">CALIDAD OBRA</td>
								<td class="cantidad_topes_total">BONIFICACION</td>
								<td class="cantidad_topes_total">TOTAL</td>
								<td class="cantidad_topes_total">HRS. EXTRA</td>
								<td class="cantidad_topes_total">G. 8HRS</td>
								<td class="cantidad_topes_total">G. 12HRS</td>
					...
					<?php 
						...
						do{
							...
							<tr>
								...
								<td class="cantidad_total" style="background-color:yellow;"><?php echo $datos["sueldo_base"]; ?></td>
								<td class="cantidad_total" style="font-weight: bold;"><u><?php echo $datos["sueldo_diario"]; ?></u></td>
								<td class="cantidad_total"><?php echo $datos["cumpl"]; ?></td>
								<td class="cantidad_total" style="mso-number-format:'Currency';"><?php echo $datos["calidad"]; ?></td>
								<td class="cantidad_total" style="mso-number-format:'Currency';"><?php echo $datos["bonif"]; ?></td>
								<td class="cantidad_total" style="mso-number-format:'Currency'; background-color:yellow;"><?php echo $datos["total_pagado"]; ?></td>
								<td class="cantidad_total"><?php echo $datos["horas_extra"]; ?></td>
								<td class="cantidad_total"><?php echo $g8; ?></td>
								<td class="cantidad_total"><?php echo $g12; ?></td>
...
<?php	}
	...
	//Esta funcion exporta la Nómina a un archivo de excel
	function guardarRepNominaMam($hdn_consulta,$hdn_msje,$fecha_ini,$fecha_fin){
		//Manejo de fechas
		include_once("../../includes/func_fechas.php");
		//Esribir datos de la pagina en excel
		header("Content-type: application/vnd.ms-excel");
			...
			<div id="tabla">				
				<table width="1100">
							...
							<tr>
								...
								</td><td width="50"></td><td width="150"></td><td width="200"></td>
							</tr>
							<tr></tr>
							<tr>
								<td></td>
...
<?php	}
	...
	//Esta funcion exporta la Nómina a un archivo de excel
	function guardarRepNominaMac($hdn_consulta,$hdn_msje,$fecha_ini,$fecha_fin){
		//Manejo de fechas
		include_once("../../includes/func_fechas.php");
		//Esribir datos de la pagina en excel
		header("Content-type: application/vnd.ms-excel");
		header("Content-Disposition: attachment; filename=Nomina_Mtto_Superficie.xls");		
		//Realizar la conexion a la BD de Desarrollo
		$conn = conecta($_POST["hdn_bd"]);
		//Ejecutar la sentencia y almacena los datos de la consulta en la variable $rs (result set)
		$rs_datos = mysql_query($hdn_consulta);
			...
			<div id="tabla">				
				<table width="1100">
							...
							<tr>
								<td></td><td></td><td></td>
								<td colspan="13" rowspan="2" class="cantidad_total" style="font-size: 25px; border-style: none; font-weight: bold;">
									NOMINA DE MANTENIMIENTO SUPERFICIE UNIDAD FRESNILLO
								</td>
								<td class="cantidad_total" style="border-style: none; font-weight: bold;" colspan="2">Semana:</td>
								<td style="border-bottom-style: solid; border-bottom-width: 1px;" colspan="2"><?php echo $fecha_ini." al ".$fecha_fin ?></td>
							</tr>
...
<?php	}
	...
	//Esta funcion exporta la Nómina a un archivo de excel
	function guardarRepNominaAdministracion($hdn_consulta,$hdn_msje,$fecha_ini,$fecha_fin){
		//Manejo de fechas
		include_once("../../includes/func_fechas.php");
		//Esribir datos de la pagina en excel
		header("Content-type: application/vnd.ms-excel");
		header("Content-Disposition: attachment; filename=Nomina_Administracion.xls");		
		//Realizar la conexion a la BD de Desarrollo
		$conn = conecta($_POST["hdn_bd"]);
		//Ejecutar la sentencia y almacena los datos de la consulta en la variable $rs (result set)
		$rs_datos = mysql_query($hdn_consulta);
			...
			<div id="tabla">				
				<table width="1100">
							...
							<tr>
								<td></td><td></td><td></td>
								<td colspan="13" rowspan="2" class="cantidad_total" style="font-size: 25px; border-style: none; font-weight: bold;">
									NOMINA DE ADMINISTRACION UNIDAD FRESNILLO
								</td>
								<td class="cantidad_total" style="border-style: none; font-weight: bold;" colspan="2">Semana:</td>
								<td style="border-bottom-style: solid; border-bottom-width: 1px;" colspan="2"><?php echo $fecha_ini." al ".$fecha_fin ?></td>
							</tr>
...
<?php	}
	...
	function colorCelda($campo){
		$cadena = "";
		if($campo=="F")
			$cadena = "background-color:red;";
		else if($campo=="I")
			$cadena = "background-color:blue;";
		else if($campo=="D")
			$cadena = "background-color:yellow;";
		else if($campo=="B")
