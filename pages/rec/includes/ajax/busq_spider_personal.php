			...
			if(strlen($queryString) >0) {
				...
				if ($_GET['nomTabla']=="empleados"){
					...
					if ($_GET["depto"]=="todo")
						...
						$query = $db->query("SELECT rfc_empleado,CONCAT(nombre,' ',ape_pat,' ',ape_mat) AS nombre FROM empleados WHERE CONCAT(nombre,' ',ape_pat,' ',ape_mat) LIKE '%$queryString%' AND area='$_GET[depto]' AND estado_actual='ALTA' LIMIT 10");
				}
