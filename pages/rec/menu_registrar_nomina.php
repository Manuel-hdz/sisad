...
<body>
  	...
  	<table class="tabla_frm" width="50%" border="0" align="center" cellpadding="5" cellspacing="5">
		<tr>
      		<td width="20%" align="center">
				<form action="frm_registrarNominaDesarrollo.php">
					<input type="image"src="images/add-nomina-interna.png" width="150" height="200" border="0" title="Registrar N&oacute;mina Desarrollo" 
						onmouseover="window.status='';return true" />
				    	<input type="image" src="../../images/btn-rep-nomina-desarrollo.png"  name="btn1" id="btn1" width="118" height="46" border="0" 
                        title="Registrar N&oacute;mina Desarrollo" 
			...
			<td width="20%" align="center">
				<form action="frm_registrarNominaZarpeo.php">
					<input type="image"src="images/add-nomina-interna.png" width="150" height="200" border="0" title="Registrar N&oacute;mina Zarpeo" 
						onmouseover="window.status='';return true" />
				    	<input type="image" src="../../images/btn-rep-nomina-zarpeo.png"  name="btn2" id="btn2" width="118" height="46" border="0" 
                        title="Registrar N&oacute;mina Zarpeo" 
	...
	<table class="tabla_frm" width="50%" border="0" align="center" cellpadding="5" cellspacing="5">
		<tr>
      		<td width="20%" align="center">
				<form action="frm_registrarNominaMam.php">
					<input type="image"src="images/add-nomina-interna.png" width="150" height="200" border="0" title="Registrar N&oacute;mina Mantenimiento Mina" 
						onmouseover="window.status='';return true" />
				    	<input type="image" src="../../images/btn-rep-nomina-mam.png"  name="btn3" id="btn3" width="118" height="46" border="0" 
                        title="Registrar N&oacute;mina Mantenimiento Mina" 
			...
			<td width="20%" align="center">
				<form action="frm_registrarNominaMac.php">
					<input type="image"src="images/add-nomina-interna.png" width="150" height="200" border="0" title="Registrar N&oacute;mina Mantenimiento Superficie" 
						onmouseover="window.status='';return true" />
				    	<input type="image" src="../../images/btn-rep-nomina-mac.png"  name="btn4" id="btn4" width="118" height="46" border="0" 
                        title="Registrar N&oacute;mina Mantenimiento Superficie" 
			...
			<td width="20%" align="center">
				<form action="frm_registrarNominaAdministracion.php">
					<input type="image"src="images/add-nomina-interna.png" width="150" height="200" border="0" title="Registrar N&oacute;mina Administraci&oacute;n" 
						onmouseover="window.status='';return true" />
				    	<input type="image" src="../../images/btn-rep-nomina-administracion.png"  name="btn5" id="btn5" width="118" height="46" border="0" 
                        title="Registrar N&oacute;mina Administraci&oacute;n" 
