...
<body>
  	...
  	<table class="tabla_frm" width="50%" border="0" align="center" cellpadding="5" cellspacing="5">
		<tr>
      		<td width="20%" align="center">
				<form action="frm_reporteNominaDesarrollo.php">
			...
			<td width="20%" align="center">
				<form action="frm_reporteNominaZarpeo.php">
	...
	<table class="tabla_frm" width="50%" border="0" align="center" cellpadding="5" cellspacing="5">
		<tr>
      		<td width="20%" align="center">
				<form action="frm_reporteNominaMam.php">
			...
			<td width="20%" align="center">
				<form action="frm_reporteNominaMac.php">
