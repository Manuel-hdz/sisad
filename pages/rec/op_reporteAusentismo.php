	...
	**/
	...
	function reporteAusentismo(){		
		...
		<?php } 
				...
				<td align="center"><?php 
						$datosGrapAusentismo = array("Ausentismo"=>$AusentismoArea, "hdn_msg"=>$msg_grafica, "diferencia"=>$diferencia);
						$_SESSION['datosGrapAusentismo'] = $datosGrapAusentismo;?>						
						<input type="button" name="btn_verGrafica" class="botones" value="Ver Grafica" title="Ver Gr&aacute;fica de Ausentismo" 
						onClick="javascript:window.open('verGraficas.php?graph=ausentismoFecha','_blank','top=100, left=250, width=1035, height=723, status=no, menubar=no, resizable=no, scrollbars=yes, toolbar=no, location=no, directories=no');" />
			  </td>
				<?php }?>
			</tr>
		</table>			
