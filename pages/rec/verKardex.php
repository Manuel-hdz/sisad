...
<?php
	...
	/**
	  ...
	  * Fecha: 14/Abril/2011
	  * Descripci�n: Este archivo contiene funciones para Ver el Kardex
	  **/ 
	...
	function mostrarKardex(){	
		...
		$sql = "SELECT fecha_entrada, estado FROM kardex WHERE empleados_rfc_empleado = '$id_empleado' AND fecha_entrada>='$fechaIni'
				AND fecha_salida<='$fechaFin' ORDER BY fecha_salida";
