...
<?php
	...
	/**
	  ...
	  * Fecha: 12/Mayo/2011
	  * Descripci�n: Este archivo contiene funciones para Ver el Kardex de Asistencia del Enmpleado
	  **/ 
	...
	function mostrarKardex(){	
		...
		$sql = "SELECT fecha_checada, estado FROM checadas WHERE empleados_rfc_empleado = '$id_empleado' 
				AND estado='A' AND fecha_checada>='$fechaIni' AND fecha_checada<='$fechaFin' ORDER BY fecha_checada";
