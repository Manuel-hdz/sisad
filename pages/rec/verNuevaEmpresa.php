<?php
	/**
	  ...
	  * Nombre Programador:Nadi Madah� L�pez Hern�ndez
	  * Fecha: 26/Septiembre/2012
	  * Descripci�n: Este archivo contiene el formulario para registraruna nueva empresa externa
	  **/ 
...
<head>
	...
	//Obtener el ID de la Nueva Empresa que ser� registrada
	$id = obtenerIdEmpresa();?>	
