...
<title>Sistema de Gesti&oacute;n Empresarial, Producci&oacute;n y Operaci&oacute;n</title>
    ...
    <style type="text/css">
		<!--				
			...
			#tabla-consulta-empleados {position:absolute; left:30px; top:191px; width:465px; height:130px; z-index:25;}
			#tabla-empleados { position:absolute; left:550px; top:197px; width:420px; height:124px; z-index:13; }
			...
			#tabla-materiales { position:absolute; left:30px; top:350px; width:945px; height:290px; z-index:16; overflow:auto; }
		-->
    </style>
</head>
<body>
	<div id="barra"> <img src="../../images/title-bar-bg.gif" width="999" height="30" /></div>
	<div class="titulo_barra" id="titulo-consulta-empleados">Consulta Equipo de Seguridad Entregado </div>
	<?php
		...
		<form name="frm_consultarEquipo" method="post"><?php 
			echo"<div id='tabla-empleados' width='100%' class='borde_seccion' align='center'>";
				//Llamamos a la función mostrar empleados que se encuentra en el op 
				mostrarEmpleados();
			echo "</div>";
			echo"<div id='tabla-materiales' width='100%' class='borde_seccion' align='center'>";
				//Llamamos a la función mostrarMateriales que se encuentra en el op 
				mostrarMateriales();
			echo "</div>";?>
				<div id="btns-regpdf" align="center">&nbsp;
				    <input name="btn_cancelar" type="button" class="botones" value="Regresar" title="Regresar a Seleccionar Otra Consulta" 
		...
		<br>
		<form onsubmit="return valFormConsultaES(this);" method="post" name="frm_consultarEquipo" id="frm_consultarEquipo">
			...
			<div align="center">
				...
				onmouseover="window.status='';return true;" title="Consultar Equipo de Seguridad del Personal"/>
				&nbsp;&nbsp;&nbsp;&nbsp;
				<input name="btn_cancelar" type="button" class="botones" value="Regresar" title="Regresar a Seleccionar Otra Consulta" 
        		onMouseOver="window.status='';return true" onclick="location.href='frm_seleccionarConsulta.php'" />
			</div> 
