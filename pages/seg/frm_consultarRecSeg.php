	...
	<form name="frm_recorrido" id="frm_recorridos" action="op_consultarRecSeg.php" method="post"><?php 
		if(isset($_GET['idAlerta'])){?>				
			...
			<div id="botones" align="center">
				<input name="sbt_desactivar" type="submit" class="botones_largos" value="Desactivar Alerta (s)" title="Desactivar Alertas" 
				onmouseover="window.status='';return true" />
				&nbsp;&nbsp;&nbsp;&nbsp;
				<input name="btn_regresar" type="button" class="botones" value="Regresar" 
				title="Regresar Al Inicio de Seguridad" onclick="location.href='inicio_seguridad.php'" onmouseover="window.status='';return true" />
			</div>
			</div><?php 
		}?>
	</form>	
