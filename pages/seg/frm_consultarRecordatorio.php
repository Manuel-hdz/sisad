...
<?php
	...
	if(!verificarPermiso($usr_reg,$_SERVER['PHP_SELF'])){	
		...
		include ("op_consultarRecordatorio.php");?>
...
<body>
    ...
    <div class="titulo_barra" id="titulo-modificar">Recordatorios Registrados </div>
	<form  onsubmit="return valFormRecordatorioAlerta(this);" name="frm_modificarRec" id="frm_modificarRec" method="post" action="frm_modificarRecordatorio2.php"><?php 
	...
	<?php }
			...
			&nbsp;&nbsp;&nbsp;&nbsp;
			<input name="btn_cancelar" type="button" class="botones" value="Regresar" title="Regresar a Consultar Otro Recordatorio" 
			onMouseOver="window.status='';return true" onclick="location.href='inicio_seguridad.php'" />
			</div>
		<?php 
		}
