...
<Sistema de Gestion Empresarial, Produccion y Operacion html xmlns="http://www.w3.org/1999/xhtml">
	...
	//Comprobar que el usuario registrado tenga acceso a esta seccion del M�dulo de Seguridad Industrial
	...
	<head>
		...
		<script type="text/javascript" src="../../includes/ajax/busq_spider_material_req_seguridad.js"></script>
					...
					<tr>
						...
						<td>
							<input name="txt_areaSolicitante" type="text" id="txt_areaSolicitante"
								onkeypress="return permite(event,'num_car');" size="25" maxlength="45" value="<?php echo $area;?>"
								required="required" />
						</td>
						<td>
						...
						<td>
							<input name="txt_solicitanteReq" type="text" id="txt_solicitanteReq"
								onkeypress="return permite(event,'num_car');" size="40" maxlength="60" value="<?php echo $usuario;?>"
								required="required" />
						</td>
					</tr>
					<tr>
