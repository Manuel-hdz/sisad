	...
	<table width="806" height="187"  cellpadding="5" cellspacing="5" class="tabla_frm">
	  ...
	  <tr>
	    ...
	    <td><input name="txt_archivos" id="txt_archivos" type="text" class="caja_de_texto" size="40" readonly="readonly" 
				onclick="window.open('verArchivosVinculados.php','_blank','top=50, left=50, width=680, height=500, status=no, menubar=no, resizable=no, scrollbars=yes, toolbar=no, location=no, directories=no');" title="De Click Sobre La Caja De Texto Para Agregar Archivos"/></td>
	  </tr>
		...
		<tr>
			<td colspan="6">
				<div align="center">
					...
					onmouseover="window.status='';return true"  onclick="confirmarSalida('menu_recordatorios.php')" />
				</div>			 </td>
		</tr>
    </table>
	</form>
