...
<head>
	...
	$(document).ready(function(){
			$("#tabla-resultadosConsulta").dataTable({
    ...
    <style type="text/css">
		...
		#btn-regresar { position: absolute; left:30px; top:590px; width:900px; height:40px; z-index:23; }
	-->
    </style>
...
<body>
	...
	<div class="titulo_barra" id="titulo-registrar">Generar Reporte Accidentes e Incidentes </div>
	<?php if(isset($_POST['sbt_consultar'])){?>
	
	    <form name="frm_consultarActa" id="frm_consultarActa" method="post" action="guardar_reporte.php">
    		 <div id='tabla-mostrarActas' class='borde_seccion2' align='center'><?php 
				...
				if(isset($_POST['cmb_tipo'])){
					if($_POST['cmb_tipo']=="AREA"){
						mostrarInformeAreas($_POST['cmb_opcion']);	
					}
					if($_POST['cmb_tipo']=="TURNO"){
						mostrarInformeTurno($_POST['cmb_opcion']);	
					}
					if($_POST['cmb_tipo']=="TIPO"){
						mostrarInformeTipo($_POST['cmb_opcion']);	
					}
				}?>
	    </form>
	<?php 
