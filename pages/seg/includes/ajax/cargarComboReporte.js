/**
  ...
  */
	...
	/******************************************************************************************
	 * Esta función cargara un combo box en base al tipo de consulta seleccionado
	 ******************************************************************************************/
	function cargarComboReporteAccInc(combo){
		...
		if(combo!=""){			
			...
			var url = "includes/ajax/cargarComboReporte.php?combo="+combo+"&fechaIni="+fechaIni+"&fechaFin="+fechaFin;	
			...
			cargaContenidoComboReporte(url, "GET", procesarRespuestaComboReporte);
		}
			...
			objeto.length++;
			objeto.options[objeto.length-1].text="Ordenar Por";
	...
	function procesarRespuestaComboReporte(){		
	...
	function cargaContenidoComboReporte(url, metodo, funcion) {
