  	...
  	<table class="tabla_frm" width="545" border="0" align="center" cellpadding="5" cellspacing="5">
    	<tr>
      		<td width="255" align="center">
				<form action="frm_registrarActaIncidentesAccidentes.php">
					<input type="image" src="images/add-acta-acin.png" width="165" height="200" border="0" title="Registrar Informe de Incidentes/Accidentes" 
					...
					title="Registrar Informe de Incidentes/Accidentes"
      		...
      		<td width="255" align="center">
				<form action="frm_consultarActaIncidentesAccidentes.php">
					<input type="image" src="images/upd-acta-acin.png" width="165" height="200" border="0" 
					title="Consultar Informe Incidentes/Accidentes" 
					onmouseover="window.status='';return true" /><br/>
