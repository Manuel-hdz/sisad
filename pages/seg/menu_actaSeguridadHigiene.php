...
<head>
    ...
    <style type="text/css">
		<!--
		#parrilla-menu1 { position:absolute; left:100px; top:160px; width:566px; height:280px; z-index:1; }
		-->
    </style>
</head>
<body>
  	...
  	<table class="tabla_frm" width="545" border="0" align="center" cellpadding="5" cellspacing="5">
    	<tr>
      		<td width="255" align="center">
				<form action="frm_registrarActaSeguridadHigiene.php">
					<input type="image" src="images/add-acta-seg.png" width="140" height="200" border="0" title="Registrar Acta Comisi&oacute;n Seguridad e Higiene" 
					...
					title="Registrar Acta Comisi&oacute;n Seguridad e Higiene"
      		...
      		<td width="255" align="center">
				<form action="frm_consultarActaSeguridadHigiene.php">
					<input type="image" src="images/sea-acta-seg.png" width="140" height="200" border="0" 
					title="Consultar Registro Acta Comisi&oacute;n Seguridad e Higiene" 
					onmouseover="window.status='';return true" /><br/>
					<input type="image" src="../../images/btn-sea.png" name="btn2" id="bnt2" width="118" height="46" border="0" 
					title="Consultar Registro Acta Comisi&oacute;n Seguridad e Higiene" 
					onclick="MM_nbGroup('down','group1','btn2','',1)" 
					onmouseover="MM_nbGroup('over','btn2','../../images/btn-sea-over.png','',1);window.status='';return true" onmouseout="MM_nbGroup('out')"/>
    		 	</form>   	  		  
			</td>
   		</tr>
