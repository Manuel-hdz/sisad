    	...
    	<tr>
      		<td width="255" align="center">
				<form action="frm_registrarBitacora.php">
					<input type="image" src="images/add-bit-residuos.png" width="160" height="200" border="0" title="Registrar Bitacora de Residuos Peligrosos" 
					...
					title="Registrar Bitacora de Residuos Peligrosos" onclick="MM_nbGroup('down','group1','btn1','',1)" 
      		...
      		<td align="center">
				<form action="frm_modificarBitacora.php">
					<input type="image" src="images/upd-bit-residuos.png" width="160" height="200" border="0" title="Modificar Bitacora de Residuos Peligrosos" 
					onmouseover="window.status='';return true" /><br/>
					<input type="image" src="../../images/btn-upd.png" name="btn2" id="bnt2" width="118" height="46" border="0" 
					title="Modificar Bitacora de Residuos Peligrosos" onclick="MM_nbGroup('down','group1','btn2','',1)" 
