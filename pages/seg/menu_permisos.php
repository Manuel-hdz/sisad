  	...
  	<table class="tabla_frm" width="545" border="0" align="center" cellpadding="5" cellspacing="5">
    	<tr>
      		<td width="255" align="center">
				<form action="frm_seleccionarPermiso.php">
					<input type="image" src="images/add-permiso.png" width="130" height="200" border="0" title="Generar Permisos" onmouseover="window.status='';return true"/><br/>
					<input type="image" src="../../images/btn-add.png"  name="btn1" id="bnt1" width="118" height="46" border="0" title="Generar un Tipo de Permiso"
				...
				<td width="255" align="center">
				<form action="frm_consultarPermisos.php">
					<input type="image" src="images/sea-permiso.png" width="130" height="200" border="0" title="Consultar Permisos Generados" onmouseover="window.status='';return true" /><br/>
					<input type="image" src="../../images/btn-sea.png" name="btn2" id="bnt2" width="118" height="46" border="0" title="Consultar los Permisos Generados" 
