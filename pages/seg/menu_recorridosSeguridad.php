...
<?php
	...
	if(!verificarPermiso($usr_reg,$_SERVER['PHP_SELF'])){
		...
		//Manejo de la funciones para registrar los recorridos de seguridad
		include ("op_registrarRecSeg.php");
		//Verificar que se haya presionado el boton de cancelar para eliminar las fotos 
		if(isset($_GET['cancel'])){
			borrarFotos($_GET['cancel']);
		}
		//Liberamos sesion de registrar fotos para el registro de los recorridos de seguridad
  	...
  	<table class="tabla_frm" width="545" border="0" align="center" cellpadding="5" cellspacing="5">
    	<tr>
      		<td width="255" align="center">
				<form action="frm_registrarRecSeg.php">
					<input type="image" src="images/add-recorrido-seg.png" width="150" height="200" border="0" title="Registrar Recorrido Seguridad" 
					...
					title="Registrar Recorrido Seguridad"
      		...
      		<td width="255" align="center">
				<form action="frm_modificarRecSeg.php">
					<input type="image" src="images/upd-recorrido-seg.png" width="150" height="200" border="0" 
					title="Modificar Registro Recorrido Seguridad" 
					onmouseover="window.status='';return true" /><br/>
