...
<head>
    ...
    <style type="text/css">
		<!--
		#parrilla-menu1 { position:absolute; left:100px; top:160px; width:566px; height:295px; z-index:1; }
		-->
    </style>
</head>
<body>
  	...
  	<table class="tabla_frm" width="545" border="0" align="center" cellpadding="5" cellspacing="5">
    	<tr>
			<td width="255" align="center">
				<form action="frm_reporteIncidentesAccidentes.php">
					<input type="image" src="images/add-rep-inf-acc-inc.png" width="150" height="200" border="0" title="Generar Reporte Accidentes/Incidentes" 
					...
					title="Generar Reporte Accidentes/Incidentes" 
      		...
      		<td width="255" align="center">
				<form action="frm_reportePlanContingencia.php">
					<input type="image" src="images/add-rep-cont.png" width="150" height="200" border="0" title="Generar  Reporte Plan Contingencia" 
					onmouseover="window.status='';return true"/><br/>
					<input type="image" src="../../images/btn-gen.png"  name="btn3" id="btn3" width="118" height="46" border="0" 
					title="Generar Reporte Plan de Contingencia"
					onclick="MM_nbGroup('down','group1','btn3','',1)"
					onmouseover="MM_nbGroup('over','btn3','../../images/btn-gen-over.png','',1); window.status='';return true" onmouseout="MM_nbGroup('out')" />	
				</form>	     
			</td>
			<td align="center">
					<form action="frm_reporteRequisiciones.php">
			 		<input type="image" src="images/add-requisicion.png" width="150" height="200" border="0" title="Generar Reporte Requisiciones" 
                	onmouseover="window.status='';return true" /><br/>
                    ...
                    onmouseover="MM_nbGroup('over','btn1','../../images/btn-gen-over.png','',1);window.status='';return true" 
