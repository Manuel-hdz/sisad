<?php
	...
	function mostrarRecordatorios(){
		...
		//De lo contrario seleccionamos aquellas que cumplan con los parametros
			...
			//Cremos la consulta
			$stm_sql ="SELECT *	FROM alertas_generales WHERE tipo_alerta='INTERNA' AND estado='1' AND dias_restantes<=5 ORDER BY id_alerta";
		}
		...
		if($datos = mysql_fetch_array($rs)){		
			echo "				
				<table cellpadding='5' width='100%'>
					<caption class='titulo_etiqueta'>RECORDATORIOS REGISTRADOS</caption>	";
			echo "	<tr>
	...
	function eliminarRegistro(){
		...
		$band=0;
		//Creamos la conslulta SQL que permite eliminar el registro de la BD
