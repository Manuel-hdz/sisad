<?php
	...
	if(!isset($_GET['idAlerta'])){
		...
		<legend class="titulo_etiqueta">Seleccionar Archivos</legend>	
			...
			<table width="100%" border="0" cellpadding="5" cellspacing="5">
				<tr align="center">
					<td colspan="4">
						...
						title="Vuelve al Registro de los Recordatorios"/>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;		
	...
	if(isset($_GET['idAlerta'])){
		...
		if($datos = mysql_fetch_array($rs)){		
			...
			$cont = 1;	
			do{	
				$nomArchivo = obtenerDato("bd_seguridad", "repositorio_documentos", "nombre", "id_documento", $datos['repositorio_documentos_id_documento']);
				echo "
				<tr>
			...
			echo "</table>";?>
			<div align="center">
					<input name='btn_cerrar' type='button' class='botones'  value='Cerrar' title='Cerrar El Formulario' onclick='window.close();'/></div><?php 
			return 1;
		}
		else{
