...
<body onLoad="inicio(); setInterval(muestraReloj, 1000);" onkeypress="parar()" onclick="parar()" onmousemove="parar()">
  	...
  	<table width="50" border="0">    			
		<tr>
      		<td width="50" height="50">						
				<form action="inicio_sistemas.php">
					<input type="image" src="../../images/dock/home.png" name="icono1" id="icono1" width="50" height="50" border="0" title="Inicio Sistemas"					
	...
	<div id="menu" style="position:absolute; left:-15px; top:70px; width:1035px; height:85px; z-index:123;"> 
		<ul id="css3menu">	
			<li class="topfirst"><a href="menu_consumibles.php" onMouseOver="window.status='';return true"  title="Consumibles de Impresora">Consumibles de Impresoras</a>
				<ul>
					<li class="subfirst">
						<a href="frm_aregarConsumibles.php" onMouseOver="window.status='';return true" title="Consumibles">Consumibles</a>
					</li>
					<li class="subfirst">
						<a href="menu_bitconsumibles.php" onMouseOver="window.status='';return true" 
						title="Bitacora de Consumibles"><span>Bitacora de Consumibles</span></a>
						<ul>
							<li>
								<a href="frm_aregarBitacoraConsumibles.php" onMouseOver="window.status='';return true" 
								title="Agrega Bitacora de Consumibles">Agrega Bitacora de Consumibles</a>
							</li>
							<li>
								<a href="frm_consultarBitacoraConsumibles.php" onMouseOver="window.status='';return true" 
								title="Consultar Bitacora de Consumibles">Consultar Bitacora de Consumibles</a>
							</li>
						</ul>
					</li>
				</ul>	
			</li>
			<li class="topfirst"><a href="menu_equipo_computo.php" onMouseOver="window.status='';return true"  title="Equipo de Computo">Equipo de Computo</a>
				<ul>
					<li class="subfirst">
						<a href="" onMouseOver="window.status='';return true" title="Agregar Equipo de Computo">Agregar Equipo de Computo</a>
					</li>
					<li class="subfirst">
						<a href="" onMouseOver="window.status='';return true" title="Modificar Equipo de Computo">Modificar Equipo de Computo</a>
					</li>
					<li class="subfirst">
						<a href="" onMouseOver="window.status='';return true" title="Consultar Equipo de Computo">Consultar Equipo de Computo</a>
					</li>
				</ul>	
			</li>
			<!--
			<li class="topfirst"><a href="" onMouseOver="window.status='';return true"  title="Equipo de Computo">Antivirus</a>
				<ul>
					<li class="subfirst">
						<a href="" onMouseOver="window.status='';return true" 
						title="Licencias Antivirus"><span>Licencias Antivirus</span></a>
						<ul>
							<li>
								<a href="" onMouseOver="window.status='';return true" 
								title="Agregar Licencia Antivirus">Agregar Licencia Antivirus</a>
							</li>
							<li>
								<a href="" onMouseOver="window.status='';return true" 
								title="Consultar Licencia Antivirus">Consultar Licencia Antivirus</a>
							</li>
						</ul>
					</li>
					<li class="subfirst">
						<a href="" onMouseOver="window.status='';return true" 
						title="Equipos"><span>Equipos</span></a>
						<ul>
							<li>
								<a href="" onMouseOver="window.status='';return true" 
								title="Agregar Licencia Antivirus a Equipo">Agregar Licencia Antivirus a Equipo</a>
							</li>
							<li>
								<a href="" onMouseOver="window.status='';return true" 
								title="Modificar Licencia Antivirus a Equipo">Modificar Licencia Antivirus a Equipo</a>
							</li>
						</ul>
					</li>
				</ul>	
	...
	<div id="modulo" class="usr-reg">M&oacute;dulo de Sistemas</div>
