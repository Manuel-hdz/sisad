...
<head>
    ...
    <style type="text/css">
		...
		#btn_regresar {position:absolute;left:30px;top:669px;width:923px;height:39px;z-index:14; }
		-->
    </style>
</head>
<body>
    ...
    <div class="titulo_barra" id="titulo-consultar">Consultar Lista de Precios</div>
	<br>
