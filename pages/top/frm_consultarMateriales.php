...
<body>
	...
	<div id="botones" align="center">
		<input type="button" name="btn_regresar" title="Regresar al Inicio" onclick="location.href='inicio_topografia.php';" value="Regresar" class="botones" onmouseover="window.status='';return true;"/>
	</div>
