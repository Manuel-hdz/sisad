...
<?php
	...
	if(!verificarPermiso($usr_reg,$_SERVER['PHP_SELF'])){	
		...
		include ("op_consultarPlanos.php");?>
...
<head>
    ...
    <style type="text/css">
		<!--
			...
			#tabla-consultarPlano {position:absolute;left:30px;top:190px;width:425px;height:162px;z-index:12;}
...
<body>
    ...
    <div class="titulo_barra" id="titulo-consultar">Consultar  Planos </div>
	...
	<br>
	<form name="frm_consultarPlanoFecha" method="post" action="frm_consultarPlanos.php"  onsubmit="return valFormConsultarPlano(this);" enctype="multipart/form-data">
