...
<body>	
	...
	if(isset($_POST["sbt_modificar"]))
		modificarRegistro($_POST["rdb_idRegistro"]);
	...
	?>
		...
		<br>
		<form onSubmit="return valFormSeleccionarObraEq(this);" name="frm_modificarObraEqP" method="post" action="frm_modificarEquipoPesado.php">
	...
	<?php
		...
		?>
		<form onSubmit="return valFormModBitEqP(this);" name="frm_eliminarEquipoPesado" method="post" action="frm_modificarEquipoPesado2.php">
				...
				<tr>
					<td>
						...
						if($res==1){?>
							...
							onmouseover="window.status='';return true" title="Modificar Registro Seleccionado" />&nbsp;&nbsp;&nbsp;&nbsp;
						<?php
						}?>               
						<input name="btn_regresar2" type="button" class="botones" value="Regresar" onclick="location.href='frm_modificarEquipoPesado.php';"
