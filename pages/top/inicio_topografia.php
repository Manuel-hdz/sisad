...
<?php
	...
	if(!verificarPermiso($usr_reg,$_SERVER['PHP_SELF'])){	
		...
		//Liberar Datos de la SESSION del Reporte de Acumulados de la Seccion de CONCILIACION
		unset($_SESSION['reporteAcumulados']);
		
		//Liberar los arreglos de Session utilizados en la Generacion de Requisiciones
...
<body>
    <div id="parrilla-menu1">
      <div align="center">
        <p><img src="../../images/logo-topografia.png" width="449" height="453" /><br/>
