  	...
  	<table class="tabla_frm" width="890" border="0" align="center" cellpadding="5" cellspacing="5">
    	<tr>
      		<td width="25%" align="center">
				<form action="frm_registrarObra.php">
					<input type="image" src="images/add-obra.png" width="160" height="200" border="0" title="Registrar Obra" 
                    onmouseover="window.status='';return true"/><br/>
					<input type="image" src="../../images/btn-gen.png"  name="btn1" id="btn1" width="118" height="46" border="0" title="Registrar Obras"
      		...
      		<td width="25%" align="center">
				<form action="frm_modificarNombreObra.php">
					<input type="image"src="images/upd-obra.png" width="160" height="200" border="0" title="Modificar Obras" 
					onmouseover="window.status='';return true" /><br/>
					<input type="image" src="../../images/btn-upd.png" name="btn5" id="btn5" width="118" height="46" border="0" title="Modificar Obras"
			...
			<td width="25%" align="center">
				<form action="frm_consultarObra.php">
					<input type="image" src="images/sea-obra.png" width="160" height="200" border="0" title="Consultar Obras" 
					onmouseover="window.status='';return true" /><br/>
					<input type="image" src="../../images/btn-sea.png"  name="btn4" id="btn4" width="118" height="46" border="0" title="Consultar Obras" 
