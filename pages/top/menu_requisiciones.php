    	...
    	<tr>
			...
			<td width="25%" align="center">
				<form action="frm_generarRequisicion.php">
					<input type="image" src="images/add-requisicion.png" width="130" height="200" border="0" title="Generar Requisici&oacute;n" 
                    onmouseover="window.status='';return true" /><br/>
					<input type="image" src="../../images/btn-gen-requisicion.png" name="btn5" id="btn5" width="118" height="46" border="0" 
                    title="Generar Requisici&oacute;n" onclick="MM_nbGroup('down','group1','btn5','',1)" 
                    onmouseover="MM_nbGroup('over','btn5','../../images/btn-gen-requisicion-over.png','',1);window.status='';return true" 
			...
			<td width="25%" align="center">
				<form action="frm_consultarRequisiciones.php">
					<input type="image" src="images/sea-requisicion.png" width="130" height="200" border="0" title="Consultar Requisici&oacute;nes" 
                    onmouseover="window.status='';return true" /><br/>
					<input type="image" src="../../images/btn-est-req.png" name="btn6" id="btn6" width="118" height="46" border="0" 
                    title="Consultar Requisiciones" onclick="MM_nbGroup('down','group1','btn6','',1)" 
                    onmouseover="MM_nbGroup('over','btn6','../../images/btn-est-req-over.png','',1);window.status='';return true" onmouseout="MM_nbGroup('out')"/>
				</form>
			</td>
			<td align="center">
				<form action="frm_reporteRequisiciones.php">
			 		<input type="image" src="images/add-requisicion.png" width="130" height="200" border="0" title="Generar Reporte Requisiciones" 
                	onmouseover="window.status='';return true" /><br/>
