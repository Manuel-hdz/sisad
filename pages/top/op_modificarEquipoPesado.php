<?php
	...
	**/
	...
	function modificarRegistro(){
		...
		$sql_stm="UPDATE bitacora_eq_pesado SET t_cambio='$tasaCambio',fecha_registro='$fecha',no_quincena='$quincena' WHERE idbitacora='$idBitacora'";
		$rs=mysql_query($sql_stm);
		...
		if($rs){
			...
			registrarOperacion("bd_topografia",$idBitacora,"ModificarRegBitEquipo",$_SESSION['usr_reg']);
