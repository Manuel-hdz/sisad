...
<head>
    ...
    <style type="text/css">
		<!--
			...
			#tabla-repCensos{position:absolute;left:30px;top:190px;width:442px;height:221px;z-index:12;}
			...
			#tabla-consultarResultados{position:absolute; left:34px; top:192px; width:950px; height:367px; z-index:14; padding:15px; padding-top:0px; overflow:scroll;}
			#botones{position:absolute;left:26px;top:607px;width:950px;height:37px;z-index:15;}
...
<body>
    ...
    <div class="titulo_barra" id="titulo-consultar">Consultar Registro de Incapacidades a Trabajadores</div>
		<?php
	...
	?>
		...
		<legend class="titulo_etiqueta">Consultar Incapacidades de los Trabajadores</legend>	
		<br>
		<form onsubmit="return valFormDockClinica(this);" name="frm_detalleIncapacidades" method="post" action="frm_conIncapacidadesRH.php">
			<table width="100%"  cellpadding="5" cellspacing="5" class="tabla_frm">
				<tr>
				  <td width="73"><div align="right">Fecha Inicio</div></td>
					...
					<td width="73"><div align="right">Fecha Fin</div></td>
					<td>
				...
				<tr>
					...
					<select name="cmb_tipoClasificacion" class="combo_box" id="cmb_tipoClasificacion">
						...
						<option value="RT">INCAPACIDAD ACCIDENTE TRABAJO</option>
						<option value="E">INCAPACIDAD ENFERMEDAD GENERAL</option>
						<option value="T">INCAPACIDAD EN TRAYECTO</option>
					</select>
				</tr>
				<tr>
					<td colspan="2">
						<div align="center"> 
							...
							title="Consultar las Incapacidades de los Trabajadores"
							onMouseOver="window.status='';return true"/>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<input name="btn_regresar" type="button" class="botones" value="Regresar" title="Regresar a Seleccionar Otros Par&aacute;metros de B&uacute;squeda" 
							onmouseover="window.status='';return true" onclick="location.href='frm_selConsultaExterna.php'" />
						</div>
					</td>
				</tr>
		  </table>
		...
		<div id="calendario-uno">
			<input name="calendario_uno" type="image" id="calendario_uno" onclick="displayCalendar (document.frm_detalleIncapacidades.txt_fechaIni,'dd/mm/yyyy',this)" 
		...
		<div id="calendario-dos">
			<input name="calendario_dos" type="image" id="calendario_dos" onclick="displayCalendar (document.frm_detalleIncapacidades.txt_fechaFin,'dd/mm/yyyy',this)" 
	...
	<?php }
		...
		if(isset($_GET["fechaI"])){
			...
			echo "<form name='frm_selDetalleIncapacidades' method='post' 
			onsubmit='return valFormSelDetalleIncapacidades(this);' action='frm_conIncapacidadesRH.php'>";
			echo "<div class='borde_seccion2' id='tabla-consultarResultados'><br>";
				$sql_stm = mostrarIncapacidades($fechaI,$fechaF,$tipo);
			echo "</div>";
			...
			?>
				...
				<!--
				<input type="button" class="botones" value="Exportar a Excel" name="btn_exportar" id="btn_exportar" 
				title="Exportar a Excel los Registros de los Historiales Clinicos" 
				onclick="location.href='guardar_reporte.php?fechaI=<?php//echo $fechaI?>
				&fechaF=<?php //echo $fechaF?>&tipo=<?php //echo $tipo?>&tipoRep=RepIncapacidadesEmpleados'"/>
				 -->
				&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="button" class="botones" value="Regresar" name="btn_regresar" id="btn_regresar" title="Regresar a Seleccionar Otros Par&aacute;metros de Consulta" 
				onclick="location.href='frm_conIncapacidadesRH.php'"/>
