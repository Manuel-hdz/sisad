...
<head>
    ...
    <style type="text/css">
		...
		#calendario{position:absolute;left:546px;top:243px;width:30px;height:26px;z-index:13;}		
		#calendario-nac{position:absolute;left:543px;top:350px;width:30px;height:26px;z-index:13;}		
...
<body>
	...
	if(isset($_GET["idEmpleado"])){
		...
		//Obtenermos el id del historial clinico
		$idHistorial = obtenerIdHistorialClinico();
		//Obtenermos de la BD el nombvre de la empresa, la razon social y el nombre del empleado correspndiente a el registro
		$nomEmpresa = obtenerDato("bd_clinica","catalogo_empresas", "nom_empresa", "id_empresa", $idEmp);
		$razSocial = obtenerDato("bd_clinica","catalogo_empresas", "razon_social", "id_empresa", $idEmp);
		$nomEmpleado = obtenerDato("bd_clinica","empleados_externos", "nom_empleado_ext", "id_registro", $idEmpleado);

		//Variables utilizadas para colocar directamente que la claisifcacion y tipo de examen son externos a la empresa
		$clasExa = "EMPRESA EXTERNA";
		$tipoClas = "EXTERNO"; 
		//Se conecta a la Base de la clinica
	...
	<form  onsubmit="return valFormRegHistorialClinico(this);"name="frm_historialClinico" id="frm_historialClinico" method="post" action="">
		<table width="101%" cellpadding="3" cellspacing="3" class="tabla_frm">
			<tr>
				...
				<td width="22%">
			 		<input type="text" name="txt_clasExa" id="txt_clasExa" value="<?php echo $clasExa; ?>" size="18" maxlength="15" readonly="readonly" 
			...
			<tr>
				...
				<td>
					<input type="text" name="txt_numSS" id="txt_numSS" value="" size="15" maxlength="15"  class="caja_de_texto"/>				
				</td>
			...
			<tr>
				...
				<td>
					...
					<input type="hidden" name="hdn_idEmpleadoExt" id="hdn_idEmpleadoExt" value="<?php echo $idEmpleado; ?>"/>				
				</td>
				...
				<td>
					...
					onkeypress="return permite(event,'num',3);" value="" size="2" maxlength="2" onchange="validarEdad(this);"/>
					N&deg; Empleado
					<input type="text" name="txt_numEmp" id="txt_numEmp" value="" size="5" maxlength="20" 
			...
			<tr>
				...
				<td>
					<input name="txt_reside" type="text" class="caja_de_texto" id="txt_reside" value="" 
					size="40" maxlength="60" onkeypress="return permite(event,'num_car',0);"/>				</td>
				<td><div align="right">*Originario</div></td>
				<td>
					<input type="text" name="txt_originario" id="txt_originario" value="" 
			...
			<tr>
				...
				<td>
					...
					value="" size="40" maxlength="120"/>				</td>
				<td><div align="right">Fecha Nacimiento </div></td>
			  	<td>
					<input name="txt_fechaNac" type="text" id="txt_fechaNac" value="<?php echo date("d/m/Y");?>" size="10"  readonly="readonly" 
					class="caja_de_texto"/>
					<input type="hidden" name="hdn_fechaAct" id="hdn_fechaAct" value="<?php echo date("d/m/Y");?>"/>          
				</td>
				<td><div align="right">Telefono</div></td>
				<td>
					<input name="txt_tel" type="text" id="txt_tel" value="" size="10" onblur="validarTelefono(this);" 
					 class="caja_de_texto" onkeypress="return permite(event,'num',3);"/>				</td>
			</tr>
			<tr>
				<td><div align="right">*Escolaridad</div></td>
				<td>
					<input type="text" name="txt_escolaridad" id="txt_escolaridad" value="" size="15" 
				...
				<td>
					...
					onkeypress="return permite(event,'num_car',4);" class="caja_de_texto"/>				</td>
			...
			<tr>
				...
				<td>
					...
					value="DR. MALCO OBED GARC&Iacute;A BORJ&Oacute;N" size="40" maxlength="120"/>				</td>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
			</tr>
			<tr>
