...
<?php
	...
	//Comprobar que el usuario registrado tenga acceso a esta seccion del M�dulo USO
...
<head>
    ...
    <style type="text/css">
		...
		#material-requisicion { position:absolute; left:21px; top:575px; width:978px; height:148px; z-index:14; overflow:auto;}
		...
		#datos-gral { position:absolute; left:20px; top:380px; width:940px; height:175px; z-index:15; }
...
<body>
	...
	if(!isset($_POST['txt_areaSolicitante'])){
		$solicitante="";
		/*DECOMENTAR ESTAS LINEAS Y APLICARLAS AL ORGANIGRAMA PARA EXTRAER EL NOMBRE DEL ENCARGADO DE ESTE DEPARTAMENTO
		$area="DEPARTAMENTO ELECTRICO";
		...
		*/
		...
		//$elaborador="DRA DIANA ROCIO CHAIREZ TRETO";
	?>
	...
	<form onsubmit="return valFormInformacionRequisicion(this);" name="frm_InformacionRequisicion" method="post" action="frm_generarRequisicion.php">
  	<table border="0" cellpadding="5" cellspacing="5" class="tabla_frm">
		<tr>
		    ...
		    <td>
				<input name="txt_elaboradorReq" type="text" id="txt_elaboradorReq" onkeypress="return permite(event,'num_car');" readonly="readonly" size="40" maxlength="60" value="<?php echo $elaborador;?>"/>
    	...
    	<tr>
			<td>
      		...
      		<td>
				<input name="txt_areaSolicitante" type="text" id="txt_areaSolicitante" onkeypress="return permite(event,'num_car');" size="25" maxlength="45" value="UNIDAD DE SALUD OCUPACIONAL" required="required"/>
			</td>
			<td>
