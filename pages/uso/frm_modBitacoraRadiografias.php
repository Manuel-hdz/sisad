...
<head>
    ...
    <style type="text/css">
		<!--
			...
			#tabla-seleccionFechas{position:absolute;left:30px;top:190px;width:436px;height:162px;z-index:12;}
			#calendario-uno{position:absolute;left:268px;top:234px;width:30px;height:26px;z-index:13;}
			#calendario-dos{position:absolute;left:268px;top:270px;width:30px;height:26px;z-index:13;}
			...
			#tabla-complementar-radiografia{ position:absolute; left:30px; top:190px; width:850px;	height:280px; z-index:16; }
			#calendario { position:absolute; left:737px; top:233px; width:30px; height:26px; z-index:17; }
		-->
    </style>
...
<body>
    ...
    <div class="titulo_barra" id="titulo-consultar">Modificar Bit&aacute;cora de Radiograf&iacute;as</div>
	...
	?>
		<script type="text/javascript" language="javascript">
			setTimeout("alert('No se Encontraron Resultados');",500);
		</script>
	<?php
	}
	...
	if(isset($_POST["sbt_borrar"]))
		borrarRegBitacora($_POST["rdb_bitacora"]);
	...
	if(isset($_POST["sbt_modificar"]))
		modificarRegBitacora($_POST["rdb_bitacora"]);
	...
	?>
		...
		<legend class="titulo_etiqueta">Registros de Bit&aacute;cora por Fecha</legend>	
		<br>
		<form name="frm_seleccionarFechas" method="post" action="frm_modBitacoraRadiografias.php">
			<table width="444"  cellpadding="5" cellspacing="5" class="tabla_frm">
				...
				<tr>
					<td colspan="2">
						<div align="center"> 
							<input name="sbt_consultar" type="submit" class="botones" id= "sbt_guardar" value="Consultar" title="Consultar Registros de las Radiograf&iacute;as"
							onMouseOver="window.status='';return true"/>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="reset" name="btn_limpiar" class="botones" value="Restablecer" title="Restablece el Formulario"/>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<input name="btn_regresar" type="button" class="botones" value="Regresar" title="Regresar al Men&uacute; de Bit&aacute;cora de Radiograf&iacute;as" 
							onmouseover="window.status='';return true" onclick="location.href='menu_bitacoraRadiografias.php'" />
						</div>
					</td>
				</tr>
		  </table>
	...
	<?php }
		...
		if(!isset($_POST["sbt_modificar"])){
			if(isset($_GET["cancel"])){
				//Quitar el arreglo de radiografias si es que esta definido
			...
			echo "<form name='frm_selRegModificarRadio' method='post' onsubmit='return valFormSelRegBitacora(this);'>";
			echo "<div class='borde_seccion2' id='tabla-consultarResultados'><br>";
			mostrarBitacoraRadiografias($fechaI,$fechaF);
			echo "</div>";
			...
			?>
				...
				onclick="location.href='guardar_reporte.php?fechaI=<?php echo $fechaI?>&fechaF=<?php echo $fechaF?>&tipoRep=RepBitRadio'"/>
				&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="button" class="botones" value="Regresar" name="btn_regresar" id="btn_regresar" title="Regresar a seleccionar otras Fechas" onclick="location.href='frm_modBitacoraRadiografias.php'"/>
			<?php
			echo "</div>";
			echo "</form>";
		}
