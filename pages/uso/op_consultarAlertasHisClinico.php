<?php
	...
	function mostrarRecordatorios(){
		...
		if(isset($_GET['idAlerta'])){
			...
			$stm_sql ="SELECT *	FROM alerta_examen WHERE id_alerta_exa='$idAlerta' ORDER BY id_alerta_exa";			
		}
		//De lo contrario seleccionamos aquellas que cumplan con los parametros
			...
			$stm_sql ="SELECT *	FROM alerta_examen WHERE  estado='0' ORDER BY id_alerta_exa";
			...
			do{			
				...
				<tr>
					<td class='nombres_filas' align='center'>
								<input type='radio' id='rdb_id' name='rdb_id' value='$datos[id_alerta_exa]'/>
					</td>
					<td class='$nom_clase'>$datos[id_alerta_exa]</td>"; 
				echo "
					  ...
					  <td class="<?php echo $nom_clase; ?>" align="center">
						...
						onClick="javascript:window.open('verDepartamentos.php?idAlerta=<?php echo $datos['id_alerta_exa'];?>',
	...
	function eliminarRegistro(){
		...
		if($rs2){
			...
			registrarOperacion("bd_clinica",$idAlerta,"EliminarAlertaPlanC",$_SESSION['usr_reg']);
