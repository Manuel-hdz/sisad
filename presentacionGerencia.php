...
<head>
	...
	<meta http-equiv="refresh" content="10; url=pages/loginGerencia.php?usr_sts=accinc">
...
<!--
body {
	background-image: url(pages/dir/images/bk2.jpg);
	background-color: #FFFFFF;
}
.style1 {color: #CCFFCC;font-weight: bold; }
-->
</style>
...
<div id="Layer3" style="position:absolute; left:700px; top:486px; width:52px; height:10px; z-index:12"> 
  <div align="right" class="style1"><font size="2" face="Arial, Helvetica, sans-serif">Ver 0.1</font></div>
</div>
</body>
</html>
